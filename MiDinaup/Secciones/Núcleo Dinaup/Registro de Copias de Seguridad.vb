...
Partial Public Class SeccionesD
  Public Class RegistroDeCopiasDeSeguridadD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeCopiasDeSeguridadC )) 
          Dim R As New List(Of RegistroDeCopiasDeSeguridadC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeCopiasDeSeguridadES._SeccionID, False, Parametros) 
