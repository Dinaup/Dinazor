...
Partial Public Class SeccionesD
  Public Class RegistroDeCopiasDeSeguridadD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistroDeCopiasDeSeguridadC )) 
          Dim R As New List(Of RegistroDeCopiasDeSeguridadC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistroDeCopiasDeSeguridadES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistroDeCopiasDeSeguridadC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As RegistroDeCopiasDeSeguridadC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of RegistroDeCopiasDeSeguridadC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of RegistroDeCopiasDeSeguridadC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, RegistroDeCopiasDeSeguridadES._SeccionID, Importar, CampoWhere, "") 
      End Function
    ...
    End Sub
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_10040269579")
            End Get   
        End Property
        ...
        Public ReadOnly property DinaupVersion As Integer
            get
                return me.GetValue_Int("pr_60040269574")
            End Get   
        End Property
        Public ReadOnly property DinaupRevision As Integer
            get
                return me.GetValue_Int("pr_60040269575")
            End Get   
        End Property
        Public ReadOnly property TipoDeCopia As EnumTipoBackUpEE
            get
                return me.GetValue_Int("pr_20040269586")
            End Get   
        End Property
