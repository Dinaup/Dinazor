...
Partial Public Class SeccionesD
  Public Class UbicacionesBaseD
      Public Class UbicacionesBase_ConListaC
      Public Listador as UbicacionesBaseC
      Public Lista As New List(of UbicacionesBaseListaD.UbicacionesBaseListaC)
        sub new(_listador  as UbicacionesBaseC, _lista as List(of UbicacionesBaseListaD.UbicacionesBaseListaC))
              ...
              For Each Actual In d.Datos 
                  ...
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New UbicacionesBaseListaD.UbicacionesBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New UbicacionesBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class UbicacionesBaseES
          Public shared _SeccionID as Guid = New Guid("bffd6c6e-a75b-455f-8367-067e7bb2fb47")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_1464b5a4e2x3b0wd"
      Public Shared FechaReferenciaEnvioSC_UTC$ = "pr_6f300a7wd"
      Public Shared FechaAlta_UTC$ = "pr_14c9f3de68x33ewd"
      Public Shared ExportarEnModulos$ = "pr_14631007adh324wd"
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""bffd6c6e-a75b-455f-8367-067e7bb2fb47"",""titulo"": ""Base - Ubicaciones"",""iconoid"": ""b985b58f-7275-46b8-9b66-2c54346b0185"",""etiquetasingular"": ""Ubicación"",""etiquetaplural"": ""Ubicaciones"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""bffd6c6e-a75b-455f-8367-067e7bb2fb47"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_1464b5a4e2x3b0wd")
         ...
         End if
         R.add("pr_1464b5a4e2x3b0wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
