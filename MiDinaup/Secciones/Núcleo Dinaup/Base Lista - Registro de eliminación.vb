...
Partial Public Class SeccionesD
  Public Class RegistroDeEliminacionBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeEliminacionBaseListaC )) 
          Dim R As New List(Of RegistroDeEliminacionBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeEliminacionBaseListaES._SeccionID, False, Parametros) 
