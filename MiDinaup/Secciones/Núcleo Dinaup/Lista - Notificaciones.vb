...
Partial Public Class SeccionesD
  Public Class NotificacionesListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of NotificacionesListaC )) 
          Dim R As New List(Of NotificacionesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(NotificacionesListaES._SeccionID, False, Parametros) 
