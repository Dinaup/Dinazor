...
Partial Public Class SeccionesD
  Public Class AccesosAEmpresasListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AccesosAEmpresasListaC )) 
          Dim R As New List(Of AccesosAEmpresasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AccesosAEmpresasListaES._SeccionID, False, Parametros) 
