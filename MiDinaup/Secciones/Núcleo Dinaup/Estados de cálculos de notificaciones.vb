...
Partial Public Class SeccionesD
  Public Class EstadosDeCalculosDeNotificacionesD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EstadosDeCalculosDeNotificacionesC )) 
          Dim R As New List(Of EstadosDeCalculosDeNotificacionesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EstadosDeCalculosDeNotificacionesES._SeccionID, False, Parametros) 
