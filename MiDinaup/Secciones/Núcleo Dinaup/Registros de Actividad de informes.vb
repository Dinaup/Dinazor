...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeInformesD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeInformesC )) 
          Dim R As New List(Of RegistrosDeActividadDeInformesC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeInformesES._SeccionID, False, Campo, Valor) 
