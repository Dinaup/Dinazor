...
Partial Public Class SeccionesD
  Public Class AccesosAUbicacionesD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of AccesosAUbicacionesC )) 
          Dim R As New List(Of AccesosAUbicacionesC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AccesosAUbicacionesES._SeccionID, False, Campo, Valor) 
