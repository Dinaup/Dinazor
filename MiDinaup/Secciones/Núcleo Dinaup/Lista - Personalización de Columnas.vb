...
Partial Public Class SeccionesD
  Public Class PersonalizacionDeColumnasListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PersonalizacionDeColumnasListaC )) 
          Dim R As New List(Of PersonalizacionDeColumnasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PersonalizacionDeColumnasListaES._SeccionID, False, Parametros) 
