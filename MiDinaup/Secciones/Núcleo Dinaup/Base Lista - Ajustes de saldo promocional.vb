...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeSaldoPromocionalBaseListaC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeSaldoPromocionalBaseListaES._SeccionID, False, Parametros) 
