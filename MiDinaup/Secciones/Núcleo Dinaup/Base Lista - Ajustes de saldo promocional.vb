...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of AjustesDeSaldoPromocionalBaseListaC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AjustesDeSaldoPromocionalBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AjustesDeSaldoPromocionalBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""c9fc48d8-a322-4c32-bba2-e0da377b5c87"",""titulo"": ""Base Lista - Ajustes de saldo promocional"",""iconoid"": """",""etiquetasingular"": ""Ajuste de saldo promocional"",""etiquetaplural"": ""Ajustes de saldo promocional"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""c9fc48d8-a322-4c32-bba2-e0da377b5c87"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Ajuste de saldo promocional (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Ajuste de saldo promocional (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""3cdb877c-0318-4594-8d69-1cd2d4db495e"",""titulo"": ""Base - Ajustes de saldo promocional"",""iconoid"": ""fc4e6fd7-d82c-42e3-b0d9-35cfefd324aa"",""etiquetasingular"": ""Ajuste de saldo promocional"",""etiquetaplural"": ""Ajustes de saldo promocional"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""3cdb877c-0318-4594-8d69-1cd2d4db495e"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Ajuste de saldo promocional (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Ajuste de saldo promocional (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Ajuste de saldo promocional (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Ajuste de saldo promocional (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200401131814"), _Datos.Leer_String("pr_200401131814.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_200401131823")
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200401131815"), _Datos.Leer_String("pr_200401131815.nombre"))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200401131820"), _Datos.Leer_String("pr_200401131820.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_200401131818")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200401131816"), _Datos.Leer_String("pr_200401131816.nombre"))
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_200401131817")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_200401131819")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_200401131821")
         ...
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_200401131814",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_200401131814","")
         End if
         R.add("pr_200401131823", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_200401131815",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_200401131815","")
         End if
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_200401131820",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_200401131820","")
         End if
         R.add("pr_200401131818", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_200401131816",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_200401131816","")
         End if
         R.add("pr_200401131817", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_200401131819", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_200401131821", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
