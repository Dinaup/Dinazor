...
Partial Public Class SeccionesD
  Public Class IntegridadDeRegistrosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of IntegridadDeRegistrosBaseListaC )) 
          Dim R As New List(Of IntegridadDeRegistrosBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(IntegridadDeRegistrosBaseListaES._SeccionID, False, Parametros) 
