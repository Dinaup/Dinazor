...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalListaD
      Public Shared _SeccionID As String = "51e40c3e-a1c8-4a23-80d1-ef5173997c08"
      Public Shared _SeccionIDGUID As New Guid("51e40c3e-a1c8-4a23-80d1-ef5173997c08")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of AjustesDeSaldoPromocionalListaC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AjustesDeSaldoPromocionalListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AjustesDeSaldoPromocionalListaC 
          ...
          Return R 
      End Function 
      Public Class AjustesDeSaldoPromocionalListaES
          Public shared _SeccionID as Guid = New Guid("51e40c3e-a1c8-4a23-80d1-ef5173997c08")
      ...
      End Class
      Public Class AjustesDeSaldoPromocionalListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""51e40c3e-a1c8-4a23-80d1-ef5173997c08"",""titulo"": ""Lista - Ajustes de saldo promocional"",""iconoid"": """",""etiquetasingular"": ""Ajuste de saldo promocional"",""etiquetaplural"": ""Ajustes de saldo promocional"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""51e40c3e-a1c8-4a23-80d1-ef5173997c08"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class AjustesDeSaldoPromocionalLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_200401131815")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_200401131815", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_200401131814")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_200401131814", value)
            End Set
          End Property
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_200401131817")
            End Get   
        End Property
