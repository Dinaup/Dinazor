...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeSaldoPromocionalListaC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeSaldoPromocionalListaES._SeccionID, False, Parametros) 
