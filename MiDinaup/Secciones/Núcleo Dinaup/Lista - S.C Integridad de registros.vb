...
Partial Public Class SeccionesD
  Public Class SCIntegridadDeRegistrosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of SCIntegridadDeRegistrosListaC )) 
          Dim R As New List(Of SCIntegridadDeRegistrosListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, SCIntegridadDeRegistrosListaES._SeccionID, False, Campo, Valor) 
