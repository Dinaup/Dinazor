...
Partial Public Class SeccionesD
  Public Class ActividadesDeInformesBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ActividadesDeInformesBaseC )) 
          Dim R As New List(Of ActividadesDeInformesBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ActividadesDeInformesBaseES._SeccionID, False, Parametros) 
