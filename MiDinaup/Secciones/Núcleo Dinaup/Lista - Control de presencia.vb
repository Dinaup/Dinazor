...
Partial Public Class SeccionesD
  Public Class ControlDePresenciaListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ControlDePresenciaListaC )) 
          Dim R As New List(Of ControlDePresenciaListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ControlDePresenciaListaES._SeccionID, False, Parametros) 
