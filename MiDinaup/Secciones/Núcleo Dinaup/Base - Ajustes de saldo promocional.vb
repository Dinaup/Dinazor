...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalBaseD
      Public Class AjustesDeSaldoPromocionalBase_ConListaC
      Public Listador as AjustesDeSaldoPromocionalBaseC
      Public Lista As New List(of AjustesDeSaldoPromocionalBaseListaD.AjustesDeSaldoPromocionalBaseListaC)
        sub new(_listador  as AjustesDeSaldoPromocionalBaseC, _lista as List(of AjustesDeSaldoPromocionalBaseListaD.AjustesDeSaldoPromocionalBaseListaC))
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of AjustesDeSaldoPromocionalBaseC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AjustesDeSaldoPromocionalBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AjustesDeSaldoPromocionalBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of  AjustesDeSaldoPromocionalBase_ConListaC)) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBase_ConListaC )  
          Dim d =  Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AjustesDeSaldoPromocionalBaseES._SeccionID, True, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Dim Obj_Listador As New AjustesDeSaldoPromocionalBaseC 
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Dim Objs_Listas As New List(Of AjustesDeSaldoPromocionalBaseListaD.AjustesDeSaldoPromocionalBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New AjustesDeSaldoPromocionalBaseListaD.AjustesDeSaldoPromocionalBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New AjustesDeSaldoPromocionalBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""3cdb877c-0318-4594-8d69-1cd2d4db495e"",""titulo"": ""Base - Ajustes de saldo promocional"",""iconoid"": ""fc4e6fd7-d82c-42e3-b0d9-35cfefd324aa"",""etiquetasingular"": ""Ajuste de saldo promocional"",""etiquetaplural"": ""Ajustes de saldo promocional"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""3cdb877c-0318-4594-8d69-1cd2d4db495e"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
