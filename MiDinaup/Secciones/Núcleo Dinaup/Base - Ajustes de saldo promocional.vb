...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeSaldoPromocionalBaseC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeSaldoPromocionalBaseES._SeccionID, False, Parametros) 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  AjustesDeSaldoPromocionalBase_ConListaC)) 
          Dim R As New List(Of AjustesDeSaldoPromocionalBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeSaldoPromocionalBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
