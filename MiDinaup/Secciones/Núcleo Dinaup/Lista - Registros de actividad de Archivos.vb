...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeArchivosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeArchivosListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeArchivosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeArchivosListaES._SeccionID, False, Parametros) 
