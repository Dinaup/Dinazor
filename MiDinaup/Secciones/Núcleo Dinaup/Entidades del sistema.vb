...
Partial Public Class SeccionesD
  Public Class EntidadesDelSistemaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EntidadesDelSistemaC )) 
          Dim R As New List(Of EntidadesDelSistemaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntidadesDelSistemaES._SeccionID, False, Parametros) 
