...
Partial Public Class SeccionesD
  Public Class MovimientosInternosDeSaldoAcumuladoBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MovimientosInternosDeSaldoAcumuladoBaseListaC )) 
          Dim R As New List(Of MovimientosInternosDeSaldoAcumuladoBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MovimientosInternosDeSaldoAcumuladoBaseListaES._SeccionID, False, Parametros) 
