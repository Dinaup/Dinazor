...
Partial Public Class SeccionesD
  Public Class AccesosAEmpresasBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AccesosAEmpresasBaseListaC )) 
          Dim R As New List(Of AccesosAEmpresasBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AccesosAEmpresasBaseListaES._SeccionID, False, Parametros) 
