...
Partial Public Class SeccionesD
  Public Class ControlDePresenciaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ControlDePresenciaC )) 
          Dim R As New List(Of ControlDePresenciaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ControlDePresenciaES._SeccionID, False, Parametros) 
