...
Partial Public Class SeccionesD
  Public Class RegistrosDeEliminacionListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeEliminacionListaC )) 
          Dim R As New List(Of RegistrosDeEliminacionListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeEliminacionListaES._SeccionID, False, Parametros) 
