...
Partial Public Class SeccionesD
  Public Class NotificacionesD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of NotificacionesC )) 
          Dim R As New List(Of NotificacionesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(NotificacionesES._SeccionID, False, Parametros) 
