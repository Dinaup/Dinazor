...
Partial Public Class SeccionesD
  Public Class RegistrosDeAccesoASistemaBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeAccesoASistemaBaseListaC )) 
          Dim R As New List(Of RegistrosDeAccesoASistemaBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeAccesoASistemaBaseListaES._SeccionID, False, Parametros) 
