...
Partial Public Class SeccionesD
  Public Class ServidoresListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ServidoresListaC )) 
          Dim R As New List(Of ServidoresListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ServidoresListaES._SeccionID, False, Parametros) 
