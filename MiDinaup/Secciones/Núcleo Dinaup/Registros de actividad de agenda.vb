...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeAgendaC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeAgendaES._SeccionID, False, Parametros) 
