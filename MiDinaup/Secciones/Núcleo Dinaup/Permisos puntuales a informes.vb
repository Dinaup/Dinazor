...
Partial Public Class SeccionesD
  Public Class PermisosPuntualesAInformesD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PermisosPuntualesAInformesC )) 
          Dim R As New List(Of PermisosPuntualesAInformesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PermisosPuntualesAInformesES._SeccionID, False, Parametros) 
