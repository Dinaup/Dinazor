...
Partial Public Class SeccionesD
  Public Class ControlDePresenciaBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ControlDePresenciaBaseC )) 
          Dim R As New List(Of ControlDePresenciaBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ControlDePresenciaBaseES._SeccionID, False, Parametros) 
