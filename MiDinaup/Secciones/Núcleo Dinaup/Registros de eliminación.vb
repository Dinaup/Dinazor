...
Partial Public Class SeccionesD
  Public Class RegistrosDeEliminacionD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeEliminacionC )) 
          Dim R As New List(Of RegistrosDeEliminacionC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeEliminacionES._SeccionID, False, Parametros) 
