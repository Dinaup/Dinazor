...
Partial Public Class SeccionesD
  Public Class RegistrosDeEliminacionD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeEliminacionC )) 
          Dim R As New List(Of RegistrosDeEliminacionC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeEliminacionES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeEliminacionC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As RegistrosDeEliminacionC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of RegistrosDeEliminacionC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of RegistrosDeEliminacionC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, RegistrosDeEliminacionES._SeccionID, Importar, CampoWhere, "") 
      End Function
      ...
      Inherits Base_DatoC
          <DisplayName("Nombre dato")>
          Public Property NombreDato As String
          Public Shared ___NombreDato As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""NombreDato"",""etiqueta"": ""Nombre dato"",""oculta"": false,""formato"": 5,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Nombre dato"",""descripcion"": """",""keyword"": ""NombreDato"",""formato"": 5,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __NombreDato As DinaNETCore.APID.DinaupAPI_CampoC = ___NombreDato
          ...
          <DisplayName("Registro de Acceso")>
          Public Property ReferenciaRegistroDeAcceso As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaRegistroDeAcceso As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaRegistroDeAcceso"",""etiqueta"": ""Registro de Acceso"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""c5250d97-16c1-420f-bd6b-94cf0216ea32"",""titulo"": ""Base - Registros de acceso a sistema"",""iconoid"": ""d601858e-c944-474a-9f6d-fa55326d6ef0"",""etiquetasingular"": ""Registro de acceso a sistema"",""etiquetaplural"": ""Registros de acceso a sistema"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""c5250d97-16c1-420f-bd6b-94cf0216ea32"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Registro de Acceso"",""descripcion"": """",""keyword"": ""ReferenciaRegistroDeAcceso"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaRegistroDeAcceso As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaRegistroDeAcceso
          <DisplayName("Tipo de acción")>
          Public Property TipoDeAccion As EnumRAAccionPapeleraE
          Public Shared ___TipoDeAccion As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""TipoDeAccion"",""etiqueta"": ""Tipo de acción"",""oculta"": false,""formato"": 2,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 39,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [0,1,2],""predefinidos_textos"": [""Indefinido"",""Eliminar"",""Restaurar""],""predefinidos_iconos"": [""https://cdn.dinaup.com/ico/enums/39_0.png"",""https://cdn.dinaup.com/ico/enums/39_1.png"",""https://cdn.dinaup.com/ico/enums/39_2.png""],""filtro"": {""titulo"": ""Tipo de acción"",""descripcion"": """",""keyword"": ""TipoDeAccion"",""formato"": 2,""rol"": 39,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false,""enumeracion"": {""titulo"": ""Enum - R.A Acción papelera"", ""valores"": [{""valor"": 0, ""titulo"": ""Indefinido""},{""valor"": 1, ""titulo"": ""Eliminar""},{""valor"": 2, ""titulo"": ""Restaurar""}]}},""solovalorespredefinidos"": true}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""e1556eb8-d914-453b-982a-b3ad48985ae4"",""titulo"": ""Registros de eliminación"",""iconoid"": ""67995210-d882-457d-9236-d8ef357cb391"",""etiquetasingular"": ""Registro de eliminación"",""etiquetaplural"": ""Registros de eliminación"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""e1556eb8-d914-453b-982a-b3ad48985ae4"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.NombreDato = _Datos.Leer_String("pr_4713bdex307wc")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_1463107681x368wd")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_14c9f3f003x288wd")
          me.ReferenciaElemento = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_40a65b6xa2wc"), _Datos.Leer_String("pr_40a65b6xa2wc.nombre"))
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_1464b597f5g348wd")
          me.ReferenciaSeccion = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_40a655fx2wc"), _Datos.Leer_String("pr_40a655fx2wc.nombre"))
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1463107650x3c2wd"), _Datos.Leer_String("pr_1463107650x3c2wd.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_1463149084hb3wd")
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1464b42855x76wd"), _Datos.Leer_String("pr_1464b42855x76wd.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_776ae2awd")
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_146310770cx134wd"), _Datos.Leer_String("pr_146310770cx134wd.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1464b4282dx21fwd"), _Datos.Leer_String("pr_1464b4282dx21fwd.nombre"))
          me.ReferenciaRegistroDeAcceso = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_185b356df1x299wd"), _Datos.Leer_String("pr_185b356df1x299wd.nombre"))
          me.TipoDeAccion = _Datos.Leer_EnumRAAccionPapeleraE("pr_7c20d03wd")
          me.ReferenciaServidor = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040212261"), _Datos.Leer_String("pr_50040212261.nombre"))
         ...
         R.add("pr_4713bdex307wc", me.NombreDato.AdaptarMySQL_String())
         R.add("pr_1463107681x368wd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_14c9f3f003x288wd", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaElemento IsNot nothing then
           R.add("pr_40a65b6xa2wc",me.ReferenciaElemento.ID.STR())
         Else
           R.add("pr_40a65b6xa2wc","")
         End if
         R.add("pr_1464b597f5g348wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaSeccion IsNot nothing then
           R.add("pr_40a655fx2wc",me.ReferenciaSeccion.ID.STR())
         Else
           R.add("pr_40a655fx2wc","")
         End if
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_1463107650x3c2wd",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_1463107650x3c2wd","")
         End if
         R.add("pr_1463149084hb3wd", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_1464b42855x76wd",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_1464b42855x76wd","")
         End if
         R.add("pr_776ae2awd", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_146310770cx134wd",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_146310770cx134wd","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_1464b4282dx21fwd",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_1464b4282dx21fwd","")
         End if
         If Me.ReferenciaRegistroDeAcceso IsNot nothing then
           R.add("pr_185b356df1x299wd",me.ReferenciaRegistroDeAcceso.ID.STR())
         Else
           R.add("pr_185b356df1x299wd","")
         End if
         R.add("pr_7c20d03wd", me.TipoDeAccion.AdaptarMySQL_EnumRAAccionPapeleraE())
         If Me.ReferenciaServidor IsNot nothing then
           R.add("pr_50040212261",me.ReferenciaServidor.ID.STR())
         Else
           R.add("pr_50040212261","")
         End if
    ...
    End Sub
        ...
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_776ae2awd")
            End Get   
        End Property
        ...
        Public ReadOnly property ReferenciaRegistroDeAcceso As Guid
            ...
            End Get   
        End Property
        Public ReadOnly property TipoDeAccion As EnumRAAccionPapeleraE
            get
                return me.GetValue_Int("pr_7c20d03wd")
            End Get   
        End Property
