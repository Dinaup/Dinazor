...
Partial Public Class SeccionesD
  Public Class ActividadesDeInformesBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ActividadesDeInformesBaseListaC )) 
          Dim R As New List(Of ActividadesDeInformesBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ActividadesDeInformesBaseListaES._SeccionID, False, Parametros) 
