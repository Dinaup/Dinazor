...
Partial Public Class SeccionesD
  Public Class ModulosD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ModulosC )) 
          Dim R As New List(Of ModulosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ModulosES._SeccionID, False, Parametros) 
