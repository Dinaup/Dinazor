...
Partial Public Class SeccionesD
  Public Class IntegridadDeRegistrosBaseD
      Public Class IntegridadDeRegistrosBase_ConListaC
      Public Listador as IntegridadDeRegistrosBaseC
      Public Lista As New List(of IntegridadDeRegistrosBaseListaD.IntegridadDeRegistrosBaseListaC)
        sub new(_listador  as IntegridadDeRegistrosBaseC, _lista as List(of IntegridadDeRegistrosBaseListaD.IntegridadDeRegistrosBaseListaC))
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of IntegridadDeRegistrosBaseC )) 
          Dim R As New List(Of IntegridadDeRegistrosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(IntegridadDeRegistrosBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New IntegridadDeRegistrosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  IntegridadDeRegistrosBase_ConListaC)) 
          Dim R As New List(Of IntegridadDeRegistrosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(IntegridadDeRegistrosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of IntegridadDeRegistrosBaseListaD.IntegridadDeRegistrosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New IntegridadDeRegistrosBaseListaD.IntegridadDeRegistrosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New IntegridadDeRegistrosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""dd10b9d7-771b-4957-93fb-aea098b2b13e"",""titulo"": ""Base - Integridad de registros"",""iconoid"": ""e815be98-6a31-40a4-85f5-da6a2b3f87a0"",""etiquetasingular"": ""Registro de Integridad de registros"",""etiquetaplural"": ""Registros de Integridad de registros"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""dd10b9d7-771b-4957-93fb-aea098b2b13e"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_71aebafwd")
         ...
         R.add("pr_71aebafwd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
