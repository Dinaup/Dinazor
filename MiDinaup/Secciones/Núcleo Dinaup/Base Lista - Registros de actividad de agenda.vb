...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeAgendaBaseListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeAgendaBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadDeAgendaBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""d9df88a5-7490-4a6b-9514-b15a756d35c3"",""titulo"": ""Base Lista - Registros de actividad de agenda"",""iconoid"": """",""etiquetasingular"": ""Registro de actividad de agenda"",""etiquetaplural"": ""Registros de actividad de agenda"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""d9df88a5-7490-4a6b-9514-b15a756d35c3"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Registro de actividad de agenda (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Registro de actividad de agenda (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""857c0641-69e7-4118-81be-980b6b4a691d"",""titulo"": ""Base - Registros de actividad de agenda"",""iconoid"": ""794b629b-a476-4cf1-9eba-c713fd0f2a78"",""etiquetasingular"": ""Registro de actividad de agenda"",""etiquetaplural"": ""Registros de actividad de agenda"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""857c0641-69e7-4118-81be-980b6b4a691d"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Registro de actividad de agenda (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Registro de actividad de agenda (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Registro de actividad de agenda (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Registro de actividad de agenda (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e74wd"), _Datos.Leer_String("pr_7c25e74wd.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_7c25e8awd")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_7c25e7cwd")
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e84wd"), _Datos.Leer_String("pr_7c25e84wd.nombre"))
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e78wd"), _Datos.Leer_String("pr_7c25e78wd.nombre"))
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_7c25e86wd")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_7c25e7awd")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_7c25e7ewd")
         ...
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_7c25e74wd",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_7c25e74wd","")
         End if
         R.add("pr_7c25e8awd", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_7c25e7cwd", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_7c25e84wd",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_7c25e84wd","")
         End if
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_7c25e78wd",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_7c25e78wd","")
         End if
         R.add("pr_7c25e86wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_7c25e7awd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_7c25e7ewd", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
