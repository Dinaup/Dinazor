...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeAgendaBaseListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeAgendaBaseListaES._SeccionID, False, Parametros) 
