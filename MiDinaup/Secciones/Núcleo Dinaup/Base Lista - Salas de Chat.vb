...
Partial Public Class SeccionesD
  Public Class SalasDeChatBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of SalasDeChatBaseListaC )) 
          Dim R As New List(Of SalasDeChatBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, SalasDeChatBaseListaES._SeccionID, False, Campo, Valor) 
