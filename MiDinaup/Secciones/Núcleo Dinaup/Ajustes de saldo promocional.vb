...
Partial Public Class SeccionesD
  Public Class AjustesDeSaldoPromocionalD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeSaldoPromocionalC )) 
          Dim R As New List(Of AjustesDeSaldoPromocionalC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeSaldoPromocionalES._SeccionID, False, Parametros) 
