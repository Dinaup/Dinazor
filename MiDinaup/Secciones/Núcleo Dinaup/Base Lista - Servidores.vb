...
Partial Public Class SeccionesD
  Public Class ServidoresBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ServidoresBaseListaC )) 
          Dim R As New List(Of ServidoresBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ServidoresBaseListaES._SeccionID, False, Parametros) 
