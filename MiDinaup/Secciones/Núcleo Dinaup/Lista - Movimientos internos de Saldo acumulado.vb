...
Partial Public Class SeccionesD
  Public Class MovimientosInternosDeSaldoAcumuladoListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of MovimientosInternosDeSaldoAcumuladoListaC )) 
          Dim R As New List(Of MovimientosInternosDeSaldoAcumuladoListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, MovimientosInternosDeSaldoAcumuladoListaES._SeccionID, False, Campo, Valor) 
