...
Partial Public Class SeccionesD
  Public Class TurnosDeTrabajoD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TurnosDeTrabajoC )) 
          Dim R As New List(Of TurnosDeTrabajoC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TurnosDeTrabajoES._SeccionID, False, Parametros) 
