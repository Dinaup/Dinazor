...
Partial Public Class SeccionesD
  Public Class ChatSalasListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ChatSalasListaC )) 
          Dim R As New List(Of ChatSalasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ChatSalasListaES._SeccionID, False, Parametros) 
