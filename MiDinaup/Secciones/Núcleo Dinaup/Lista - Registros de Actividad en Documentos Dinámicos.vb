...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadEnDocumentosDinamicosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadEnDocumentosDinamicosListaC )) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadEnDocumentosDinamicosListaES._SeccionID, False, Parametros) 
