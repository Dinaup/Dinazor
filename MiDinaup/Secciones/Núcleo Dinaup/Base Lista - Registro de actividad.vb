...
Partial Public Class SeccionesD
  Public Class RegistroDeActividadBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeActividadBaseListaC )) 
          Dim R As New List(Of RegistroDeActividadBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeActividadBaseListaES._SeccionID, False, Parametros) 
