...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeAgendaBaseC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeAgendaBaseES._SeccionID, False, Parametros) 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  RegistrosDeActividadDeAgendaBase_ConListaC)) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeAgendaBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
