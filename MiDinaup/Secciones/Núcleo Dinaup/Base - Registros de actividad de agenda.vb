...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaBaseD
      Public Class RegistrosDeActividadDeAgendaBase_ConListaC
      Public Listador as RegistrosDeActividadDeAgendaBaseC
      Public Lista As New List(of RegistrosDeActividadDeAgendaBaseListaD.RegistrosDeActividadDeAgendaBaseListaC)
        sub new(_listador  as RegistrosDeActividadDeAgendaBaseC, _lista as List(of RegistrosDeActividadDeAgendaBaseListaD.RegistrosDeActividadDeAgendaBaseListaC))
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeAgendaBaseC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeAgendaBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadDeAgendaBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of  RegistrosDeActividadDeAgendaBase_ConListaC)) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaBase_ConListaC )  
          Dim d =  Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeAgendaBaseES._SeccionID, True, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Dim Obj_Listador As New RegistrosDeActividadDeAgendaBaseC 
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Dim Objs_Listas As New List(Of RegistrosDeActividadDeAgendaBaseListaD.RegistrosDeActividadDeAgendaBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New RegistrosDeActividadDeAgendaBaseListaD.RegistrosDeActividadDeAgendaBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New RegistrosDeActividadDeAgendaBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      ...
      Inherits Base_DatoC
          ...
          <DisplayName("Agenda elemento")>
          Public Property ReferenciaAgendaElemento As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaAgendaElemento As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaAgendaElemento"",""etiqueta"": ""Agenda elemento"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Agenda elemento"",""descripcion"": """",""keyword"": ""ReferenciaAgendaElemento"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaAgendaElemento As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaAgendaElemento
          ...
          <DisplayName("Sección agenda")>
          Public Property ReferenciaSeccionAgenda As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaSeccionAgenda As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaSeccionAgenda"",""etiqueta"": ""Sección agenda"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": ""plantillasp"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Sección agenda"",""descripcion"": """",""keyword"": ""ReferenciaSeccionAgenda"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaSeccionAgenda As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaSeccionAgenda
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""857c0641-69e7-4118-81be-980b6b4a691d"",""titulo"": ""Base - Registros de actividad de agenda"",""iconoid"": ""794b629b-a476-4cf1-9eba-c713fd0f2a78"",""etiquetasingular"": ""Registro de actividad de agenda"",""etiquetaplural"": ""Registros de actividad de agenda"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""857c0641-69e7-4118-81be-980b6b4a691d"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_7c25e8cwd")
          me.ReferenciaRegistroDeAccesoSesion = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c27cebwd"), _Datos.Leer_String("pr_7c27cebwd.nombre"))
          me.ReferenciaAgendaElemento = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c27ce9wd"), _Datos.Leer_String("pr_7c27ce9wd.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_7c25e64wd")
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e72wd"), _Datos.Leer_String("pr_7c25e72wd.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e5cwd"), _Datos.Leer_String("pr_7c25e5cwd.nombre"))
          me.VecesFoco = _Datos.Leer_Integer("pr_7c48d94wd")
          me.AgendaNombre = _Datos.Leer_String("pr_7c28201wd")
          me.SegundosActividad = _Datos.Leer_Integer("pr_7c48d92wd")
          me.FinalizacionInesperada = _Datos.Leer_Boolean("pr_7c49705wd")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_7c25e6cwd")
          me.TiempoEjecucion = _Datos.Leer_Decimal("pr_7c49703wd")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_7c25e62wd")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_7c25e88wd")
          me.SegundosAbierto = _Datos.Leer_Integer("pr_7c48d8ewd")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c25e60wd"), _Datos.Leer_String("pr_7c25e60wd.nombre"))
          me.ReferenciaSeccionAgenda = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_7c27ce7wd"), _Datos.Leer_String("pr_7c27ce7wd.nombre"))
          me.ReferenciaServidor = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040212263"), _Datos.Leer_String("pr_50040212263.nombre"))
         ...
         R.add("pr_7c25e8cwd", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaRegistroDeAccesoSesion IsNot nothing then
           R.add("pr_7c27cebwd",me.ReferenciaRegistroDeAccesoSesion.ID.STR())
         Else
           R.add("pr_7c27cebwd","")
         End if
         If Me.ReferenciaAgendaElemento IsNot nothing then
           R.add("pr_7c27ce9wd",me.ReferenciaAgendaElemento.ID.STR())
         Else
           R.add("pr_7c27ce9wd","")
         End if
         R.add("pr_7c25e64wd", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_7c25e72wd",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_7c25e72wd","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_7c25e5cwd",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_7c25e5cwd","")
         End if
         R.add("pr_7c48d94wd", me.VecesFoco.AdaptarMySQL_Integer())
         R.add("pr_7c28201wd", me.AgendaNombre.AdaptarMySQL_String())
         R.add("pr_7c48d92wd", me.SegundosActividad.AdaptarMySQL_Integer())
         R.add("pr_7c49705wd", me.FinalizacionInesperada.AdaptarMySQL_Boolean())
         R.add("pr_7c25e6cwd", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_7c49703wd", me.TiempoEjecucion.AdaptarMySQL_Decimal())
         R.add("pr_7c25e62wd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_7c25e88wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_7c48d8ewd", me.SegundosAbierto.AdaptarMySQL_Integer())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_7c25e60wd",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_7c25e60wd","")
         End if
         If Me.ReferenciaSeccionAgenda IsNot nothing then
           R.add("pr_7c27ce7wd",me.ReferenciaSeccionAgenda.ID.STR())
         Else
           R.add("pr_7c27ce7wd","")
         End if
         If Me.ReferenciaServidor IsNot nothing then
           R.add("pr_50040212263",me.ReferenciaServidor.ID.STR())
         Else
           R.add("pr_50040212263","")
         End if
