...
Partial Public Class SeccionesD
  Public Class RegistroDeActividadBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeActividadBaseC )) 
          Dim R As New List(Of RegistroDeActividadBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeActividadBaseES._SeccionID, False, Parametros) 
