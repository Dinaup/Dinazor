...
Partial Public Class SeccionesD
  Public Class PersonalizacionDeInformesD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PersonalizacionDeInformesC )) 
          Dim R As New List(Of PersonalizacionDeInformesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PersonalizacionDeInformesES._SeccionID, False, Parametros) 
