...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeServidorD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeServidorC )) 
          Dim R As New List(Of RegistrosDeActividadDeServidorC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeServidorES._SeccionID, False, Parametros) 
