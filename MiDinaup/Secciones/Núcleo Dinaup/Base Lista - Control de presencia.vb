...
Partial Public Class SeccionesD
  Public Class ControlDePresenciaBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ControlDePresenciaBaseListaC )) 
          Dim R As New List(Of ControlDePresenciaBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ControlDePresenciaBaseListaES._SeccionID, False, Parametros) 
