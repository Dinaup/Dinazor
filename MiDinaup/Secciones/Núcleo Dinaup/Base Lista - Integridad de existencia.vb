...
Partial Public Class SeccionesD
  Public Class IntegridadDeExistenciaBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of IntegridadDeExistenciaBaseListaC )) 
          Dim R As New List(Of IntegridadDeExistenciaBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(IntegridadDeExistenciaBaseListaES._SeccionID, False, Parametros) 
