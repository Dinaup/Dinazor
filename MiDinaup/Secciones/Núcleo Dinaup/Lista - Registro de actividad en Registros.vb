...
Partial Public Class SeccionesD
  Public Class RegistroDeActividadEnRegistrosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeActividadEnRegistrosListaC )) 
          Dim R As New List(Of RegistroDeActividadEnRegistrosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeActividadEnRegistrosListaES._SeccionID, False, Parametros) 
