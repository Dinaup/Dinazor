...
Partial Public Class SeccionesD
  Public Class NumeracionesSeriesD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of NumeracionesSeriesC )) 
          Dim R As New List(Of NumeracionesSeriesC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, NumeracionesSeriesES._SeccionID, False, Campo, Valor) 
