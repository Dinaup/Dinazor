...
Partial Public Class SeccionesD
  Public Class MovimientosInternosDeSaldoAcumuladoBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of MovimientosInternosDeSaldoAcumuladoBaseC )) 
          Dim R As New List(Of MovimientosInternosDeSaldoAcumuladoBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, MovimientosInternosDeSaldoAcumuladoBaseES._SeccionID, False, Campo, Valor) 
