...
Partial Public Class SeccionesD
  Public Class UbicacionesD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of UbicacionesC )) 
          Dim R As New List(Of UbicacionesC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, UbicacionesES._SeccionID, False, Campo, Valor) 
