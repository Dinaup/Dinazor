...
Partial Public Class SeccionesD
  Public Class HorasExtraordinariasListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of HorasExtraordinariasListaC )) 
          Dim R As New List(Of HorasExtraordinariasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(HorasExtraordinariasListaES._SeccionID, False, Parametros) 
