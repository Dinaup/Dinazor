...
Partial Public Class SeccionesD
  Public Class RegistroDeActividadEnRegistrosD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeActividadEnRegistrosC )) 
          Dim R As New List(Of RegistroDeActividadEnRegistrosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeActividadEnRegistrosES._SeccionID, False, Parametros) 
