...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaListaD
      Public Shared _SeccionID As String = "d3c25cc5-afec-40ae-ac65-5cf7b74793b0"
      Public Shared _SeccionIDGUID As New Guid("d3c25cc5-afec-40ae-ac65-5cf7b74793b0")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeAgendaListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeAgendaListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadDeAgendaListaC 
          ...
          Return R 
      End Function 
      Public Class RegistrosDeActividadDeAgendaListaES
          Public shared _SeccionID as Guid = New Guid("d3c25cc5-afec-40ae-ac65-5cf7b74793b0")
      ...
      End Class
      Public Class RegistrosDeActividadDeAgendaListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""d3c25cc5-afec-40ae-ac65-5cf7b74793b0"",""titulo"": ""Lista - Registros de actividad de agenda"",""iconoid"": """",""etiquetasingular"": ""Registro de actividad de agenda"",""etiquetaplural"": ""Registros de actividad de agenda"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""d3c25cc5-afec-40ae-ac65-5cf7b74793b0"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class RegistrosDeActividadDeAgendaLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_7c25e7awd")
            End Get   
        End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_7c25e74wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_7c25e74wd", value)
            End Set
          End Property
