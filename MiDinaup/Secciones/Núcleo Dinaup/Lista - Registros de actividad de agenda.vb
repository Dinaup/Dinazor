...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeAgendaListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeAgendaListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeAgendaListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeAgendaListaES._SeccionID, False, Parametros) 
