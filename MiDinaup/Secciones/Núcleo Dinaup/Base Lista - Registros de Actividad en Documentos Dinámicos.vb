...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadEnDocumentosDinamicosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadEnDocumentosDinamicosBaseListaC )) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadEnDocumentosDinamicosBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadEnDocumentosDinamicosBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4850cc53-190a-46f0-b5cb-734f6de747e5"",""titulo"": ""Base Lista - Registros de Actividad en Documentos Dinámicos"",""iconoid"": """",""etiquetasingular"": ""Registro de Actividad en Documentos Dinámicos"",""etiquetaplural"": ""Registros de Actividad en Documentos Dinámicos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""4850cc53-190a-46f0-b5cb-734f6de747e5"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Registro de Actividad en Documentos Dinámicos (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Registro de Actividad en Documentos Dinámicos (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""bafabfa9-37a8-4013-b424-6c3cca9921c9"",""titulo"": ""Base - Registros de Actividad en Documentos Dinámicos"",""iconoid"": ""a500bd11-895a-477c-a8c4-d8a150a656ba"",""etiquetasingular"": ""Registro de Actividad en Documentos Dinámicos"",""etiquetaplural"": ""Registros de Actividad en Documentos Dinámicos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""bafabfa9-37a8-4013-b424-6c3cca9921c9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Registro de Actividad en Documentos Dinámicos (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Registro de Actividad en Documentos Dinámicos (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Registro de Actividad en Documentos Dinámicos (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Registro de Actividad en Documentos Dinámicos (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589028"), _Datos.Leer_String("pr_600403589028.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_600403589027")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_600403589025")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_600403589026")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589024"), _Datos.Leer_String("pr_600403589024.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589022"), _Datos.Leer_String("pr_600403589022.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_600403589029")
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589023"), _Datos.Leer_String("pr_600403589023.nombre"))
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_600403589030")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_600403589028",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_600403589028","")
         End if
         R.add("pr_600403589027", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_600403589025", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_600403589026", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_600403589024",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_600403589024","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_600403589022",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_600403589022","")
         End if
         R.add("pr_600403589029", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_600403589023",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_600403589023","")
         End if
         R.add("pr_600403589030", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
