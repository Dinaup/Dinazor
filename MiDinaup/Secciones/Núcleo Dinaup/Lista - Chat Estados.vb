...
Partial Public Class SeccionesD
  Public Class ChatEstadosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ChatEstadosListaC )) 
          Dim R As New List(Of ChatEstadosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ChatEstadosListaES._SeccionID, False, Parametros) 
