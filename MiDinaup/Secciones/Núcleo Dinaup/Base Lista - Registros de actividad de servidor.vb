...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeServidorBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeServidorBaseListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeServidorBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeServidorBaseListaES._SeccionID, False, Parametros) 
