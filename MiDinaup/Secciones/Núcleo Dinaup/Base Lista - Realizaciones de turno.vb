...
Partial Public Class SeccionesD
  Public Class RealizacionesDeTurnoBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RealizacionesDeTurnoBaseListaC )) 
          Dim R As New List(Of RealizacionesDeTurnoBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RealizacionesDeTurnoBaseListaES._SeccionID, False, Parametros) 
