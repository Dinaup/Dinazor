...
Partial Public Class SeccionesD
  Public Class MovimientosInternosDeSaldoAcumuladoD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MovimientosInternosDeSaldoAcumuladoC )) 
          Dim R As New List(Of MovimientosInternosDeSaldoAcumuladoC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MovimientosInternosDeSaldoAcumuladoES._SeccionID, False, Parametros) 
