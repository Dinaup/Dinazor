...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeArchivosD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeArchivosC )) 
          Dim R As New List(Of RegistrosDeActividadDeArchivosC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeArchivosES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadDeArchivosC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As RegistrosDeActividadDeArchivosC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of RegistrosDeActividadDeArchivosC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of RegistrosDeActividadDeArchivosC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, RegistrosDeActividadDeArchivosES._SeccionID, Importar, CampoWhere, "") 
      End Function
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""a0aa8e03-4fe5-4e52-9d89-ec5f6d237212"",""titulo"": ""Registros de actividad de Archivos"",""iconoid"": ""8219414b-06fa-42b0-bf5e-5a837c33e841"",""etiquetasingular"": ""Registros de actividad de archivo"",""etiquetaplural"": ""Registros de actividad de archivos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""a0aa8e03-4fe5-4e52-9d89-ec5f6d237212"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
    ...
    End Sub
        ...
        Public ReadOnly property SegundosActividad As Integer
            get
                return me.GetValue_Int("pr_7c49e39wd")
            End Get   
        End Property
        ...
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_77611e4wd")
            End Get   
        End Property
        ...
        Public ReadOnly property DuracionTransferenciaDeDatos As Integer
            get
                return me.GetValue_Int("pr_7c343aewd")
            End Get   
        End Property
        ...
        Public ReadOnly property ReferenciaAutorDelAlta As Guid
            ...
            End Get   
        End Property
        Public ReadOnly property TipoDeEvento As EnumRAArchivoE
            get
                return me.GetValue_Int("pr_7c34961wd")
            End Get   
        End Property
        ...
        Public ReadOnly property SegundosAbierto As Integer
            get
                return me.GetValue_Int("pr_7c49e3bwd")
            End Get   
        End Property
        ...
        Public ReadOnly property VecesFoco As Integer
            get
                return me.GetValue_Int("pr_7c49e37wd")
            End Get   
        End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
