...
Partial Public Class SeccionesD
  Public Class AccesosAUbicacionesListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AccesosAUbicacionesListaC )) 
          Dim R As New List(Of AccesosAUbicacionesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AccesosAUbicacionesListaES._SeccionID, False, Parametros) 
