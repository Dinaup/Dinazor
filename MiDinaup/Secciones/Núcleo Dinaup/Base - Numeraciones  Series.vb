...
Partial Public Class SeccionesD
  Public Class NumeracionesSeriesBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of NumeracionesSeriesBaseC )) 
          Dim R As New List(Of NumeracionesSeriesBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(NumeracionesSeriesBaseES._SeccionID, False, Parametros) 
