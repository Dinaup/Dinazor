...
Partial Public Class SeccionesD
  Public Class NumeracionesSeriesBaseD
      Public Shared _SeccionID As String = "a93edb96-3ad2-4498-a1ca-696737b93cea"
      Public Shared _SeccionIDGUID As New Guid("a93edb96-3ad2-4498-a1ca-696737b93cea")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of NumeracionesSeriesBaseC )) 
          Dim R As New List(Of NumeracionesSeriesBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, NumeracionesSeriesBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New NumeracionesSeriesBaseC 
          ...
          Return R 
      End Function 
      Public Class NumeracionesSeriesBaseES
          Public shared _SeccionID as Guid = New Guid("a93edb96-3ad2-4498-a1ca-696737b93cea")
      ...
      Public Shared ExportarEnModulos$ = "pr_14630fe690x1a2wd"
      Public Shared FechaAlta_UTC$ = "pr_14c9f3da34g31fwd"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_1464b58cf8i89wd"
      ...
      End Class
      Public Class NumeracionesSeriesBaseC
      Inherits Base_DatoC
          <Description("1")>
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""a93edb96-3ad2-4498-a1ca-696737b93cea"",""titulo"": ""Base - Numeraciones / Series"",""iconoid"": ""5ae6b089-a12a-417c-92c2-d64de875e355"",""etiquetasingular"": ""Numeración / Serie"",""etiquetaplural"": ""Numeraciones / Series"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""a93edb96-3ad2-4498-a1ca-696737b93cea"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_1464b58cf8i89wd")
         ...
         R.add("pr_1464b58cf8i89wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
