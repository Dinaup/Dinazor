...
Partial Public Class SeccionesD
  Public Class MensajesChatBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MensajesChatBaseListaC )) 
          Dim R As New List(Of MensajesChatBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MensajesChatBaseListaES._SeccionID, False, Parametros) 
