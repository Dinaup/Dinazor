...
Partial Public Class SeccionesD
  Public Class HorasExtraordinariasD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of HorasExtraordinariasC )) 
          Dim R As New List(Of HorasExtraordinariasC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, HorasExtraordinariasES._SeccionID, False, Campo, Valor) 
