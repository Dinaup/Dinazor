...
Partial Public Class SeccionesD
  Public Class AccesosAUbicacionesBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of AccesosAUbicacionesBaseListaC )) 
          Dim R As New List(Of AccesosAUbicacionesBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, AccesosAUbicacionesBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AccesosAUbicacionesBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""bb4dfb45-89b0-4b42-8e68-882477f4189c"",""titulo"": ""Base Lista - Accesos a ubicaciones"",""iconoid"": """",""etiquetasingular"": ""Acceso a ubicación"",""etiquetaplural"": ""Accesos a ubicaciones"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""bb4dfb45-89b0-4b42-8e68-882477f4189c"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Acceso a ubicación (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Acceso a ubicación (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4661d9eb-7888-4747-b096-04ff049775ff"",""titulo"": ""Base - Accesos a ubicaciones"",""iconoid"": ""1e854bf0-f3da-431e-a046-33382063dca3"",""etiquetasingular"": ""Acceso a ubicación"",""etiquetaplural"": ""Accesos a ubicaciones"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""4661d9eb-7888-4747-b096-04ff049775ff"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Acceso a ubicación (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Acceso a ubicación (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Acceso a ubicación (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Acceso a ubicación (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_30040480301022"), _Datos.Leer_String("pr_30040480301022.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_30040480301021")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_30040480301018"), _Datos.Leer_String("pr_30040480301018.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_30040480301016"), _Datos.Leer_String("pr_30040480301016.nombre"))
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_30040480301019")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_30040480301020")
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_30040480301017"), _Datos.Leer_String("pr_30040480301017.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_30040480301023")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_30040480301024")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_30040480301022",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_30040480301022","")
         End if
         R.add("pr_30040480301021", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_30040480301018",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_30040480301018","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_30040480301016",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_30040480301016","")
         End if
         R.add("pr_30040480301019", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_30040480301020", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_30040480301017",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_30040480301017","")
         End if
         R.add("pr_30040480301023", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_30040480301024", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
