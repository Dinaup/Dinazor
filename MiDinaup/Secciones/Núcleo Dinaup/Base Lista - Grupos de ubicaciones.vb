...
Partial Public Class SeccionesD
  Public Class GruposDeUbicacionesBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of GruposDeUbicacionesBaseListaC )) 
          Dim R As New List(Of GruposDeUbicacionesBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(GruposDeUbicacionesBaseListaES._SeccionID, False, Parametros) 
