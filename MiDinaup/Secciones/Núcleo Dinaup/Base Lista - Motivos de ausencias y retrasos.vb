...
Partial Public Class SeccionesD
  Public Class MotivosDeAusenciasYRetrasosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MotivosDeAusenciasYRetrasosBaseListaC )) 
          Dim R As New List(Of MotivosDeAusenciasYRetrasosBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MotivosDeAusenciasYRetrasosBaseListaES._SeccionID, False, Parametros) 
