...
Partial Public Class SeccionesD
  Public Class MotivosDeAusenciasYRetrasosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of MotivosDeAusenciasYRetrasosBaseListaC )) 
          Dim R As New List(Of MotivosDeAusenciasYRetrasosBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, MotivosDeAusenciasYRetrasosBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New MotivosDeAusenciasYRetrasosBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""2b4cc994-b07d-4e7c-b914-426fdf9d4975"",""titulo"": ""Base Lista - Motivos de ausencias y retrasos"",""iconoid"": """",""etiquetasingular"": ""Motivo de ausencias y retrasos"",""etiquetaplural"": ""Motivos de ausencias y retrasos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""2b4cc994-b07d-4e7c-b914-426fdf9d4975"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Motivo de ausencias y retrasos (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Motivo de ausencias y retrasos (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""86d66f59-4f8f-457d-8a05-f1c52f423b90"",""titulo"": ""Base - Motivos de ausencias y retrasos"",""iconoid"": ""93467278-d6f7-4d1e-9a79-b419778f9b10"",""etiquetasingular"": ""Motivo de ausencias y retrasos"",""etiquetaplural"": ""Motivos de ausencias y retrasos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""86d66f59-4f8f-457d-8a05-f1c52f423b90"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Motivo de ausencias y retrasos (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Motivo de ausencias y retrasos (Listador) Eliminadoo *")>
          ...
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_100402122421"), _Datos.Leer_String("pr_100402122421.nombre"))
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_100402122417"), _Datos.Leer_String("pr_100402122417.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_100402122420")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_100402122419")
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_100402122422")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_100402122423")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_100402122421",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_100402122421","")
         End if
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_100402122417",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_100402122417","")
         End if
         R.add("pr_100402122420", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_100402122419", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         R.add("pr_100402122422", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_100402122423", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
