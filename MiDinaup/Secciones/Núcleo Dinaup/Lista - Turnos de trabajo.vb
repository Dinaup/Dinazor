...
Partial Public Class SeccionesD
  Public Class TurnosDeTrabajoListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TurnosDeTrabajoListaC )) 
          Dim R As New List(Of TurnosDeTrabajoListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TurnosDeTrabajoListaES._SeccionID, False, Parametros) 
