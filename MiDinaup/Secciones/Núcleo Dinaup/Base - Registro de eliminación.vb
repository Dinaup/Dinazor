...
Partial Public Class SeccionesD
  Public Class RegistroDeEliminacionBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistroDeEliminacionBaseC )) 
          Dim R As New List(Of RegistroDeEliminacionBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistroDeEliminacionBaseES._SeccionID, False, Parametros) 
