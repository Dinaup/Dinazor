...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeServidorListaD
      Public Shared _SeccionID As String = "1ab91295-59fc-43b5-9a6d-3085d24cc978"
      Public Shared _SeccionIDGUID As New Guid("1ab91295-59fc-43b5-9a6d-3085d24cc978")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadDeServidorListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeServidorListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadDeServidorListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadDeServidorListaC 
          ...
          Return R 
      End Function 
      Public Class RegistrosDeActividadDeServidorListaES
          Public shared _SeccionID as Guid = New Guid("1ab91295-59fc-43b5-9a6d-3085d24cc978")
      ...
      End Class
      Public Class RegistrosDeActividadDeServidorListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""1ab91295-59fc-43b5-9a6d-3085d24cc978"",""titulo"": ""Lista - Registros de actividad de servidor"",""iconoid"": """",""etiquetasingular"": ""Log de servidor"",""etiquetaplural"": ""Logs de servidores"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""1ab91295-59fc-43b5-9a6d-3085d24cc978"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_70b1fc1wd"), _Datos.Leer_String("pr_70b1fc1wd.nombre"))
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_70b1fc9wd")
         ...
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_70b1fc1wd",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_70b1fc1wd","")
         End if
         R.add("pr_70b1fc9wd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class RegistrosDeActividadDeServidorLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_70b1fc1wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_70b1fc1wd", value)
            End Set
          End Property
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_70b1fc9wd")
            End Get   
        End Property
