...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeServidorListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeServidorListaC )) 
          Dim R As New List(Of RegistrosDeActividadDeServidorListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeServidorListaES._SeccionID, False, Parametros) 
