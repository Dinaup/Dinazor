...
Partial Public Class SeccionesD
  Public Class PersonalizacionDeCamposD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PersonalizacionDeCamposC )) 
          Dim R As New List(Of PersonalizacionDeCamposC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PersonalizacionDeCamposES._SeccionID, False, Parametros) 
