...
Partial Public Class SeccionesD
  Public Class IntegridadDeValoresBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of IntegridadDeValoresBaseListaC )) 
          Dim R As New List(Of IntegridadDeValoresBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, IntegridadDeValoresBaseListaES._SeccionID, False, Campo, Valor) 
