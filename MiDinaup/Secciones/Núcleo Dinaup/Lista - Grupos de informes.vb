...
Partial Public Class SeccionesD
  Public Class GruposDeInformesListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of GruposDeInformesListaC )) 
          Dim R As New List(Of GruposDeInformesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(GruposDeInformesListaES._SeccionID, False, Parametros) 
