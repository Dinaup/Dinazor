...
Partial Public Class SeccionesD
  Public Class PuestosDeTrabajoBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PuestosDeTrabajoBaseListaC )) 
          Dim R As New List(Of PuestosDeTrabajoBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PuestosDeTrabajoBaseListaES._SeccionID, False, Parametros) 
