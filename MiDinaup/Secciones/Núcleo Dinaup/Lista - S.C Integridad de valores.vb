...
Partial Public Class SeccionesD
  Public Class SCIntegridadDeValoresListaD
      Public Shared _SeccionID As String = "f21aa669-ee99-4b39-beb7-0487e3fbae4c"
      Public Shared _SeccionIDGUID As New Guid("f21aa669-ee99-4b39-beb7-0487e3fbae4c")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of SCIntegridadDeValoresListaC )) 
          Dim R As New List(Of SCIntegridadDeValoresListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, SCIntegridadDeValoresListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SCIntegridadDeValoresListaC 
          ...
          Return R 
      End Function 
      Public Class SCIntegridadDeValoresListaES
          Public shared _SeccionID as Guid = New Guid("f21aa669-ee99-4b39-beb7-0487e3fbae4c")
      ...
      End Class
      Public Class SCIntegridadDeValoresListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f21aa669-ee99-4b39-beb7-0487e3fbae4c"",""titulo"": ""Lista - S.C Integridad de valores"",""iconoid"": """",""etiquetasingular"": ""Registro de integridad de valores"",""etiquetaplural"": ""Registros de integridad de valores"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f21aa669-ee99-4b39-beb7-0487e3fbae4c"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("pr_71aec91wd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_71aec89wd",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_71aec89wd","")
         End if
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class SCIntegridadDeValoresLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_71aec91wd")
            End Get   
        End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_71aec89wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_71aec89wd", value)
            End Set
          End Property
