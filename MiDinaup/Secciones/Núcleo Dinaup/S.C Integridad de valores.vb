...
Partial Public Class SeccionesD
  Public Class SCIntegridadDeValoresD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SCIntegridadDeValoresC )) 
          Dim R As New List(Of SCIntegridadDeValoresC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SCIntegridadDeValoresES._SeccionID, False, Parametros) 
