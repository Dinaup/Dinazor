...
Partial Public Class SeccionesD
  Public Class PersonalizacionDeSeccionesD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of PersonalizacionDeSeccionesC )) 
          Dim R As New List(Of PersonalizacionDeSeccionesC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, PersonalizacionDeSeccionesES._SeccionID, False, Campo, Valor) 
