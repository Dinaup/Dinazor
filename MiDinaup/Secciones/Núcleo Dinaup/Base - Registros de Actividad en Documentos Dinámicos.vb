...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadEnDocumentosDinamicosBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadEnDocumentosDinamicosBaseC )) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadEnDocumentosDinamicosBaseES._SeccionID, False, Parametros) 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC)) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadEnDocumentosDinamicosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
