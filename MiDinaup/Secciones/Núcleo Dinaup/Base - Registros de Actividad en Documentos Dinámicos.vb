...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadEnDocumentosDinamicosBaseD
      Public Class RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC
      Public Listador as RegistrosDeActividadEnDocumentosDinamicosBaseC
      Public Lista As New List(of RegistrosDeActividadEnDocumentosDinamicosBaseListaD.RegistrosDeActividadEnDocumentosDinamicosBaseListaC)
        sub new(_listador  as RegistrosDeActividadEnDocumentosDinamicosBaseC, _lista as List(of RegistrosDeActividadEnDocumentosDinamicosBaseListaD.RegistrosDeActividadEnDocumentosDinamicosBaseListaC))
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of RegistrosDeActividadEnDocumentosDinamicosBaseC )) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadEnDocumentosDinamicosBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RegistrosDeActividadEnDocumentosDinamicosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of  RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC)) 
          Dim R As New List(Of RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC )  
          Dim d =  Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, RegistrosDeActividadEnDocumentosDinamicosBaseES._SeccionID, True, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Dim Obj_Listador As New RegistrosDeActividadEnDocumentosDinamicosBaseC 
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Dim Objs_Listas As New List(Of RegistrosDeActividadEnDocumentosDinamicosBaseListaD.RegistrosDeActividadEnDocumentosDinamicosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New RegistrosDeActividadEnDocumentosDinamicosBaseListaD.RegistrosDeActividadEnDocumentosDinamicosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New RegistrosDeActividadEnDocumentosDinamicosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""bafabfa9-37a8-4013-b424-6c3cca9921c9"",""titulo"": ""Base - Registros de Actividad en Documentos Dinámicos"",""iconoid"": ""a500bd11-895a-477c-a8c4-d8a150a656ba"",""etiquetasingular"": ""Registro de Actividad en Documentos Dinámicos"",""etiquetaplural"": ""Registros de Actividad en Documentos Dinámicos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""bafabfa9-37a8-4013-b424-6c3cca9921c9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_600403589016")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589015"), _Datos.Leer_String("pr_600403589015.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589013"), _Datos.Leer_String("pr_600403589013.nombre"))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589020"), _Datos.Leer_String("pr_600403589020.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_600403589019")
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_600403589014"), _Datos.Leer_String("pr_600403589014.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_600403589031")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_600403589017")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_600403589032")
          me.ReferenciaArchivo = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_100403589137"), _Datos.Leer_String("pr_100403589137.nombre"))
         ...
         R.add("pr_600403589016", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_600403589015",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_600403589015","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_600403589013",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_600403589013","")
         End if
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_600403589020",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_600403589020","")
         End if
         R.add("pr_600403589019", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_600403589014",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_600403589014","")
         End if
         R.add("pr_600403589031", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_600403589017", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         R.add("pr_600403589032", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaArchivo IsNot nothing then
           R.add("pr_100403589137",me.ReferenciaArchivo.ID.STR())
         Else
           R.add("pr_100403589137","")
         End if
