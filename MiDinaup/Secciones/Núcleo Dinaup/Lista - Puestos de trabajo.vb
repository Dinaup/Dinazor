...
Partial Public Class SeccionesD
  Public Class PuestosDeTrabajoListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PuestosDeTrabajoListaC )) 
          Dim R As New List(Of PuestosDeTrabajoListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PuestosDeTrabajoListaES._SeccionID, False, Parametros) 
