...
Partial Public Class SeccionesD
  Public Class MotivosDeRealizacionDeTurnosBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of MotivosDeRealizacionDeTurnosBaseC )) 
          Dim R As New List(Of MotivosDeRealizacionDeTurnosBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, MotivosDeRealizacionDeTurnosBaseES._SeccionID, False, Campo, Valor) 
