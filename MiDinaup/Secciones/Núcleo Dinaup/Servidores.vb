...
Partial Public Class SeccionesD
  Public Class ServidoresD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ServidoresC )) 
          Dim R As New List(Of ServidoresC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ServidoresES._SeccionID, False, Parametros) 
