...
Partial Public Class SeccionesD
  Public Class RegistrosDeActividadDeServidorBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RegistrosDeActividadDeServidorBaseC )) 
          Dim R As New List(Of RegistrosDeActividadDeServidorBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RegistrosDeActividadDeServidorBaseES._SeccionID, False, Parametros) 
