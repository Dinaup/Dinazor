...
Partial Public Class SeccionesD
  Public Class NotificacionesBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of NotificacionesBaseListaC )) 
          Dim R As New List(Of NotificacionesBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(NotificacionesBaseListaES._SeccionID, False, Parametros) 
