...
Partial Public Class SeccionesD
  Public Class ModulosBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ModulosBaseC )) 
          Dim R As New List(Of ModulosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ModulosBaseES._SeccionID, False, Parametros) 
