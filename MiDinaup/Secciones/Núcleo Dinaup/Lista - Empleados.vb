...
Partial Public Class SeccionesD
  Public Class EmpleadosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EmpleadosListaC )) 
          Dim R As New List(Of EmpleadosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EmpleadosListaES._SeccionID, False, Parametros) 
