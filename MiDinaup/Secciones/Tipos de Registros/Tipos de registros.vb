...
Partial Public Class SeccionesD
  Public Class TiposDeRegistrosD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeRegistrosC )) 
          Dim R As New List(Of TiposDeRegistrosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeRegistrosES._SeccionID, False, Parametros) 
