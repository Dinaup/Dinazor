...
Partial Public Class SeccionesD
  Public Class TiposDeTareasV1D
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeTareasV1C )) 
          Dim R As New List(Of TiposDeTareasV1C )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeTareasV1ES._SeccionID, False, Parametros) 
