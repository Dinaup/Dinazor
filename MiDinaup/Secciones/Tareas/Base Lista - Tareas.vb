...
Partial Public Class SeccionesD
  Public Class TareasBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TareasBaseListaC )) 
          Dim R As New List(Of TareasBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TareasBaseListaES._SeccionID, False, Parametros) 
