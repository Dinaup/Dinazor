...
Partial Public Class SeccionesD
  Public Class TiposDeTareasV1ListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeTareasV1ListaC )) 
          Dim R As New List(Of TiposDeTareasV1ListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeTareasV1ListaES._SeccionID, False, Parametros) 
