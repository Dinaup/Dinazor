...
Partial Public Class SeccionesD
  Public Class TareasListaD
      Public Shared _SeccionID As String = "793617ad-1e79-4fe0-8b19-0ae1e033394d"
      Public Shared _SeccionIDGUID As New Guid("793617ad-1e79-4fe0-8b19-0ae1e033394d")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of TareasListaC )) 
          Dim R As New List(Of TareasListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, TareasListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TareasListaC 
          ...
          Return R 
      End Function 
      Public Class TareasListaES
          Public shared _SeccionID as Guid = New Guid("793617ad-1e79-4fe0-8b19-0ae1e033394d")
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""793617ad-1e79-4fe0-8b19-0ae1e033394d"",""titulo"": ""Lista - Tareas"",""iconoid"": """",""etiquetasingular"": ""Tarea"",""etiquetaplural"": ""Tareas"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""793617ad-1e79-4fe0-8b19-0ae1e033394d"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class TareasLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_7735f6dwd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_7735f6dwd", value)
            End Set
          End Property
