...
Partial Public Class SeccionesD
  Public Class BandejaDeCorreosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of BandejaDeCorreosBaseListaC )) 
          Dim R As New List(Of BandejaDeCorreosBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(BandejaDeCorreosBaseListaES._SeccionID, False, Parametros) 
