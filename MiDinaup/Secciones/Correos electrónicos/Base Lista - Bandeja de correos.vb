...
Partial Public Class SeccionesD
  Public Class BandejaDeCorreosBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of BandejaDeCorreosBaseListaC )) 
          Dim R As New List(Of BandejaDeCorreosBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, BandejaDeCorreosBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New BandejaDeCorreosBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""cf8df0d6-b719-449b-b1c6-ff9e60f469cd"",""titulo"": ""Base Lista - Bandeja de correos"",""iconoid"": """",""etiquetasingular"": ""Bandeja de  correos"",""etiquetaplural"": ""Bandejas de  correos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""cf8df0d6-b719-449b-b1c6-ff9e60f469cd"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Bandeja de  correos (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Bandeja de  correos (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""9121b827-441d-4eaf-883d-3efd40f44d45"",""titulo"": ""Base - Bandeja de correos"",""iconoid"": ""ec14206c-8b07-475d-98ab-6228a60d640a"",""etiquetasingular"": ""Bandeja de  correos"",""etiquetaplural"": ""Bandejas de  correos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""9121b827-441d-4eaf-883d-3efd40f44d45"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Bandeja de  correos (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Bandeja de  correos (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Bandeja de  correos (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Bandeja de  correos (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200402571122"), _Datos.Leer_String("pr_200402571122.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_200402571120")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_200402571119")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_200402571118"), _Datos.Leer_String("pr_200402571118.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_200402571121")
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_200402571123")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_200402571124")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_200402571122",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_200402571122","")
         End if
         R.add("pr_200402571120", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         R.add("pr_200402571119", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_200402571118",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_200402571118","")
         End if
         R.add("pr_200402571121", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_200402571123", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_200402571124", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
