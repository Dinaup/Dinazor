...
Partial Public Class SeccionesD
  Public Class EnviosProgramadosDeCorreosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EnviosProgramadosDeCorreosListaC )) 
          Dim R As New List(Of EnviosProgramadosDeCorreosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EnviosProgramadosDeCorreosListaES._SeccionID, False, Parametros) 
