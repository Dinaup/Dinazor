...
Partial Public Class SeccionesD
  Public Class CuentasDeCorreoElectronicoBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CuentasDeCorreoElectronicoBaseListaC )) 
          Dim R As New List(Of CuentasDeCorreoElectronicoBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CuentasDeCorreoElectronicoBaseListaES._SeccionID, False, Parametros) 
