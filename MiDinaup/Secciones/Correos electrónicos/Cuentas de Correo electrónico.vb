...
Partial Public Class SeccionesD
  Public Class CuentasDeCorreoElectronicoD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of CuentasDeCorreoElectronicoC )) 
          Dim R As New List(Of CuentasDeCorreoElectronicoC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, CuentasDeCorreoElectronicoES._SeccionID, False, Campo, Valor) 
