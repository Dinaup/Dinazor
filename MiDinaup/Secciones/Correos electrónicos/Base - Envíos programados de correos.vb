...
Partial Public Class SeccionesD
  Public Class EnviosProgramadosDeCorreosBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EnviosProgramadosDeCorreosBaseC )) 
          Dim R As New List(Of EnviosProgramadosDeCorreosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EnviosProgramadosDeCorreosBaseES._SeccionID, False, Parametros) 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  EnviosProgramadosDeCorreosBase_ConListaC)) 
          Dim R As New List(Of EnviosProgramadosDeCorreosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EnviosProgramadosDeCorreosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
