...
Partial Public Class SeccionesD
  Public Class EnviosProgramadosDeCorreosD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of EnviosProgramadosDeCorreosC )) 
          Dim R As New List(Of EnviosProgramadosDeCorreosC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, EnviosProgramadosDeCorreosES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EnviosProgramadosDeCorreosC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As EnviosProgramadosDeCorreosC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of EnviosProgramadosDeCorreosC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of EnviosProgramadosDeCorreosC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, EnviosProgramadosDeCorreosES._SeccionID, Importar, CampoWhere, "") 
      End Function
      ...
      Inherits Base_DatoC
          ...
          <DisplayName("Archivo 3 (Obsoleto)")>
          Public Property ReferenciaArchivo3 As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaArchivo3 As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaArchivo3"",""etiqueta"": ""Archivo 3 (Obsoleto)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": ""imagenes"",""rol"": 8,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Archivo 3 (Obsoleto)"",""descripcion"": """",""keyword"": ""ReferenciaArchivo3"",""formato"": 9,""rol"": 8,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""fe5f53f0-3ad0-499b-b30b-3d72675f8d91"",""titulo"": ""Envíos programados de correos"",""iconoid"": ""3fa003db-8231-412c-9d8e-5beda36b7dac"",""etiquetasingular"": ""Envío programado de correo"",""etiquetaplural"": ""Envíos programados de correos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""fe5f53f0-3ad0-499b-b30b-3d72675f8d91"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
    ...
    End Sub
        ...
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_30040163371033")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
        ...
        Public ReadOnly property ReintentosDeEnvio As Integer
            get
                return me.GetValue_Int("pr_40040163371")
            End Get   
        End Property
        Public ReadOnly property ReferenciaConfiguracionDeCorreoDeOrigen As Guid
            ...
            End Get   
        End Property
        Public ReadOnly property EstadoDeEnvio As EnumTramitacionE
            get
                return me.GetValue_Int("pr_20040164244")
            End Get   
        End Property
        ...
        Public ReadOnly property CantidadDeArchivos As Integer
            get
                return me.GetValue_Int("pr_40040257421")
            End Get   
        End Property
