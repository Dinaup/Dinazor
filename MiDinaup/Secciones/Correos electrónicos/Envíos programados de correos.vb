...
Partial Public Class SeccionesD
  Public Class EnviosProgramadosDeCorreosD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EnviosProgramadosDeCorreosC )) 
          Dim R As New List(Of EnviosProgramadosDeCorreosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EnviosProgramadosDeCorreosES._SeccionID, False, Parametros) 
