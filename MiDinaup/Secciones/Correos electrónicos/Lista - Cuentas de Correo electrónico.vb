...
Partial Public Class SeccionesD
  Public Class CuentasDeCorreoElectronicoListaD
      Public Shared _SeccionID As String = "1ab093ea-7bf6-4f68-8ee9-a0ed644e6ed1"
      Public Shared _SeccionIDGUID As New Guid("1ab093ea-7bf6-4f68-8ee9-a0ed644e6ed1")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of CuentasDeCorreoElectronicoListaC )) 
          Dim R As New List(Of CuentasDeCorreoElectronicoListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, CuentasDeCorreoElectronicoListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CuentasDeCorreoElectronicoListaC 
          ...
          Return R 
      End Function 
      Public Class CuentasDeCorreoElectronicoListaES
          Public shared _SeccionID as Guid = New Guid("1ab093ea-7bf6-4f68-8ee9-a0ed644e6ed1")
      ...
      End Class
      Public Class CuentasDeCorreoElectronicoListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""1ab093ea-7bf6-4f68-8ee9-a0ed644e6ed1"",""titulo"": ""Lista - Cuentas de Correo electrónico"",""iconoid"": """",""etiquetasingular"": ""Cuenta de correo electrónico"",""etiquetaplural"": ""Cuentas de Correo electrónico"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""1ab093ea-7bf6-4f68-8ee9-a0ed644e6ed1"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Cuenta de correo electrónico (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""cb53c54c-e1f7-47de-8978-0e5228ed81c4"",""titulo"": ""Cuentas de Correo electrónico"",""iconoid"": ""5fd758a4-dbc3-4365-ad56-18af81075b78"",""etiquetasingular"": ""Cuenta de correo electrónico"",""etiquetaplural"": ""Cuentas de Correo electrónico"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""cb53c54c-e1f7-47de-8978-0e5228ed81c4"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Cuenta de correo electrónico (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class CuentasDeCorreoElectronicoLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_30040163371001")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040163371001", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_30040163371002")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040163371002", value)
            End Set
          End Property
