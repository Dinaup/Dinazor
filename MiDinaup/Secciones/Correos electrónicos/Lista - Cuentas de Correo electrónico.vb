...
Partial Public Class SeccionesD
  Public Class CuentasDeCorreoElectronicoListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CuentasDeCorreoElectronicoListaC )) 
          Dim R As New List(Of CuentasDeCorreoElectronicoListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CuentasDeCorreoElectronicoListaES._SeccionID, False, Parametros) 
