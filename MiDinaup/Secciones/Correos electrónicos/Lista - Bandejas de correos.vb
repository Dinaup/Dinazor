...
Partial Public Class SeccionesD
  Public Class BandejasDeCorreosListaD
      Public Shared _SeccionID As String = "798a09e3-3106-4ad3-a321-3aa6155fa083"
      Public Shared _SeccionIDGUID As New Guid("798a09e3-3106-4ad3-a321-3aa6155fa083")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of BandejasDeCorreosListaC )) 
          Dim R As New List(Of BandejasDeCorreosListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, BandejasDeCorreosListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New BandejasDeCorreosListaC 
          ...
          Return R 
      End Function 
      Public Class BandejasDeCorreosListaES
          Public shared _SeccionID as Guid = New Guid("798a09e3-3106-4ad3-a321-3aa6155fa083")
      ...
      End Class
      Public Class BandejasDeCorreosListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""798a09e3-3106-4ad3-a321-3aa6155fa083"",""titulo"": ""Lista - Bandejas de correos"",""iconoid"": """",""etiquetasingular"": ""Bandeja de  correos"",""etiquetaplural"": ""Bandejas de  correos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""798a09e3-3106-4ad3-a321-3aa6155fa083"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class BandejasDeCorreosLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_200402571119")
            End Get   
        End Property
