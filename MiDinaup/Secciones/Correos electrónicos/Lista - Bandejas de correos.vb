...
Partial Public Class SeccionesD
  Public Class BandejasDeCorreosListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of BandejasDeCorreosListaC )) 
          Dim R As New List(Of BandejasDeCorreosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(BandejasDeCorreosListaES._SeccionID, False, Parametros) 
