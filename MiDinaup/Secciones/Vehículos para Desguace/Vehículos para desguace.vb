...
Partial Public Class SeccionesD
  Public Class VehiculosParaDesguaceD
      Public Shared _SeccionID As String = "80145d3a-9d1b-430a-b900-212345985efe"
      Public Shared _SeccionIDGUID As New Guid("80145d3a-9d1b-430a-b900-212345985efe")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of VehiculosParaDesguaceC )) 
          Dim R As New List(Of VehiculosParaDesguaceC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VehiculosParaDesguaceES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New VehiculosParaDesguaceC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As VehiculosParaDesguaceC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of VehiculosParaDesguaceC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of VehiculosParaDesguaceC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, VehiculosParaDesguaceES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As VehiculosParaDesguace_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VehiculosParaDesguaceES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New VehiculosParaDesguace_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As VehiculosParaDesguace_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VehiculosParaDesguaceES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New VehiculosParaDesguace_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class VehiculosParaDesguaceES
          Public shared _SeccionID as Guid = New Guid("80145d3a-9d1b-430a-b900-212345985efe")
      ...
      End Class
      Public Class VehiculosParaDesguaceC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""80145d3a-9d1b-430a-b900-212345985efe"",""titulo"": ""Vehículos para desguace"",""iconoid"": ""46b23736-96cc-4637-8004-ee110663b142"",""etiquetasingular"": ""Vehículo para desguace"",""etiquetaplural"": ""Vehículos para desguace"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""80145d3a-9d1b-430a-b900-212345985efe"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class VehiculosParaDesguace_FormularioC
    ...
    End Sub
        ...
        End Property
          ...
          Public property ImporteFacturacionPotencial As Decimal
            get
                return me.GetValue_Decimal("pr_10010421341")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_10010421341", value)
            End Set
          End Property
          Public property ImporteCosteSinImpuestos As Decimal
            get
          ...
          Public property ImporteBeneficioPotencial As Decimal
            get
                return me.GetValue_Decimal("pr_10010421342")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_10010421342", value)
            End Set
          End Property
          Public property ImporteNoFacturable As Decimal
            get
                return me.GetValue_Decimal("pr_10010421345")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_10010421345", value)
            End Set
          End Property
        ...
        End Property
          ...
          Public property ReferenciaFoto As Guid
            ...
            End Set
          End Property
        Public ReadOnly property ImporteCosteConImpuestosObsoleto As Decimal
            get
                return me.GetValue_Decimal("pr_500104215616")
            End Get   
        End Property
        ...
        End Property
          Public property Bastidor As String
            get
                return me.GetValue_String("pr_60040473182")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040473182", value)
            End Set
          End Property
          Public property Kilometraje As Integer
            get
                return me.GetValue_Int("pr_60040473183")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_60040473183", value)
            End Set
          End Property
          Public property Año As Integer
            get
                return me.GetValue_Int("pr_60040473184")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_60040473184", value)
            End Set
          End Property
          Public property RefsMotor As String
            get
                return me.GetValue_String("pr_40040473191")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040473191", value)
            End Set
          End Property
          Public property ReferenciaColor As Guid
            get
                return me.GetValue_Guid("pr_30040473192")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040473192", value)
            End Set
          End Property
          Public property IDExterna As String
            get
