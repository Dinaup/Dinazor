...
Partial Public Class SeccionesD
  Public Class FamiliasDeRecambiosBaseD
      Public Class FamiliasDeRecambiosBase_ConListaC
      Public Listador as FamiliasDeRecambiosBaseC
      Public Lista As New List(of FamiliasDeRecambiosBaseListaD.FamiliasDeRecambiosBaseListaC)
        sub new(_listador  as FamiliasDeRecambiosBaseC, _lista as List(of FamiliasDeRecambiosBaseListaD.FamiliasDeRecambiosBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "aa130e0b-2474-4d97-9c10-1f7256fe112f"
      Public Shared _SeccionIDGUID As New Guid("aa130e0b-2474-4d97-9c10-1f7256fe112f")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of FamiliasDeRecambiosBaseC )) 
          Dim R As New List(Of FamiliasDeRecambiosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FamiliasDeRecambiosBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New FamiliasDeRecambiosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  FamiliasDeRecambiosBase_ConListaC)) 
          Dim R As New List(Of FamiliasDeRecambiosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FamiliasDeRecambiosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of FamiliasDeRecambiosBaseListaD.FamiliasDeRecambiosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New FamiliasDeRecambiosBaseListaD.FamiliasDeRecambiosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New FamiliasDeRecambiosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class FamiliasDeRecambiosBaseES
          Public shared _SeccionID as Guid = New Guid("aa130e0b-2474-4d97-9c10-1f7256fe112f")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_400404639827"
      ...
      End Class
      Public Class FamiliasDeRecambiosBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""aa130e0b-2474-4d97-9c10-1f7256fe112f"",""titulo"": ""Base - Familias de recambios"",""iconoid"": ""e2e81926-e7b9-43c8-bb19-75bed0dcf0cb"",""etiquetasingular"": ""Familia de recambio"",""etiquetaplural"": ""Familias de recambios"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""aa130e0b-2474-4d97-9c10-1f7256fe112f"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_400404639827")
         ...
         R.add("pr_400404639827", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
