...
Partial Public Class SeccionesD
  Public Class SalidasDeInventarioBaseD
      Public Class SalidasDeInventarioBase_ConListaC
      Public Listador as SalidasDeInventarioBaseC
      Public Lista As New List(of SalidasDeInventarioBaseListaD.SalidasDeInventarioBaseListaC)
        sub new(_listador  as SalidasDeInventarioBaseC, _lista as List(of SalidasDeInventarioBaseListaD.SalidasDeInventarioBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "11c48ca7-9601-4465-90a8-0a294866e199"
      Public Shared _SeccionIDGUID As New Guid("11c48ca7-9601-4465-90a8-0a294866e199")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SalidasDeInventarioBaseC )) 
          Dim R As New List(Of SalidasDeInventarioBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeInventarioBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SalidasDeInventarioBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  SalidasDeInventarioBase_ConListaC)) 
          Dim R As New List(Of SalidasDeInventarioBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeInventarioBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of SalidasDeInventarioBaseListaD.SalidasDeInventarioBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New SalidasDeInventarioBaseListaD.SalidasDeInventarioBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New SalidasDeInventarioBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class SalidasDeInventarioBaseES
          Public shared _SeccionID as Guid = New Guid("11c48ca7-9601-4465-90a8-0a294866e199")
      ...
      Public Shared ExportarEnModulos$ = "pr_1004010569111"
      ...
      End Class
      Public Class SalidasDeInventarioBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""11c48ca7-9601-4465-90a8-0a294866e199"",""titulo"": ""Base - Salidas de inventario"",""iconoid"": ""fcc4c1a5-24a3-4221-adcc-0d27247804b9"",""etiquetasingular"": ""Movimiento de producto"",""etiquetaplural"": ""Movimientos de producto"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""11c48ca7-9601-4465-90a8-0a294866e199"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
