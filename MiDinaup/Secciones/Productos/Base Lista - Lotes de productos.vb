...
Partial Public Class SeccionesD
  Public Class LotesDeProductosBaseListaD
      Public Shared _SeccionID As String = "dfcd801a-1262-4c86-aac6-b3bfd4e1ad4b"
      Public Shared _SeccionIDGUID As New Guid("dfcd801a-1262-4c86-aac6-b3bfd4e1ad4b")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of LotesDeProductosBaseListaC )) 
          Dim R As New List(Of LotesDeProductosBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(LotesDeProductosBaseListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New LotesDeProductosBaseListaC 
          ...
          Return R 
      End Function 
      Public Class LotesDeProductosBaseListaES
          Public shared _SeccionID as Guid = New Guid("dfcd801a-1262-4c86-aac6-b3bfd4e1ad4b")
      ...
      End Class
      Public Class LotesDeProductosBaseListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""dfcd801a-1262-4c86-aac6-b3bfd4e1ad4b"",""titulo"": ""Base Lista - Lotes de productos"",""iconoid"": """",""etiquetasingular"": ""Lote de producto"",""etiquetaplural"": ""Lotes de producto"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""dfcd801a-1262-4c86-aac6-b3bfd4e1ad4b"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
