...
Partial Public Class SeccionesD
  Public Class EntradasDeInventarioBaseD
      Public Class EntradasDeInventarioBase_ConListaC
      Public Listador as EntradasDeInventarioBaseC
      Public Lista As New List(of EntradasDeInventarioBaseListaD.EntradasDeInventarioBaseListaC)
        sub new(_listador  as EntradasDeInventarioBaseC, _lista as List(of EntradasDeInventarioBaseListaD.EntradasDeInventarioBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "372a51f6-60c3-4838-8cf1-825aaf4011b6"
      Public Shared _SeccionIDGUID As New Guid("372a51f6-60c3-4838-8cf1-825aaf4011b6")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EntradasDeInventarioBaseC )) 
          Dim R As New List(Of EntradasDeInventarioBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeInventarioBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EntradasDeInventarioBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  EntradasDeInventarioBase_ConListaC)) 
          Dim R As New List(Of EntradasDeInventarioBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeInventarioBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of EntradasDeInventarioBaseListaD.EntradasDeInventarioBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New EntradasDeInventarioBaseListaD.EntradasDeInventarioBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New EntradasDeInventarioBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class EntradasDeInventarioBaseES
          Public shared _SeccionID as Guid = New Guid("372a51f6-60c3-4838-8cf1-825aaf4011b6")
      ...
      Public Shared ExportarEnModulos$ = "pr_1004010569169"
      ...
      End Class
      Public Class EntradasDeInventarioBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""372a51f6-60c3-4838-8cf1-825aaf4011b6"",""titulo"": ""Base - Entradas de inventario"",""iconoid"": ""ee656da0-2043-420c-80b9-4ebdb99ea97a"",""etiquetasingular"": ""Movimiento de producto"",""etiquetaplural"": ""Movimientos de producto"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""372a51f6-60c3-4838-8cf1-825aaf4011b6"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
