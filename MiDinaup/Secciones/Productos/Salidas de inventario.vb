...
Partial Public Class SeccionesD
  Public Class SalidasDeInventarioD
      Public Shared _SeccionID As String = "f09b320f-e100-45c4-a677-0954455471d7"
      Public Shared _SeccionIDGUID As New Guid("f09b320f-e100-45c4-a677-0954455471d7")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SalidasDeInventarioC )) 
          Dim R As New List(Of SalidasDeInventarioC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeInventarioES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SalidasDeInventarioC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As SalidasDeInventarioC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of SalidasDeInventarioC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of SalidasDeInventarioC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, SalidasDeInventarioES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As SalidasDeInventario_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeInventarioES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeInventario_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As SalidasDeInventario_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeInventarioES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeInventario_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class SalidasDeInventarioES
          Public shared _SeccionID as Guid = New Guid("f09b320f-e100-45c4-a677-0954455471d7")
          Public shared _Tabla$ = "tpr_20040105692"
      Public Shared ReferenciaEmpleadoPrincipal$ = "pr_1004010569106"
      Public Shared ReferenciaMovimientoInterno$ = "pr_40040105741"
      Public Shared ReferenciaNumeracionSerie$ = "pr_400401056954"
      Public Shared ReferenciaUbicacionPrincipal$ = "pr_1004010569107"
      Public Shared ReferenciaDestinador$ = "pr_1004010569115"
      Public Shared EntidadRelacionadaTieneAccesoWeb$ = "pr_400401056956"
      Public Shared HoraLocal$ = "pr_1004010569110"
      Public Shared CantidadUnidades$ = "pr_50040106031"
      Public Shared CantidadMedidaBasePorUnd$ = "pr_50040106034"
      Public Shared Observaciones$ = "pr_400401056960"
      Public Shared AutorDelAltaTieneAccesoWeb$ = "pr_1004010569131"
      Public Shared CantidadMedidaBase$ = "pr_50040106033"
      Public Shared ReferenciaAutorDelAlta$ = "pr_1004010569108"
      Public Shared ReferenciaPuestoDeTrabajo$ = "pr_400401056953"
      Public Shared TextoTicket$ = "pr_400401056959"
      Public Shared ReferenciaEntidadRelacionada$ = "pr_400401056952"
      Public Shared ReferenciaTicket$ = "pr_400401056957"
      Public Shared FechaAlta_UTC$ = "pr_1004010569112"
      Public Shared Cantidad$ = "pr_50040106035"
      Public Shared FechaDato_UTC$ = "pr_1004010569109"
      Public Shared ReferenciaMedida$ = "pr_50040106032"
      Public Shared ReferenciaLote$ = "pr_10040106052"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_1004010569133"
      Public Shared ReferenciaTipoDeMovimiento$ = "pr_400401056950"
      Public Shared ReferenciaMedidaBase$ = "pr_50040106036"
      Public Shared ReferenciaProducto$ = "pr_40040106021"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class SalidasDeInventarioC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f09b320f-e100-45c4-a677-0954455471d7"",""titulo"": ""Salidas de inventario"",""iconoid"": ""fcc4c1a5-24a3-4221-adcc-0d27247804b9"",""etiquetasingular"": ""Salida"",""etiquetaplural"": ""Salidas"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f09b320f-e100-45c4-a677-0954455471d7"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1004010569106"), _Datos.Leer_String("pr_1004010569106.nombre"))
          me.ReferenciaMovimientoInterno = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_40040105741"), _Datos.Leer_String("pr_40040105741.nombre"))
          me.ReferenciaNumeracionSerie = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_400401056954"), _Datos.Leer_String("pr_400401056954.nombre"))
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1004010569107"), _Datos.Leer_String("pr_1004010569107.nombre"))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1004010569115"), _Datos.Leer_String("pr_1004010569115.nombre"))
          me.EntidadRelacionadaTieneAccesoWeb = _Datos.Leer_Boolean("pr_400401056956")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_1004010569110")
          me.CantidadUnidades = _Datos.Leer_Decimal("pr_50040106031")
          me.CantidadMedidaBasePorUnd = _Datos.Leer_Decimal("pr_50040106034")
          me.Observaciones = _Datos.Leer_String("pr_400401056960")
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_1004010569131")
          me.CantidadMedidaBase = _Datos.Leer_Decimal("pr_50040106033")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1004010569108"), _Datos.Leer_String("pr_1004010569108.nombre"))
          me.ReferenciaPuestoDeTrabajo = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_400401056953"), _Datos.Leer_String("pr_400401056953.nombre"))
          me.TextoTicket = _Datos.Leer_String("pr_400401056959")
          me.ReferenciaEntidadRelacionada = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_400401056952"), _Datos.Leer_String("pr_400401056952.nombre"))
          me.ReferenciaTicket = _Datos.Leer_Integer("pr_400401056957")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_1004010569112")
          me.Cantidad = _Datos.Leer_Decimal("pr_50040106035")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_1004010569109")
          me.ReferenciaMedida = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040106032"), _Datos.Leer_String("pr_50040106032.nombre"))
          me.ReferenciaLote = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040106052"), _Datos.Leer_String("pr_10040106052.nombre"))
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_1004010569133")
          me.ReferenciaTipoDeMovimiento = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_400401056950"), _Datos.Leer_String("pr_400401056950.nombre"))
          me.ReferenciaMedidaBase = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040106036"), _Datos.Leer_String("pr_50040106036.nombre"))
          me.ReferenciaProducto = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_40040106021"), _Datos.Leer_String("pr_40040106021.nombre"))
         ...
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_1004010569106",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_1004010569106","")
         End if
         If Me.ReferenciaMovimientoInterno IsNot nothing then
           R.add("pr_40040105741",me.ReferenciaMovimientoInterno.ID.STR())
         Else
           R.add("pr_40040105741","")
         End if
         If Me.ReferenciaNumeracionSerie IsNot nothing then
           R.add("pr_400401056954",me.ReferenciaNumeracionSerie.ID.STR())
         Else
           R.add("pr_400401056954","")
         End if
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_1004010569107",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_1004010569107","")
         End if
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_1004010569115",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_1004010569115","")
         End if
         R.add("pr_400401056956", me.EntidadRelacionadaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_1004010569110", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         R.add("pr_50040106031", me.CantidadUnidades.AdaptarMySQL_Decimal())
         R.add("pr_50040106034", me.CantidadMedidaBasePorUnd.AdaptarMySQL_Decimal())
         R.add("pr_400401056960", me.Observaciones.AdaptarMySQL_String())
         R.add("pr_1004010569131", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_50040106033", me.CantidadMedidaBase.AdaptarMySQL_Decimal())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_1004010569108",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_1004010569108","")
         End if
         If Me.ReferenciaPuestoDeTrabajo IsNot nothing then
           R.add("pr_400401056953",me.ReferenciaPuestoDeTrabajo.ID.STR())
         Else
           R.add("pr_400401056953","")
         End if
         R.add("pr_400401056959", me.TextoTicket.AdaptarMySQL_String())
         If Me.ReferenciaEntidadRelacionada IsNot nothing then
           R.add("pr_400401056952",me.ReferenciaEntidadRelacionada.ID.STR())
         Else
           R.add("pr_400401056952","")
         End if
         R.add("pr_400401056957", me.ReferenciaTicket.AdaptarMySQL_Integer())
         R.add("pr_1004010569112", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_50040106035", me.Cantidad.AdaptarMySQL_Decimal())
         R.add("pr_1004010569109", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaMedida IsNot nothing then
           R.add("pr_50040106032",me.ReferenciaMedida.ID.STR())
         Else
           R.add("pr_50040106032","")
         End if
         If Me.ReferenciaLote IsNot nothing then
           R.add("pr_10040106052",me.ReferenciaLote.ID.STR())
         Else
           R.add("pr_10040106052","")
         End if
         R.add("pr_1004010569133", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaTipoDeMovimiento IsNot nothing then
           R.add("pr_400401056950",me.ReferenciaTipoDeMovimiento.ID.STR())
         Else
           R.add("pr_400401056950","")
         End if
         If Me.ReferenciaMedidaBase IsNot nothing then
           R.add("pr_50040106036",me.ReferenciaMedidaBase.ID.STR())
         Else
           R.add("pr_50040106036","")
         End if
         If Me.ReferenciaProducto IsNot nothing then
           R.add("pr_40040106021",me.ReferenciaProducto.ID.STR())
         Else
           R.add("pr_40040106021","")
         End if
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class SalidasDeInventario_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1004010569106")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1004010569106", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMovimientoInterno As Guid
            get
                return me.GetValue_Guid("pr_40040105741")
            End Get   
        End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_400401056954")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056954", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1004010569107")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1004010569107", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_1004010569115")
            End Get   
        End Property
          Public property EntidadRelacionadaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_400401056956")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_400401056956", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_1004010569110")
            End Get   
        End Property
          Public property CantidadUnidades As Decimal
            get
                return me.GetValue_Decimal("pr_50040106031")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_50040106031", value)
            End Set
          End Property
        Public ReadOnly property CantidadMedidaBasePorUnd As Decimal
            get
                return me.GetValue_Decimal("pr_50040106034")
            End Get   
        End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_400401056960")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401056960", value)
            End Set
          End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_1004010569131")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_1004010569131", value)
            End Set
          End Property
        Public ReadOnly property CantidadMedidaBase As Decimal
            get
                return me.GetValue_Decimal("pr_50040106033")
            End Get   
        End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_1004010569108")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1004010569108", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_400401056953")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056953", value)
            End Set
          End Property
          Public property TextoTicket As String
            get
                return me.GetValue_String("pr_400401056959")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401056959", value)
            End Set
          End Property
          Public property ReferenciaEntidadRelacionada As Guid
            get
                return me.GetValue_Guid("pr_400401056952")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056952", value)
            End Set
          End Property
          Public property ReferenciaTicket As Integer
            get
                return me.GetValue_Int("pr_400401056957")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_400401056957", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_1004010569112")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_1004010569112", value)
            End Set
          End Property
          Public property Cantidad As Decimal
            get
                return me.GetValue_Decimal("pr_50040106035")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_50040106035", value)
            End Set
          End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_1004010569109")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_1004010569109", value)
            End Set
          End Property
          Public property ReferenciaMedida As Guid
            get
                return me.GetValue_Guid("pr_50040106032")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040106032", value)
            End Set
          End Property
          Public property ReferenciaLote As Guid
            get
                return me.GetValue_Guid("pr_10040106052")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040106052", value)
            End Set
          End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_1004010569133")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_1004010569133", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaTipoDeMovimiento As Guid
            get
                return me.GetValue_Guid("pr_400401056950")
            End Get   
        End Property
          Public property ReferenciaMedidaBase As Guid
            get
                return me.GetValue_Guid("pr_50040106036")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040106036", value)
            End Set
          End Property
          Public property ReferenciaProducto As Guid
            get
                return me.GetValue_Guid("pr_40040106021")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040106021", value)
            End Set
          End Property
