...
Partial Public Class SeccionesD
  Public Class TiposDeMovimientoEDUD
      Public Shared _SeccionID As String = "f33d6115-138e-4811-a1fd-be3a3c0761ff"
      Public Shared _SeccionIDGUID As New Guid("f33d6115-138e-4811-a1fd-be3a3c0761ff")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeMovimientoEDUC )) 
          Dim R As New List(Of TiposDeMovimientoEDUC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeMovimientoEDUES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TiposDeMovimientoEDUC 
          ...
          Return R 
      End Function 
      Public Class TiposDeMovimientoEDUES
          Public shared _SeccionID as Guid = New Guid("f33d6115-138e-4811-a1fd-be3a3c0761ff")
      ...
      Public Shared ReferenciaNumeracionSerieEDU$ = "pr_476bd61x97wc"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class TiposDeMovimientoEDUC
      Inherits Base_DatoC
          ...
          <DisplayName("Relación elemento Tipo de movimiento")>
          Public Property ReferenciaRelacionElemento As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaRelacionElemento As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaRelacionElemento"",""etiqueta"": ""Relación elemento Tipo de movimiento"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""b37ee35b-262e-4317-b8f4-69e6b1f96f82"",""titulo"": ""Tipos de movimiento"",""iconoid"": ""d720d25f-f5b8-4c83-a9f3-a8bf6cb31468"",""etiquetasingular"": ""Tipo de movimiento"",""etiquetaplural"": ""Tipos de movimiento"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""b37ee35b-262e-4317-b8f4-69e6b1f96f82"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Relación elemento Tipo de movimiento"",""descripcion"": """",""keyword"": ""ReferenciaRelacionElemento"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Property ReferenciaNumeracionSerieEDU As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaNumeracionSerieEDU As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaNumeracionSerieEDU"",""etiqueta"": ""Numeración / Serie"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""a93edb96-3ad2-4498-a1ca-696737b93cea"",""titulo"": ""Base - Numeraciones / Series"",""iconoid"": ""5ae6b089-a12a-417c-92c2-d64de875e355"",""etiquetasingular"": ""Numeración / Serie"",""etiquetaplural"": ""Numeraciones / Series"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""a93edb96-3ad2-4498-a1ca-696737b93cea"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Numeración / Serie"",""descripcion"": """",""keyword"": ""ReferenciaNumeracionSerieEDU"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaNumeracionSerieEDU As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaNumeracionSerieEDU
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""f33d6115-138e-4811-a1fd-be3a3c0761ff"",""titulo"": ""EDU - Tipos de movimiento"",""iconoid"": """",""etiquetasingular"": ""Tipo de movimiento"",""etiquetaplural"": ""Tipos de movimiento"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f33d6115-138e-4811-a1fd-be3a3c0761ff"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaNumeracionSerieEDU = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_476bd61x97wc"), _Datos.Leer_String("pr_476bd61x97wc.nombre"))
         ...
         End if
         If Me.ReferenciaNumeracionSerieEDU IsNot nothing then
           R.add("pr_476bd61x97wc",me.ReferenciaNumeracionSerieEDU.ID.STR())
         Else
           R.add("pr_476bd61x97wc","")
         End if
