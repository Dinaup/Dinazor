...
Partial Public Class SeccionesD
  Public Class ServiciosD
      Public Shared _SeccionID As String = "c4ef6d8b-9814-47d9-b74a-cdc5e0849993"
      Public Shared _SeccionIDGUID As New Guid("c4ef6d8b-9814-47d9-b74a-cdc5e0849993")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ServiciosC )) 
          Dim R As New List(Of ServiciosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ServiciosES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New ServiciosC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As ServiciosC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of ServiciosC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of ServiciosC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, ServiciosES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As Servicios_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, ServiciosES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Servicios_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As Servicios_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, ServiciosES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Servicios_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class ServiciosES
          Public shared _SeccionID as Guid = New Guid("c4ef6d8b-9814-47d9-b74a-cdc5e0849993")
      ...
      Inherits Base_DatoC
          ...
          <Description("Este dato será utilizado para determinar el margen de beneficio en las ventas.")>
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class Servicios_FormularioC
    ...
    End Sub
          ...
          Public property ImporteCosteObsoleto As Decimal
            get
                return me.GetValue_Decimal("pr_40040192905")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_40040192905", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
        ...
        End Property
          ...
          Public property AlertaAlComprar As String
            ...
            End Set
          End Property
        Public ReadOnly property EsServicio As Boolean
            get
                return me.GetValue_Boolean("pr_14185n")
            End Get   
        End Property
          Public property Equivalencia As String
            get
