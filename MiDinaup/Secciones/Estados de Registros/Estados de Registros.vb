...
Partial Public Class SeccionesD
  Public Class EstadosDeRegistrosD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EstadosDeRegistrosC )) 
          Dim R As New List(Of EstadosDeRegistrosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EstadosDeRegistrosES._SeccionID, False, Parametros) 
