...
Partial Public Class SeccionesD
  Public Class EstadosDeRegistrosBaseD
      Public Class EstadosDeRegistrosBase_ConListaC
      Public Listador as EstadosDeRegistrosBaseC
      Public Lista As New List(of EstadosDeRegistrosBaseListaD.EstadosDeRegistrosBaseListaC)
        sub new(_listador  as EstadosDeRegistrosBaseC, _lista as List(of EstadosDeRegistrosBaseListaD.EstadosDeRegistrosBaseListaC))
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of EstadosDeRegistrosBaseC )) 
          Dim R As New List(Of EstadosDeRegistrosBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, EstadosDeRegistrosBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EstadosDeRegistrosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of  EstadosDeRegistrosBase_ConListaC)) 
          Dim R As New List(Of EstadosDeRegistrosBase_ConListaC )  
          Dim d =  Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, EstadosDeRegistrosBaseES._SeccionID, True, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Dim Obj_Listador As New EstadosDeRegistrosBaseC 
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Dim Objs_Listas As New List(Of EstadosDeRegistrosBaseListaD.EstadosDeRegistrosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New EstadosDeRegistrosBaseListaD.EstadosDeRegistrosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New EstadosDeRegistrosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""ae55d37a-9b63-4927-acd4-6a6e1926d4a3"",""titulo"": ""Base - Estados de Registros"",""iconoid"": ""1fbec552-994a-465e-a9ee-8502faa65d11"",""etiquetasingular"": ""Estado de registro"",""etiquetaplural"": ""Estados de registros"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""ae55d37a-9b63-4927-acd4-6a6e1926d4a3"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_500403821523")
         ...
         R.add("pr_500403821523", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
