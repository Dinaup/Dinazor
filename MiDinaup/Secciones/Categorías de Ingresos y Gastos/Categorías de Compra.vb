...
Partial Public Class SeccionesD
  Public Class CategoriasDeCompraD
      Public Shared _SeccionID As String = "003d9171-a61c-4658-b4c9-4bf7b5c91f76"
      Public Shared _SeccionIDGUID As New Guid("003d9171-a61c-4658-b4c9-4bf7b5c91f76")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CategoriasDeCompraC )) 
          Dim R As New List(Of CategoriasDeCompraC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CategoriasDeCompraES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CategoriasDeCompraC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As CategoriasDeCompraC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of CategoriasDeCompraC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of CategoriasDeCompraC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, CategoriasDeCompraES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As CategoriasDeCompra_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, CategoriasDeCompraES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New CategoriasDeCompra_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As CategoriasDeCompra_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, CategoriasDeCompraES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New CategoriasDeCompra_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class CategoriasDeCompraES
          Public shared _SeccionID as Guid = New Guid("003d9171-a61c-4658-b4c9-4bf7b5c91f76")
      ...
      End Class
      Public Class CategoriasDeCompraC
      Inherits Base_DatoC
          <DisplayName("Porcentaje de deducción de impuestos")>
          Public Property PorcentajeDeDeduccionDeImpuestosPorciento As Decimal
          Public Shared ___PorcentajeDeDeduccionDeImpuestosPorciento As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""PorcentajeDeDeduccionDeImpuestosPorciento"",""etiqueta"": ""Porcentaje de deducción de impuestos"",""oculta"": false,""formato"": 3,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 6,""decimales"": ""2"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": false,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Porcentaje de deducción de impuestos"",""descripcion"": """",""keyword"": ""PorcentajeDeDeduccionDeImpuestosPorciento"",""formato"": 3,""rol"": 6,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""003d9171-a61c-4658-b4c9-4bf7b5c91f76"",""titulo"": ""Categorías de Compra"",""iconoid"": ""bc114f16-6aa6-4f43-9ef7-f99f41567980"",""etiquetasingular"": ""Categoría de Compra"",""etiquetaplural"": ""Categorías de Compra"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""003d9171-a61c-4658-b4c9-4bf7b5c91f76"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class CategoriasDeCompra_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property PorcentajeDeDeduccionDeImpuestosPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_17ed044553x20dwd")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_17ed044553x20dwd", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_776ae4awd")
            End Get   
        End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_16a8827d9axcewd")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_16a8853714x258wd")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_16a8853714x258wd", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_16a8827d25x5ewd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_16a8827d25x5ewd", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_16a8827d43x280wd")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_16a8827d43x280wd", value)
            End Set
          End Property
          Public property InversionDeInventarioObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_30040131851")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_30040131851", value)
            End Set
          End Property
          Public property ReferenciaSubcuentaDevoluciones As Guid
            get
                return me.GetValue_Guid("pr_30040136184")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040136184", value)
            End Set
          End Property
          Public property ReferenciaSubcuenta As Guid
            get
                return me.GetValue_Guid("pr_30040133301001")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040133301001", value)
            End Set
          End Property
          Public property ReferenciaTiposDeProductoComprado As Guid
            get
                return me.GetValue_Guid("pr_40040238951")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040238951", value)
            End Set
          End Property
          Public property PorcentajeDeDeduccionDeIRPFPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_60040260241")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_60040260241", value)
            End Set
          End Property
          Public property Tipo As String
            get
                return me.GetValue_String("pr_10040263145")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040263145", value)
            End Set
          End Property
          Public property Descripcion As String
            get
                return me.GetValue_String("pr_100402631510")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100402631510", value)
            End Set
          End Property
          Public property ReferenciaSubcuentaGastoNoDeducibleIRPF As Guid
            get
                return me.GetValue_Guid("pr_40040271011")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040271011", value)
            End Set
          End Property
          Public property SonServicios As Boolean
            get
                return me.GetValue_Boolean("pr_30040281622")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_30040281622", value)
            End Set
          End Property
