...
Partial Public Class SeccionesD
  Public Class DetallesDeRecambiosListaD
      Public Shared _SeccionID As String = "4ac5a3de-f9b1-4006-b780-275d0e61a5c6"
      Public Shared _SeccionIDGUID As New Guid("4ac5a3de-f9b1-4006-b780-275d0e61a5c6")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of DetallesDeRecambiosListaC )) 
          Dim R As New List(Of DetallesDeRecambiosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DetallesDeRecambiosListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New DetallesDeRecambiosListaC 
          ...
          Return R 
      End Function 
      Public Class DetallesDeRecambiosListaES
          Public shared _SeccionID as Guid = New Guid("4ac5a3de-f9b1-4006-b780-275d0e61a5c6")
      ...
      End Class
      Public Class DetallesDeRecambiosListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4ac5a3de-f9b1-4006-b780-275d0e61a5c6"",""titulo"": ""Lista - Detalles de Recambios"",""iconoid"": ""4d329e91-e7bb-45fa-9f82-1a1b734ce285"",""etiquetasingular"": ""Detalles de Recambio"",""etiquetaplural"": ""Detalles de Recambios"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""4ac5a3de-f9b1-4006-b780-275d0e61a5c6"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class DetallesDeRecambiosLista_FormularioC
