...
Partial Public Class SeccionesD
  Public Class TiposDeRecursosDeLaEmpresaD
      Public Shared _SeccionID As String = "f027c4ff-70cf-46af-8423-f998db995b94"
      Public Shared _SeccionIDGUID As New Guid("f027c4ff-70cf-46af-8423-f998db995b94")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeRecursosDeLaEmpresaC )) 
          Dim R As New List(Of TiposDeRecursosDeLaEmpresaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeRecursosDeLaEmpresaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TiposDeRecursosDeLaEmpresaC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As TiposDeRecursosDeLaEmpresaC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of TiposDeRecursosDeLaEmpresaC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of TiposDeRecursosDeLaEmpresaC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, TiposDeRecursosDeLaEmpresaES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As TiposDeRecursosDeLaEmpresa_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, TiposDeRecursosDeLaEmpresaES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New TiposDeRecursosDeLaEmpresa_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As TiposDeRecursosDeLaEmpresa_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, TiposDeRecursosDeLaEmpresaES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New TiposDeRecursosDeLaEmpresa_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class TiposDeRecursosDeLaEmpresaES
          Public shared _SeccionID as Guid = New Guid("f027c4ff-70cf-46af-8423-f998db995b94")
      ...
      End Class
      Public Class TiposDeRecursosDeLaEmpresaC
      Inherits Base_DatoC
          ...
          Public Shared ___ReferenciaEstadoPredeterminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaEstadoPredeterminado"",""etiqueta"": ""Estado predeterminado"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""titulo"": ""Estados de recursos de la empresa"",""iconoid"": ""5f47f190-826e-4f17-b6d3-ddfa9ca9d5e5"",""etiquetasingular"": ""Estado de recurso de la empresa"",""etiquetaplural"": ""Estados de recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Estado predeterminado"",""descripcion"": """",""keyword"": ""ReferenciaEstadoPredeterminado"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ReferenciaEstadoDividido As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaEstadoDividido"",""etiqueta"": ""Estado dividido"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""titulo"": ""Estados de recursos de la empresa"",""iconoid"": ""5f47f190-826e-4f17-b6d3-ddfa9ca9d5e5"",""etiquetasingular"": ""Estado de recurso de la empresa"",""etiquetaplural"": ""Estados de recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Estado dividido"",""descripcion"": """",""keyword"": ""ReferenciaEstadoDividido"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ReferenciaEstadoCompletamenteDividido As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaEstadoCompletamenteDividido"",""etiqueta"": ""Estado completamente dividido"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""titulo"": ""Estados de recursos de la empresa"",""iconoid"": ""5f47f190-826e-4f17-b6d3-ddfa9ca9d5e5"",""etiquetasingular"": ""Estado de recurso de la empresa"",""etiquetaplural"": ""Estados de recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Estado completamente dividido"",""descripcion"": """",""keyword"": ""ReferenciaEstadoCompletamenteDividido"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ReferenciaEstadoVendido As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaEstadoVendido"",""etiqueta"": ""Estado vendido"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""titulo"": ""Estados de recursos de la empresa"",""iconoid"": ""5f47f190-826e-4f17-b6d3-ddfa9ca9d5e5"",""etiquetasingular"": ""Estado de recurso de la empresa"",""etiquetaplural"": ""Estados de recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""add2a87e-dc6c-4624-a831-e92a7f65820e"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Estado vendido"",""descripcion"": """",""keyword"": ""ReferenciaEstadoVendido"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaEstadoVendido As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaEstadoVendido
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f027c4ff-70cf-46af-8423-f998db995b94"",""titulo"": ""Tipos de Recursos de la empresa"",""iconoid"": ""22ebc812-3dec-498b-b23a-4c3b46c0fcb9"",""etiquetasingular"": ""Tipo de Recurso de la empresa"",""etiquetaplural"": ""Tipos de Recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f027c4ff-70cf-46af-8423-f998db995b94"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class TiposDeRecursosDeLaEmpresa_FormularioC
    ...
    End Sub
        ...
        End Property
          ...
          Public property PermiteDividir As Boolean
            ...
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040440962", value)
            End Set
          End Property
          Public property ReferenciaEstadoPredeterminado As Guid
            ...
            End Set
          End Property
          Public property ReferenciaEstadoDividido As Guid
            get
                return me.GetValue_Guid("pr_40040440964")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040440964", value)
            End Set
          End Property
          Public property ReferenciaEstadoCompletamenteDividido As Guid
            get
                return me.GetValue_Guid("pr_40040440966")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040440966", value)
            End Set
          End Property
