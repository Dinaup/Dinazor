...
Partial Public Class SeccionesD
  Public Class EstadosDeRecursosDeLaEmpresaBaseD
      Public Class EstadosDeRecursosDeLaEmpresaBase_ConListaC
      Public Listador as EstadosDeRecursosDeLaEmpresaBaseC
      Public Lista As New List(of EstadosDeRecursosDeLaEmpresaBaseListaD.EstadosDeRecursosDeLaEmpresaBaseListaC)
        sub new(_listador  as EstadosDeRecursosDeLaEmpresaBaseC, _lista as List(of EstadosDeRecursosDeLaEmpresaBaseListaD.EstadosDeRecursosDeLaEmpresaBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "4b3df6f0-abb7-4957-976a-ff3809d6afb5"
      Public Shared _SeccionIDGUID As New Guid("4b3df6f0-abb7-4957-976a-ff3809d6afb5")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EstadosDeRecursosDeLaEmpresaBaseC )) 
          Dim R As New List(Of EstadosDeRecursosDeLaEmpresaBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EstadosDeRecursosDeLaEmpresaBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EstadosDeRecursosDeLaEmpresaBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  EstadosDeRecursosDeLaEmpresaBase_ConListaC)) 
          Dim R As New List(Of EstadosDeRecursosDeLaEmpresaBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EstadosDeRecursosDeLaEmpresaBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of EstadosDeRecursosDeLaEmpresaBaseListaD.EstadosDeRecursosDeLaEmpresaBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New EstadosDeRecursosDeLaEmpresaBaseListaD.EstadosDeRecursosDeLaEmpresaBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New EstadosDeRecursosDeLaEmpresaBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class EstadosDeRecursosDeLaEmpresaBaseES
          Public shared _SeccionID as Guid = New Guid("4b3df6f0-abb7-4957-976a-ff3809d6afb5")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_400104213724"
      ...
      End Class
      Public Class EstadosDeRecursosDeLaEmpresaBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4b3df6f0-abb7-4957-976a-ff3809d6afb5"",""titulo"": ""Base - Estados de recursos de la empresa"",""iconoid"": ""7a33f990-85ca-4f29-89fd-28545187a22d"",""etiquetasingular"": ""Estado de recurso de la empresa"",""etiquetaplural"": ""Estados de recursos de la empresa"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""4b3df6f0-abb7-4957-976a-ff3809d6afb5"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_400104213724")
         ...
         R.add("pr_400104213724", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
