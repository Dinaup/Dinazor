...
Partial Public Class SeccionesD
  Public Class TiposDeFacturasEDUD
      Public Shared _SeccionID As String = "c79a352a-b884-441f-8b29-16fabe287e79"
      Public Shared _SeccionIDGUID As New Guid("c79a352a-b884-441f-8b29-16fabe287e79")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeFacturasEDUC )) 
          Dim R As New List(Of TiposDeFacturasEDUC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeFacturasEDUES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TiposDeFacturasEDUC 
          ...
          Return R 
      End Function 
      Public Class TiposDeFacturasEDUES
          Public shared _SeccionID as Guid = New Guid("c79a352a-b884-441f-8b29-16fabe287e79")
      ...
      End Class
      Public Class TiposDeFacturasEDUC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""c79a352a-b884-441f-8b29-16fabe287e79"",""titulo"": ""EDU - Tipos de Facturas"",""iconoid"": """",""etiquetasingular"": ""Tipo de factura"",""etiquetaplural"": ""Tipos de factura"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""c79a352a-b884-441f-8b29-16fabe287e79"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
