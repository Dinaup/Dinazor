...
Partial Public Class SeccionesD
  Public Class EntradasDeCompra2BaseD
      Public Class EntradasDeCompra2Base_ConListaC
      Public Listador as EntradasDeCompra2BaseC
      Public Lista As New List(of EntradasDeCompra2BaseListaD.EntradasDeCompra2BaseListaC)
        sub new(_listador  as EntradasDeCompra2BaseC, _lista as List(of EntradasDeCompra2BaseListaD.EntradasDeCompra2BaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "fabd54cc-c555-4578-829d-a4194ebc9d32"
      Public Shared _SeccionIDGUID As New Guid("fabd54cc-c555-4578-829d-a4194ebc9d32")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EntradasDeCompra2BaseC )) 
          Dim R As New List(Of EntradasDeCompra2BaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeCompra2BaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EntradasDeCompra2BaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  EntradasDeCompra2Base_ConListaC)) 
          Dim R As New List(Of EntradasDeCompra2Base_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeCompra2BaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of EntradasDeCompra2BaseListaD.EntradasDeCompra2BaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New EntradasDeCompra2BaseListaD.EntradasDeCompra2BaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New EntradasDeCompra2Base_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class EntradasDeCompra2BaseES
          Public shared _SeccionID as Guid = New Guid("fabd54cc-c555-4578-829d-a4194ebc9d32")
      ...
      Public Shared ExportarEnModulos$ = "pr_600401057447"
      ...
      End Class
      Public Class EntradasDeCompra2BaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""fabd54cc-c555-4578-829d-a4194ebc9d32"",""titulo"": ""Base - Entradas de Compra (2)"",""iconoid"": ""ee656da0-2043-420c-80b9-4ebdb99ea97a"",""etiquetasingular"": ""Movimiento de producto"",""etiquetaplural"": ""Movimientos de producto"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""fabd54cc-c555-4578-829d-a4194ebc9d32"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
