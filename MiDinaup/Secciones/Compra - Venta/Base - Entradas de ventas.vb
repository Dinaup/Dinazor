...
Partial Public Class SeccionesD
  Public Class EntradasDeVentasBaseD
      Public Class EntradasDeVentasBase_ConListaC
      Public Listador as EntradasDeVentasBaseC
      Public Lista As New List(of EntradasDeVentasBaseListaD.EntradasDeVentasBaseListaC)
        sub new(_listador  as EntradasDeVentasBaseC, _lista as List(of EntradasDeVentasBaseListaD.EntradasDeVentasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "25a4c638-f52a-44cd-bafd-046ca19a2bf9"
      Public Shared _SeccionIDGUID As New Guid("25a4c638-f52a-44cd-bafd-046ca19a2bf9")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EntradasDeVentasBaseC )) 
          Dim R As New List(Of EntradasDeVentasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeVentasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EntradasDeVentasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  EntradasDeVentasBase_ConListaC)) 
          Dim R As New List(Of EntradasDeVentasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EntradasDeVentasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of EntradasDeVentasBaseListaD.EntradasDeVentasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New EntradasDeVentasBaseListaD.EntradasDeVentasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New EntradasDeVentasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class EntradasDeVentasBaseES
          Public shared _SeccionID as Guid = New Guid("25a4c638-f52a-44cd-bafd-046ca19a2bf9")
          Public shared _Tabla$ = "tpr_60040105741"
      Public Shared ExportarEnModulos$ = "pr_60040105746"
      ...
      End Class
      Public Class EntradasDeVentasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""25a4c638-f52a-44cd-bafd-046ca19a2bf9"",""titulo"": ""Base - Entradas de ventas"",""iconoid"": ""ee656da0-2043-420c-80b9-4ebdb99ea97a"",""etiquetasingular"": ""Movimiento de producto"",""etiquetaplural"": ""Movimientos de producto"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""25a4c638-f52a-44cd-bafd-046ca19a2bf9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
