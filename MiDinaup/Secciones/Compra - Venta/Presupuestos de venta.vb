...
Partial Public Class SeccionesD
  Public Class PresupuestosDeVentaD
      Public Class PresupuestosDeVenta_ConListaC
      Public Listador as PresupuestosDeVentaC
      Public Lista As New List(of PresupuestosDeVentaListaD.PresupuestosDeVentaListaC)
        sub new(_listador  as PresupuestosDeVentaC, _lista as List(of PresupuestosDeVentaListaD.PresupuestosDeVentaListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "ff4ea09c-1b83-462f-b782-60b8717d92a9"
      Public Shared _SeccionIDGUID As New Guid("ff4ea09c-1b83-462f-b782-60b8717d92a9")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PresupuestosDeVentaC )) 
          Dim R As New List(Of PresupuestosDeVentaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresupuestosDeVentaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PresupuestosDeVentaC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  PresupuestosDeVenta_ConListaC)) 
          Dim R As New List(Of PresupuestosDeVenta_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresupuestosDeVentaES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of PresupuestosDeVentaListaD.PresupuestosDeVentaListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New PresupuestosDeVentaListaD.PresupuestosDeVentaListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New PresupuestosDeVenta_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As PresupuestosDeVentaC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of PresupuestosDeVentaC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of PresupuestosDeVentaC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, PresupuestosDeVentaES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As PresupuestosDeVenta_ConListaC, Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of PresupuestosDeVenta_ConListaC)({DAtos}), CampoWhere, CampoWhereLista)
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of PresupuestosDeVenta_ConListaC), Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Dim Importar As New List(Of DinaupAPI_ImportacionProcesableC)
          For Each Actual In DAtos 
              Dim RegistroActual = New DinaupAPI_ImportacionProcesableC() 
               ...
               Importar.Add(RegistroActual)  
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, PresupuestosDeVentaES._SeccionID, Importar, CampoWhere, CampoWhereLista) 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As PresupuestosDeVenta_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, PresupuestosDeVentaES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New PresupuestosDeVenta_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As PresupuestosDeVenta_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, PresupuestosDeVentaES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New PresupuestosDeVenta_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class PresupuestosDeVentaES
          Public shared _SeccionID as Guid = New Guid("ff4ea09c-1b83-462f-b782-60b8717d92a9")
      ...
      End Class
      Public Class PresupuestosDeVentaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""ff4ea09c-1b83-462f-b782-60b8717d92a9"",""titulo"": ""Presupuestos de venta"",""iconoid"": ""a3bd13ea-5e23-4639-9469-9e9d27f4f569"",""etiquetasingular"": ""Presupuesto de venta"",""etiquetaplural"": ""Presupuestos de venta"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""ff4ea09c-1b83-462f-b782-60b8717d92a9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class PresupuestosDeVenta_FormularioC
        Inherits DinaNETCore.VentanaVirtualC

    Public _Lista As List(Of PresupuestosDeVentaListaD.PresupuestosDeVentaLista_FormularioC)
    ...
    Overrides Sub Evento_Actualizar()
        ...
        If Me.EsListador Then
            ...
            Dim CreandoLista As New List(Of PresupuestosDeVentaListaD.PresupuestosDeVentaLista_FormularioC)
            If FormLista IsNot Nothing Then
                For i = 0 To FormLista.Count - 1
                    Dim ElementoLista As New PresupuestosDeVentaListaD.PresupuestosDeVentaLista_FormularioC(Me.__VV__, FormLista(i).Token)
    ...
    End Sub
        ...
        Public ReadOnly property CantidadDeProductos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567377")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567376")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567375")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaConceptosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567374")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalB As String
            get
                return me.GetValue_String("pr_4004010567398")
            End Get
            Set(value As String)
                me.SetValue_String("pr_4004010567398", value)
            End Set
          End Property
        Public ReadOnly property CantidadDeProductosQuePuedenReservarse As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567371")
            End Get   
        End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_4004010567393")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567393", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleExenta As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567369")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567368")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567366")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567365")
            End Get   
        End Property
        Public ReadOnly property TotalProductosVendidosDestinador As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567363")
            End Get   
        End Property
        Public ReadOnly property TotalProductosPuedenFacturarse As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567364")
            End Get   
        End Property
        Public ReadOnly property ReferenciaImpuesto2 As Guid
            get
                return me.GetValue_Guid("pr_4004010567391")
            End Get   
        End Property
          Public property SaldoPromocionalGeneradoDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567362")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567362", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentoGeneralImpuestoExento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567360")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoExento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567358")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoExento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567359")
            End Get   
        End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_3004010555184")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555184", value)
            End Set
          End Property
          Public property DescuentoVIPDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567355")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567355", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaImporteProductosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567353")
            End Get   
        End Property
        Public ReadOnly property ImporteSaldoObtenidoEntidad As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567352")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567351")
            End Get   
        End Property
        Public ReadOnly property DescuentoAdicionalBAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567350")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567349")
            End Get   
        End Property
          Public property ValidoHasta_UTC As Date
            get
                return me.GetValue_DateTime("pr_30040108151")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_30040108151", value)
            End Set
          End Property
          Public property DescuentoGeneralDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567348")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567348", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_10040115004")
            End Get   
        End Property
          Public property ImporteSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567347")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567347", value)
            End Set
          End Property
          Public property DescuentoTipoDeEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567345")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567345", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaREImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567344")
            End Get   
        End Property
        Public ReadOnly property DescuentoVIPAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567343")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567342")
            End Get   
        End Property
        Public ReadOnly property ImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567341")
            End Get   
        End Property
        Public ReadOnly property DescuentoAdicionalAAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567340")
            End Get   
        End Property
        Public ReadOnly property ReferenciaImpuesto1 As Guid
            get
                return me.GetValue_Guid("pr_4004010567389")
            End Get   
        End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_4004010567397")
            End Get
            Set(value As String)
                me.SetValue_String("pr_4004010567397", value)
            End Set
          End Property
          Public property Anulado As Boolean
            get
                return me.GetValue_Boolean("pr_40040115761")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040115761", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567336")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567337")
            End Get   
        End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555185")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555185", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaImpuesto3 As Guid
            get
                return me.GetValue_Guid("pr_4004010567388")
            End Get   
        End Property
          Public property ReferenciaRetencion As Guid
            get
                return me.GetValue_Guid("pr_4004010567387")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567387", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555188")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555188", value)
            End Set
          End Property
        Public ReadOnly property TotalReservadosDestinadores As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567335")
            End Get   
        End Property
          Public property ReferenciaCliente As Guid
            get
                return me.GetValue_Guid("pr_4004010567386")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567386", value)
            End Set
          End Property
        Public ReadOnly property CantidadDeProductosVendiblesDesdePresupuesto As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567334")
            End Get   
        End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555195")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555195", value)
            End Set
          End Property
        Public ReadOnly property DescuentoEntidadAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567333")
            End Get   
        End Property
          Public property ClienteTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_4004010567394")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_4004010567394", value)
            End Set
          End Property
        Public ReadOnly property ImporteSubtotal As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567331")
            End Get   
        End Property
          Public property ImpuestosIncluidos As Boolean
            get
                return me.GetValue_Boolean("pr_4004010567409")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_4004010567409", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555182")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555182", value)
            End Set
          End Property
        Public ReadOnly property DescuentoGeneralAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567330")
            End Get   
        End Property
        Public ReadOnly property SumaConceptosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_500401150416")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567328")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567329")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalDescuentosNoAplicados As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567327")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567326")
            End Get   
        End Property
          Public property NumeroDeFacturaCompleto As String
            get
                return me.GetValue_String("pr_4004010567396")
            End Get
            Set(value As String)
                me.SetValue_String("pr_4004010567396", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567324")
            End Get   
        End Property
          Public property ReferenciaTipoDeCliente As Guid
            get
                return me.GetValue_Guid("pr_4004010567385")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567385", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567322")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaImporteDeProductosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567323")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalA As String
            get
                return me.GetValue_String("pr_4004010567395")
            End Get
            Set(value As String)
                me.SetValue_String("pr_4004010567395", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567320")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567319")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567316")
            End Get   
        End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_4004010567382")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567382", value)
            End Set
          End Property
          Public property DescuentoAdicionalBDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567314")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567314", value)
            End Set
          End Property
        Public ReadOnly property SaldoPromocionalGeneradoAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567313")
            End Get   
        End Property
          Public property ReferenciaTipoDeFactura As Guid
            get
                return me.GetValue_Guid("pr_4004010567381")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567381", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567312")
            End Get   
        End Property
        Public ReadOnly property ImporteImporteRetencion As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567310")
            End Get   
        End Property
          Public property ReferenciaEstado As Guid
            get
                return me.GetValue_Guid("pr_4004010567380")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567380", value)
            End Set
          End Property
        Public ReadOnly property ImporteSaldoQueTeniaElClienteAntesDeLaVenta As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567308")
            End Get   
        End Property
        Public ReadOnly property DescuentoTipoEntidadPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567307")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555196")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555196", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567309")
            End Get   
        End Property
          Public property NumeroDeFactura As Integer
            get
                return me.GetValue_Int("pr_4004010567402")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_4004010567402", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555183")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555183", value)
            End Set
          End Property
        Public ReadOnly property TotalPorcentajeDescuentosGeneralesPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567306")
            End Get   
        End Property
          Public property AplicarRecargoDeEquivalencia As Boolean
            get
                return me.GetValue_Boolean("pr_4004010567406")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_4004010567406", value)
            End Set
          End Property
          Public property ReferenciaConfiguracionDeVenta As Guid
            get
                return me.GetValue_Guid("pr_4004010567378")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_4004010567378", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567304")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductosFacturados As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567303")
            End Get   
        End Property
          Public property DescuentoEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567302")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567302", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuestoExentos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567301")
            End Get   
        End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_3004010555186")
            End Get   
        End Property
          Public property DescuentoAdicionalADeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567300")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_4004010567300", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_3004010555191")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalDescontadoSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_4004010567299")
            End Get   
        End Property
          Public property FechaContable As Date
            get
                return me.GetValue_Date("pr_30040135705")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_30040135705", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesEmpresa As Guid
            get
                return me.GetValue_Guid("pr_600401388212")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_600401388212", value)
            End Set
          End Property
          Public property CodigoPostalEmpresa As String
            get
                return me.GetValue_String("pr_600401388215")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388215", value)
            End Set
          End Property
          Public property TelefonoEmpresa As String
            get
                return me.GetValue_String("pr_600401388214")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388214", value)
            End Set
          End Property
          Public property DenominacionRazonSocialEmpresa As String
            get
                return me.GetValue_String("pr_600401388219")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388219", value)
            End Set
          End Property
          Public property PaisEmpresa As String
            get
                return me.GetValue_String("pr_600401388221")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388221", value)
            End Set
          End Property
          Public property DireccionEmpresa As String
            get
                return me.GetValue_String("pr_600401388222")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388222", value)
            End Set
          End Property
          Public property ProvinciaEmpresa As String
            get
                return me.GetValue_String("pr_600401388217")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388217", value)
            End Set
          End Property
          Public property NIFCliente As String
            get
                return me.GetValue_String("pr_300401388320")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388320", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesCliente As Guid
            get
                return me.GetValue_Guid("pr_300401388322")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_300401388322", value)
            End Set
          End Property
          Public property DenominacionRazonSocialCliente As String
            get
                return me.GetValue_String("pr_300401388323")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388323", value)
            End Set
          End Property
          Public property MunicipioEmpresa As String
            get
                return me.GetValue_String("pr_600401388218")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388218", value)
            End Set
          End Property
          Public property PaisCliente As String
            get
                return me.GetValue_String("pr_300401388324")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388324", value)
            End Set
          End Property
          Public property TelefonoCliente As String
            get
                return me.GetValue_String("pr_300401388319")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388319", value)
            End Set
          End Property
          Public property MunicipioCliente As String
            get
                return me.GetValue_String("pr_40040138832")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138832", value)
            End Set
          End Property
          Public property CodigoPostalCliente As String
            get
                return me.GetValue_String("pr_300401388321")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388321", value)
            End Set
          End Property
          Public property NIFEmpresa As String
            get
                return me.GetValue_String("pr_600401388220")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388220", value)
            End Set
          End Property
          Public property DireccionCliente As String
            get
                return me.GetValue_String("pr_300401388325")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388325", value)
            End Set
          End Property
          Public property ProvinciaCliente As String
            get
                return me.GetValue_String("pr_40040138831")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138831", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteImpuestoGeneral As Decimal
            get
                return me.GetValue_Decimal("pr_10040148963")
            End Get   
        End Property
          Public property ReferenciaImpuestoGeneral As Guid
            get
                return me.GetValue_Guid("pr_10040148964")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040148964", value)
            End Set
          End Property
          Public property CondicionesDePago As String
            get
                return me.GetValue_String("pr_60040172143")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040172143", value)
            End Set
          End Property
          Public property Terminos As String
            get
                return me.GetValue_String("pr_60040172148")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040172148", value)
            End Set
          End Property
          Public property NotasAIncluirEnLaFactura As String
            get
                return me.GetValue_String("pr_600401721414")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401721414", value)
            End Set
          End Property
          Public property MarcarComoConcluidaAunqueHayanProcesosPendientes As Boolean
            get
                return me.GetValue_Boolean("pr_10040173916")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_10040173916", value)
            End Set
          End Property
          Public property FechaDeVencimiento As Date
            get
                return me.GetValue_Date("pr_30040176562")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_30040176562", value)
            End Set
          End Property
          Public property CondicionDePagoDias As Integer
            get
                return me.GetValue_Int("pr_30040176561")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_30040176561", value)
            End Set
          End Property
          Public property OperacionIntragrupoObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_30040238922")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_30040238922", value)
            End Set
          End Property
          Public property InversionDelSujetoPasivoObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_60040238931")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040238931", value)
            End Set
          End Property
          Public property RegimenEspecialDeBienesUsadosObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_50040238945")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040238945", value)
            End Set
          End Property
          Public property CodigoPaisCliente As String
            get
                return me.GetValue_String("pr_60040241538")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241538", value)
            End Set
          End Property
          Public property TipoCIFNIFCliente As String
            get
                return me.GetValue_String("pr_20040241604")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040241604", value)
            End Set
          End Property
          Public property CodigoProvinciaCliente As String
            get
                return me.GetValue_String("pr_60040241537")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241537", value)
            End Set
          End Property
          Public property NIFIntracomunitarioEmpresa As String
            get
                return me.GetValue_String("pr_20040255423")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040255423", value)
            End Set
          End Property
          Public property NIFIntracomunitarioCliente As String
            get
                return me.GetValue_String("pr_20040255424")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040255424", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalOperacion As Decimal
            get
                return me.GetValue_Decimal("pr_60040256624")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalSuplidos As Decimal
            get
                return me.GetValue_Decimal("pr_60040256623")
            End Get   
        End Property
