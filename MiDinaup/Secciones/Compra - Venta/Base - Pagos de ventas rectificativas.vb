...
Partial Public Class SeccionesD
  Public Class PagosDeVentasRectificativasBaseD
      Public Class PagosDeVentasRectificativasBase_ConListaC
      Public Listador as PagosDeVentasRectificativasBaseC
      Public Lista As New List(of PagosDeVentasRectificativasBaseListaD.PagosDeVentasRectificativasBaseListaC)
        sub new(_listador  as PagosDeVentasRectificativasBaseC, _lista as List(of PagosDeVentasRectificativasBaseListaD.PagosDeVentasRectificativasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "995a925c-c3ed-4561-84f4-1b4d20a451d1"
      Public Shared _SeccionIDGUID As New Guid("995a925c-c3ed-4561-84f4-1b4d20a451d1")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PagosDeVentasRectificativasBaseC )) 
          Dim R As New List(Of PagosDeVentasRectificativasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PagosDeVentasRectificativasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PagosDeVentasRectificativasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  PagosDeVentasRectificativasBase_ConListaC)) 
          Dim R As New List(Of PagosDeVentasRectificativasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PagosDeVentasRectificativasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of PagosDeVentasRectificativasBaseListaD.PagosDeVentasRectificativasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New PagosDeVentasRectificativasBaseListaD.PagosDeVentasRectificativasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New PagosDeVentasRectificativasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class PagosDeVentasRectificativasBaseES
          Public shared _SeccionID as Guid = New Guid("995a925c-c3ed-4561-84f4-1b4d20a451d1")
      ...
      Public Shared ExportarEnModulos$ = "pr_100401058138"
      ...
      End Class
      Public Class PagosDeVentasRectificativasBaseC
      Inherits Base_DatoC
