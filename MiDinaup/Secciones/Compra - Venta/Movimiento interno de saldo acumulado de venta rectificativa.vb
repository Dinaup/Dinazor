...
Partial Public Class SeccionesD
  Public Class MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaD
      Public Shared _SeccionID As String = "7320c5fe-b1aa-4d99-bc50-9b94b27174f5"
      Public Shared _SeccionIDGUID As New Guid("7320c5fe-b1aa-4d99-bc50-9b94b27174f5")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaC )) 
          Dim R As New List(Of MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaC 
          ...
          Return R 
      End Function 
      Public Class MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaES
          Public shared _SeccionID as Guid = New Guid("7320c5fe-b1aa-4d99-bc50-9b94b27174f5")
      ...
      End Class
      Public Class MovimientoInternoDeSaldoAcumuladoDeVentaRectificativaC
      Inherits Base_DatoC
