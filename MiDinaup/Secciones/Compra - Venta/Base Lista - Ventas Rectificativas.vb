...
Partial Public Class SeccionesD
  Public Class VentasRectificativasBaseListaD
      Public Shared _SeccionID As String = "664770eb-4077-44b6-95e9-9b562580d552"
      Public Shared _SeccionIDGUID As New Guid("664770eb-4077-44b6-95e9-9b562580d552")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of VentasRectificativasBaseListaC )) 
          Dim R As New List(Of VentasRectificativasBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VentasRectificativasBaseListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New VentasRectificativasBaseListaC 
          ...
          Return R 
      End Function 
      Public Class VentasRectificativasBaseListaES
          Public shared _SeccionID as Guid = New Guid("664770eb-4077-44b6-95e9-9b562580d552")
      ...
      End Class
      Public Class VentasRectificativasBaseListaC
      Inherits Base_DatoC
