...
Partial Public Class SeccionesD
  Public Class VentasD
      Public Class Ventas_ConListaC
      Public Listador as VentasC
      Public Lista As New List(of VentasListaD.VentasListaC)
        sub new(_listador  as VentasC, _lista as List(of VentasListaD.VentasListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "0ce4c6ac-54aa-488d-b8b8-e3a20d79f7a4"
      Public Shared _SeccionIDGUID As New Guid("0ce4c6ac-54aa-488d-b8b8-e3a20d79f7a4")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of VentasC )) 
          Dim R As New List(Of VentasC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VentasES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New VentasC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  Ventas_ConListaC)) 
          Dim R As New List(Of Ventas_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VentasES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of VentasListaD.VentasListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New VentasListaD.VentasListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New Ventas_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As VentasC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of VentasC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of VentasC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, VentasES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As Ventas_ConListaC, Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of Ventas_ConListaC)({DAtos}), CampoWhere, CampoWhereLista)
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of Ventas_ConListaC), Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Dim Importar As New List(Of DinaupAPI_ImportacionProcesableC)
          For Each Actual In DAtos 
              Dim RegistroActual = New DinaupAPI_ImportacionProcesableC() 
               ...
               Importar.Add(RegistroActual)  
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, VentasES._SeccionID, Importar, CampoWhere, CampoWhereLista) 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As Ventas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VentasES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Ventas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As Ventas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VentasES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Ventas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class VentasES
          Public shared _SeccionID as Guid = New Guid("0ce4c6ac-54aa-488d-b8b8-e3a20d79f7a4")
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ReferenciaMovimientoInternoDeSaldoAcumulado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaMovimientoInternoDeSaldoAcumulado"",""etiqueta"": ""Movimiento interno de saldo acumulado"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""97da60ce-25cd-4fee-8ee4-f555ba039502"",""titulo"": ""Movimiento interno de saldo acumulado de venta"",""iconoid"": ""fc4e6fd7-d82c-42e3-b0d9-35cfefd324aa"",""etiquetasingular"": ""Movimiento interno de saldo acumulado de venta"",""etiquetaplural"": ""Movimientos internos de saldo acumulado de venta"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""97da60ce-25cd-4fee-8ee4-f555ba039502"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Movimiento interno de saldo acumulado"",""descripcion"": """",""keyword"": ""ReferenciaMovimientoInternoDeSaldoAcumulado"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ReferenciaEstado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaEstado"",""etiqueta"": ""Estado"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f6c70b72-de10-4ef1-b3ce-18b7d288f84b"",""titulo"": ""Estados de Ventas"",""iconoid"": ""1fbec552-994a-465e-a9ee-8502faa65d11"",""etiquetasingular"": ""Estado de venta"",""etiquetaplural"": ""Estados de venta"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f6c70b72-de10-4ef1-b3ce-18b7d288f84b"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Estado"",""descripcion"": """",""keyword"": ""ReferenciaEstado"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <Description("Observaciones adicionales de la transacción.")>
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""0ce4c6ac-54aa-488d-b8b8-e3a20d79f7a4"",""titulo"": ""Ventas"",""iconoid"": ""97fc02d2-1b1d-4c9d-babe-b503d3af7825"",""etiquetasingular"": ""Venta"",""etiquetaplural"": ""Ventas"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""0ce4c6ac-54aa-488d-b8b8-e3a20d79f7a4"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class Ventas_FormularioC
        Inherits DinaNETCore.VentanaVirtualC

    Public _Lista As List(Of VentasListaD.VentasLista_FormularioC)
    ...
    Overrides Sub Evento_Actualizar()
        ...
        If Me.EsListador Then
            ...
            Dim CreandoLista As New List(Of VentasListaD.VentasLista_FormularioC)
            If FormLista IsNot Nothing Then
                For i = 0 To FormLista.Count - 1
                    Dim ElementoLista As New VentasListaD.VentasLista_FormularioC(Me.__VV__, FormLista(i).Token)
    ...
    End Sub
          ...
          Public property ImporteCuotaImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055312")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_500401055312", value)
            End Set
          End Property
        Public ReadOnly property CantidadDeProductosQueDebenSalir As Decimal
            get
                return me.GetValue_Decimal("pr_50040105539")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaImporteProductosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_50040105538")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoExento As Decimal
            get
                return me.GetValue_Decimal("pr_50040105534")
            End Get   
        End Property
        Public ReadOnly property ReferenciaImpuesto1 As Guid
            get
                return me.GetValue_Guid("pr_500401055324")
            End Get   
        End Property
        Public ReadOnly property ImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_500401055323")
            End Get   
        End Property
          Public property ImporteCuotaREImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055325")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_500401055325", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055339")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_10040115003")
            End Get   
        End Property
        Public ReadOnly property SaldoPromocionalGeneradoAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055333")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalCobrado As Decimal
            get
                return me.GetValue_Decimal("pr_500401055336")
            End Get   
        End Property
          Public property DescuentoTipoDeEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055328")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_500401055328", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_50040105525")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040105525", value)
            End Set
          End Property
        Public ReadOnly property TotalProductosPuedenFacturarse As Decimal
            get
                return me.GetValue_Decimal("pr_500401055329")
            End Get   
        End Property
          Public property DescuentoGeneralDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055350")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_500401055350", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentoGeneralImpuestoExento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055347")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055348")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductosFacturados As Decimal
            get
                return me.GetValue_Decimal("pr_500401055345")
            End Get   
        End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_500401055346")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_500401055346", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055344")
            End Get   
        End Property
          Public property ReferenciaCliente As Guid
            get
                return me.GetValue_Guid("pr_60040105651")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040105651", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMovimientoInternoDeSaldoAcumulado As Guid
            get
                return me.GetValue_Guid("pr_10040106101")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055357")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductos As Decimal
            get
                return me.GetValue_Decimal("pr_500401055353")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055352")
            End Get   
        End Property
        Public ReadOnly property DescuentoTipoEntidadPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055356")
            End Get   
        End Property
          Public property DescuentoEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055378")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_500401055378", value)
            End Set
          End Property
        Public ReadOnly property ImporteSaldoQueTeniaElClienteAntesDeLaVenta As Decimal
            get
                return me.GetValue_Decimal("pr_500401055377")
            End Get   
        End Property
        Public ReadOnly property ReferenciaImpuesto2 As Guid
            get
                return me.GetValue_Guid("pr_500401055376")
            End Get   
        End Property
          Public property ReferenciaTipoDeCliente As Guid
            get
                return me.GetValue_Guid("pr_500401055367")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_500401055367", value)
            End Set
          End Property
          Public property ReferenciaConfiguracionDeVenta As Guid
            get
                return me.GetValue_Guid("pr_500401055387")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_500401055387", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalDescontadoSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_500401055388")
            End Get   
        End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_50040105526")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_50040105526", value)
            End Set
          End Property
        Public ReadOnly property ImporteSaldoObtenidoEntidad As Decimal
            get
                return me.GetValue_Decimal("pr_500401055384")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalDescuentosNoAplicados As Decimal
            get
                return me.GetValue_Decimal("pr_500401055382")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_50040105529")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_50040105529", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleExenta As Decimal
            get
                return me.GetValue_Decimal("pr_500401055399")
            End Get   
        End Property
          Public property AplicarRecargoDeEquivalencia As Boolean
            get
                return me.GetValue_Boolean("pr_500401055390")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_500401055390", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoExento As Decimal
            get
                return me.GetValue_Decimal("pr_500401055396")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055395")
            End Get   
        End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_500401055227")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_500401055227", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_500401055389")
            End Get   
        End Property
        Public ReadOnly property DescuentoVIPAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553114")
            End Get   
        End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_50040105523")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040105523", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553103")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalA As String
            get
                return me.GetValue_String("pr_5004010553125")
            End Get
            Set(value As String)
                me.SetValue_String("pr_5004010553125", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_5004010553126")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_5004010553126", value)
            End Set
          End Property
        Public ReadOnly property SumaConceptosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_500401150415")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalB As String
            get
                return me.GetValue_String("pr_5004010553127")
            End Get
            Set(value As String)
                me.SetValue_String("pr_5004010553127", value)
            End Set
          End Property
        Public ReadOnly property ImporteSubtotal As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553128")
            End Get   
        End Property
          Public property DescuentoAdicionalADeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553121")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553121", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553124")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaConceptosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553146")
            End Get   
        End Property
          Public property ImporteCuotaREImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553142")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553142", value)
            End Set
          End Property
          Public property ReferenciaRetencion As Guid
            get
                return me.GetValue_Guid("pr_5004010553143")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_5004010553143", value)
            End Set
          End Property
        Public ReadOnly property DescuentoAdicionalAAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553144")
            End Get   
        End Property
        Public ReadOnly property DescuentoEntidadAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553145")
            End Get   
        End Property
          Public property ReferenciaTipoDeFactura As Guid
            get
                return me.GetValue_Guid("pr_5004010553131")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_5004010553131", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuestoExentos As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553132")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductosQueSePuedenRectificar As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553135")
            End Get   
        End Property
          Public property DescuentoVIPDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553137")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553137", value)
            End Set
          End Property
          Public property ImporteSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553156")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553156", value)
            End Set
          End Property
        Public ReadOnly property TotalSalidosDestinadores As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553150")
            End Get   
        End Property
          Public property ClienteTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_60040105652")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040105652", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteRetencion As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553154")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaImporteDeProductosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553152")
            End Get   
        End Property
          Public property ReferenciaPresupuestoDeVenta As Guid
            get
                return me.GetValue_Guid("pr_20040105792")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040105792", value)
            End Set
          End Property
          Public property UsoDeSaldoPersonalizado As Boolean
            get
                return me.GetValue_Boolean("pr_30040113881001")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_30040113881001", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553170")
            End Get   
        End Property
        Public ReadOnly property TotalRectificadosDestinadores As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553165")
            End Get   
        End Property
        Public ReadOnly property DescuentoGeneralAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553164")
            End Get   
        End Property
          Public property ImporteCuotaImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553168")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553168", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553167")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553158")
            End Get   
        End Property
          Public property DescuentoAdicionalBDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553157")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553157", value)
            End Set
          End Property
          Public property ImporteCuotaREImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553159")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553159", value)
            End Set
          End Property
        Public ReadOnly property DescuentoAdicionalBAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553178")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553176")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553177")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_500401055225")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_500401055225", value)
            End Set
          End Property
        Public ReadOnly property TotalPorcentajeDescuentosGeneralesPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553193")
            End Get   
        End Property
          Public property ReferenciaEstado As Guid
            get
                return me.GetValue_Guid("pr_5004010553187")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_5004010553187", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_50040105524")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040105524", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553188")
            End Get   
        End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_5004010553182")
            End Get
            Set(value As String)
                me.SetValue_String("pr_5004010553182", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaImpuesto3 As Guid
            get
                return me.GetValue_Guid("pr_5004010553181")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553184")
            End Get   
        End Property
          Public property ImporteCuotaImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553180")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553180", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_500401055212")
            End Get   
        End Property
          Public property NumeroDeFacturaCompleto As String
            get
                return me.GetValue_String("pr_5004010553203")
            End Get
            Set(value As String)
                me.SetValue_String("pr_5004010553203", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_50040105527")
            End Get   
        End Property
          Public property SaldoPromocionalGeneradoDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553202")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_5004010553202", value)
            End Set
          End Property
          Public property NumeroDeFactura As Integer
            get
                return me.GetValue_Int("pr_5004010553194")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_5004010553194", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalACobrar As Decimal
            get
                return me.GetValue_Decimal("pr_5004010553198")
            End Get   
        End Property
          Public property FechaContable As Date
            get
                return me.GetValue_Date("pr_30040135703")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_30040135703", value)
            End Set
          End Property
          Public property ReferenciaAsientoContable As Guid
            get
                return me.GetValue_Guid("pr_20040135291003")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040135291003", value)
            End Set
          End Property
          Public property MunicipioEmpresa As String
            get
                return me.GetValue_String("pr_10040138834")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138834", value)
            End Set
          End Property
          Public property DireccionEmpresa As String
            get
                return me.GetValue_String("pr_10040138832")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138832", value)
            End Set
          End Property
          Public property NIFEmpresa As String
            get
                return me.GetValue_String("pr_600401388230")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388230", value)
            End Set
          End Property
          Public property PaisEmpresa As String
            get
                return me.GetValue_String("pr_300401388316")
            End Get
            Set(value As String)
                me.SetValue_String("pr_300401388316", value)
            End Set
          End Property
          Public property NIFCliente As String
            get
                return me.GetValue_String("pr_40040138834")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138834", value)
            End Set
          End Property
          Public property CodigoPostalCliente As String
            get
                return me.GetValue_String("pr_40040138835")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138835", value)
            End Set
          End Property
          Public property DenominacionRazonSocialCliente As String
            get
                return me.GetValue_String("pr_400401388311")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401388311", value)
            End Set
          End Property
          Public property MunicipioCliente As String
            get
                return me.GetValue_String("pr_40040138838")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138838", value)
            End Set
          End Property
          Public property CodigoPostalEmpresa As String
            get
                return me.GetValue_String("pr_10040138831")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138831", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesEmpresa As Guid
            get
                return me.GetValue_Guid("pr_600401388216")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_600401388216", value)
            End Set
          End Property
          Public property DenominacionRazonSocialEmpresa As String
            get
                return me.GetValue_String("pr_600401388229")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388229", value)
            End Set
          End Property
          Public property TelefonoEmpresa As String
            get
                return me.GetValue_String("pr_600401388231")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388231", value)
            End Set
          End Property
          Public property PaisCliente As String
            get
                return me.GetValue_String("pr_40040138837")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138837", value)
            End Set
          End Property
          Public property TelefonoCliente As String
            get
                return me.GetValue_String("pr_40040138833")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138833", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesCliente As Guid
            get
                return me.GetValue_Guid("pr_400401388310")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401388310", value)
            End Set
          End Property
          Public property ProvinciaEmpresa As String
            get
                return me.GetValue_String("pr_10040138833")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138833", value)
            End Set
          End Property
          Public property ProvinciaCliente As String
            get
                return me.GetValue_String("pr_40040138836")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138836", value)
            End Set
          End Property
          Public property DireccionCliente As String
            get
                return me.GetValue_String("pr_40040138839")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040138839", value)
            End Set
          End Property
          Public property ReferenciaImpuestoGeneral As Guid
            get
                return me.GetValue_Guid("pr_60040148951")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040148951", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteImpuestoGeneral As Decimal
            get
                return me.GetValue_Decimal("pr_10040148961")
            End Get   
        End Property
          Public property NotasAIncluirEnLaFactura As String
            get
                return me.GetValue_String("pr_50040172145")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040172145", value)
            End Set
          End Property
          Public property FechaDeVencimiento As Date
            get
                return me.GetValue_Date("pr_500401721410")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_500401721410", value)
            End Set
          End Property
          Public property CondicionesDePago As String
            get
                return me.GetValue_String("pr_50040172149")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040172149", value)
            End Set
          End Property
          Public property Terminos As String
            get
                return me.GetValue_String("pr_50040172147")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040172147", value)
            End Set
          End Property
          Public property MarcarComoConcluidaAunqueHayanProcesosPendientes As Boolean
            get
                return me.GetValue_Boolean("pr_10040173914")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_10040173914", value)
            End Set
          End Property
          Public property CondicionDePagoDias As Integer
            get
                return me.GetValue_Int("pr_20040176521")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_20040176521", value)
            End Set
          End Property
          Public property ImporteMargen As Decimal
            get
                return me.GetValue_Decimal("pr_50040192155")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_50040192155", value)
            End Set
          End Property
          Public property ImporteCoste As Decimal
            get
                return me.GetValue_Decimal("pr_50040192154")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_50040192154", value)
            End Set
          End Property
          Public property TotalProductosEntrados As Decimal
            get
                return me.GetValue_Decimal("pr_30040242011")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_30040242011", value)
            End Set
          End Property
          Public property OperacionIntragrupo As Boolean
            get
                return me.GetValue_Boolean("pr_10040238922")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_10040238922", value)
            End Set
          End Property
          Public property InversionDelSujetoPasivoObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_60040238932")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040238932", value)
            End Set
          End Property
          Public property RegimenEspecialDeBienesUsadosObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_50040238941")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040238941", value)
            End Set
          End Property
          Public property CodigoProvinciaCliente As String
            get
                return me.GetValue_String("pr_60040241534")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241534", value)
            End Set
          End Property
          Public property CodigoPaisCliente As String
            get
                return me.GetValue_String("pr_60040241533")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241533", value)
            End Set
          End Property
          Public property TipoCIFNIFCliente As String
            get
                return me.GetValue_String("pr_10040241603")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040241603", value)
            End Set
          End Property
          Public property CantidadDeProductosQueDebenEntrar As Decimal
            get
                return me.GetValue_Decimal("pr_10040242013")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_10040242013", value)
            End Set
          End Property
          Public property ReferenciaVentaQueSeEstaRectificando As Guid
            get
                return me.GetValue_Guid("pr_60040241852")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040241852", value)
            End Set
          End Property
          Public property Tipo__Int as Integer
            get
                return me.GetValue_Int("pr_500402418514")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_500402418514", value)
            End Set
          End Property
          Public property Tipo As EnumTipoMovimientoE
            get
          ...
          Public property RegimenDeViajerosObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_40040252091")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040252091", value)
            End Set
          End Property
          Public property NIFIntracomunitarioEmpresa As String
            get
                return me.GetValue_String("pr_20040255421")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040255421", value)
            End Set
          End Property
          Public property NIFIntracomunitarioCliente As String
            get
                return me.GetValue_String("pr_20040255422")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040255422", value)
            End Set
          End Property
          Public property ReferenciaActividad As Guid
            get
                return me.GetValue_Guid("pr_30040256145")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040256145", value)
            End Set
          End Property
          Public property BienDeInversionObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_60040256141")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040256141", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalSuplido As Decimal
            get
                return me.GetValue_Decimal("pr_20040256623")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalOperacion As Decimal
            get
                return me.GetValue_Decimal("pr_60040256622")
            End Get   
        End Property
          Public property ReferenciaClaveDeOperacion As Guid
            get
                return me.GetValue_Guid("pr_20040256921")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040256921", value)
            End Set
          End Property
          Public property EstablecerManualmenteLasCuotasDeImpuestos As Boolean
            get
                return me.GetValue_Boolean("pr_20040259251")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040259251", value)
            End Set
          End Property
          Public property EsUnIngresoSinFacturaObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_20040266791")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040266791", value)
            End Set
          End Property
          Public property AsignarManualmenteLaFechaContable As Boolean
            get
                return me.GetValue_Boolean("pr_20040268933")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040268933", value)
            End Set
          End Property
          Public property ReferenciaArrendamiento As Guid
            get
                return me.GetValue_Guid("pr_30040283271")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040283271", value)
            End Set
          End Property
          Public property ReferenciaRetoCapitalMobiliario As Guid
            get
                return me.GetValue_Guid("pr_30040283272")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040283272", value)
            End Set
          End Property
          Public property ReferenciaMonedaExtranjera As Guid
            get
                return me.GetValue_Guid("pr_60040454251")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040454251", value)
            End Set
          End Property
          Public property CambioMoneda As Decimal
            get
                return me.GetValue_Decimal("pr_60040454253")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_60040454253", value)
            End Set
          End Property
          Public property ImpuestosIncluidos As Boolean
            get
                return me.GetValue_Boolean("pr_50040105537")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040105537", value)
            End Set
          End Property
