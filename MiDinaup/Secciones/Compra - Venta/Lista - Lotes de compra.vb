...
Partial Public Class SeccionesD
  Public Class LotesDeCompraListaD
      Public Shared _SeccionID As String = "326e8a53-72d3-410b-a121-2e9207bbdd08"
      Public Shared _SeccionIDGUID As New Guid("326e8a53-72d3-410b-a121-2e9207bbdd08")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of LotesDeCompraListaC )) 
          Dim R As New List(Of LotesDeCompraListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(LotesDeCompraListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New LotesDeCompraListaC 
          ...
          Return R 
      End Function 
      Public Class LotesDeCompraListaES
          Public shared _SeccionID as Guid = New Guid("326e8a53-72d3-410b-a121-2e9207bbdd08")
          Public shared _Tabla$ = "tpr_3dd6762wc_e"
      Public Shared ReferenciaEmpleadoPrincipal$ = "pr_1464b41fecg201wd"
      Public Shared ReferenciaUbicacionPrincipal$ = "pr_1464b41fech201wd"
      Public Shared FechaDato_UTC$ = "pr_1463105a57x1aewd"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class LotesDeCompraListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""326e8a53-72d3-410b-a121-2e9207bbdd08"",""titulo"": ""Lista - Lotes de compra"",""iconoid"": """",""etiquetasingular"": ""Lote de compra"",""etiquetaplural"": ""Lotes de compra"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""326e8a53-72d3-410b-a121-2e9207bbdd08"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Lote de compra (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Lote de compra (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4cf26c00-e822-4752-a0bc-693b16ccd487"",""titulo"": ""Lotes de compra"",""iconoid"": ""dde28ea3-d0eb-4b04-9e2f-c9e44247be3d"",""etiquetasingular"": ""Lote de compra"",""etiquetaplural"": ""Lotes de compra"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""4cf26c00-e822-4752-a0bc-693b16ccd487"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Lote de compra (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Lote de compra (Listador) Eliminadoo *")>
          Public Property Listadoreliminado As Boolean
          Public Shared ___Listadoreliminado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""Listadoreliminado"",""etiqueta"": ""Lote de compra (Listador) Eliminadoo *"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Lote de compra (Listador) Eliminadoo *"",""descripcion"": """",""keyword"": ""Listadoreliminado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __Listadoreliminado As DinaNETCore.APID.DinaupAPI_CampoC = ___Listadoreliminado
          Overrides Sub CargarDatos(_Datos as Dic(of string,string))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1464b41fecg201wd"), _Datos.Leer_String("pr_1464b41fecg201wd.nombre"))
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1464b41fech201wd"), _Datos.Leer_String("pr_1464b41fech201wd.nombre"))
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_1463105a57x1aewd")
         ...
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_1464b41fecg201wd",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_1464b41fecg201wd","")
         End if
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_1464b41fech201wd",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_1464b41fech201wd","")
         End if
         R.add("pr_1463105a57x1aewd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class LotesDeCompraLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b41fecg201wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1464b41fecg201wd", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b41fech201wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1464b41fech201wd", value)
            End Set
          End Property
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_1463105a57x1aewd")
            End Get   
        End Property
