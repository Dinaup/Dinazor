...
Partial Public Class SeccionesD
  Public Class TiposDeFacturasListaD
      Public Shared _SeccionID As String = "af7d1345-fd29-405d-80f2-90e5eb80d2e9"
      Public Shared _SeccionIDGUID As New Guid("af7d1345-fd29-405d-80f2-90e5eb80d2e9")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeFacturasListaC )) 
          Dim R As New List(Of TiposDeFacturasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeFacturasListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TiposDeFacturasListaC 
          ...
          Return R 
      End Function 
      Public Class TiposDeFacturasListaES
          Public shared _SeccionID as Guid = New Guid("af7d1345-fd29-405d-80f2-90e5eb80d2e9")
      ...
      End Class
      Public Class TiposDeFacturasListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""af7d1345-fd29-405d-80f2-90e5eb80d2e9"",""titulo"": ""Lista - Tipos de Facturas"",""iconoid"": """",""etiquetasingular"": ""Tipo de factura"",""etiquetaplural"": ""Tipos de factura"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""af7d1345-fd29-405d-80f2-90e5eb80d2e9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class TiposDeFacturasLista_FormularioC
