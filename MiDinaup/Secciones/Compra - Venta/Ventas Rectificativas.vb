...
Partial Public Class SeccionesD
  Public Class VentasRectificativasD
      Public Class VentasRectificativas_ConListaC
      Public Listador as VentasRectificativasC
      Public Lista As New List(of VentasRectificativasListaD.VentasRectificativasListaC)
        sub new(_listador  as VentasRectificativasC, _lista as List(of VentasRectificativasListaD.VentasRectificativasListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "e63df5f3-2a6e-4cd8-90f3-9bcdccc33344"
      Public Shared _SeccionIDGUID As New Guid("e63df5f3-2a6e-4cd8-90f3-9bcdccc33344")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of VentasRectificativasC )) 
          Dim R As New List(Of VentasRectificativasC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VentasRectificativasES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New VentasRectificativasC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  VentasRectificativas_ConListaC)) 
          Dim R As New List(Of VentasRectificativas_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(VentasRectificativasES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of VentasRectificativasListaD.VentasRectificativasListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New VentasRectificativasListaD.VentasRectificativasListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New VentasRectificativas_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As VentasRectificativasC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of VentasRectificativasC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of VentasRectificativasC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, VentasRectificativasES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As VentasRectificativas_ConListaC, Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of VentasRectificativas_ConListaC)({DAtos}), CampoWhere, CampoWhereLista)
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of VentasRectificativas_ConListaC), Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Dim Importar As New List(Of DinaupAPI_ImportacionProcesableC)
          For Each Actual In DAtos 
              Dim RegistroActual = New DinaupAPI_ImportacionProcesableC() 
               ...
               Importar.Add(RegistroActual)  
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, VentasRectificativasES._SeccionID, Importar, CampoWhere, CampoWhereLista) 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As VentasRectificativas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VentasRectificativasES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New VentasRectificativas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As VentasRectificativas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, VentasRectificativasES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New VentasRectificativas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class VentasRectificativasES
          Public shared _SeccionID as Guid = New Guid("e63df5f3-2a6e-4cd8-90f3-9bcdccc33344")
      ...
      End Class
      Public Class VentasRectificativasC
      Inherits Base_DatoC
          ...
          Public Shared ___ReferenciaMovimientoInternoDeSaldoAcumulado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaMovimientoInternoDeSaldoAcumulado"",""etiqueta"": ""Movimiento interno de saldo acumulado"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""7320c5fe-b1aa-4d99-bc50-9b94b27174f5"",""titulo"": ""Movimiento interno de saldo acumulado de venta rectificativa"",""iconoid"": ""fc4e6fd7-d82c-42e3-b0d9-35cfefd324aa"",""etiquetasingular"": ""Movimiento interno de saldo acumulado de Venta Rectificativa"",""etiquetaplural"": ""Movimientos interno de saldo acumulado de ventas Rectificativas"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""7320c5fe-b1aa-4d99-bc50-9b94b27174f5"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Movimiento interno de saldo acumulado"",""descripcion"": """",""keyword"": ""ReferenciaMovimientoInternoDeSaldoAcumulado"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""e63df5f3-2a6e-4cd8-90f3-9bcdccc33344"",""titulo"": ""Ventas Rectificativas"",""iconoid"": ""59635ab4-006a-48a9-9fb4-e2a206b9edc5"",""etiquetasingular"": ""Venta rectificativa"",""etiquetaplural"": ""Ventas rectificativas"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""e63df5f3-2a6e-4cd8-90f3-9bcdccc33344"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class VentasRectificativas_FormularioC
        Inherits DinaNETCore.VentanaVirtualC

    Public _Lista As List(Of VentasRectificativasListaD.VentasRectificativasLista_FormularioC)
    ...
    Overrides Sub Evento_Actualizar()
        ...
        If Me.EsListador Then
            ...
            Dim CreandoLista As New List(Of VentasRectificativasListaD.VentasRectificativasLista_FormularioC)
            If FormLista IsNot Nothing Then
                For i = 0 To FormLista.Count - 1
                    Dim ElementoLista As New VentasRectificativasListaD.VentasRectificativasLista_FormularioC(Me.__VV__, FormLista(i).Token)
    ...
    End Sub
          ...
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555198")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555198", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056771")
            End Get   
        End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_400401056794")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056794", value)
            End Set
          End Property
          Public property ReferenciaTipoDeMovimiento As Guid
            get
                return me.GetValue_Guid("pr_400401056793")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056793", value)
            End Set
          End Property
          Public property RectificacionEstricta As Boolean
            get
                return me.GetValue_Boolean("pr_60040115494")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040115494", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056769")
            End Get   
        End Property
          Public property DescuentoEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056770")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056770", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_400401056792")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056792", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056773")
            End Get   
        End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_3004010555201")
            End Get   
        End Property
        Public ReadOnly property ImporteVentaQueSeHaRectificadoSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_100401150211")
            End Get   
        End Property
        Public ReadOnly property ImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_400401056776")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056775")
            End Get   
        End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_3004010555206")
            End Get   
        End Property
          Public property DescuentoAdicionalADeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056777")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056777", value)
            End Set
          End Property
        Public ReadOnly property TotalProductosPuedenFacturarse As Decimal
            get
                return me.GetValue_Decimal("pr_400401056778")
            End Get   
        End Property
        Public ReadOnly property ReferenciaResumenImpuesto3 As Guid
            get
                return me.GetValue_Guid("pr_400401056795")
            End Get   
        End Property
          Public property DescuentoGeneralDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056761")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056761", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056763")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056765")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoExento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056764")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056767")
            End Get   
        End Property
          Public property ClienteTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_400401056796")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_400401056796", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalPagado As Decimal
            get
                return me.GetValue_Decimal("pr_400401056766")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555221")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555221", value)
            End Set
          End Property
          Public property ReferenciaTipoDeCliente As Guid
            get
                return me.GetValue_Guid("pr_400401056791")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056791", value)
            End Set
          End Property
        Public ReadOnly property DescuentoAdicionalAAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056751")
            End Get   
        End Property
          Public property ImpuestosIncluidos As Boolean
            get
                return me.GetValue_Boolean("pr_4004010567111")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_4004010567111", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056750")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalDescuentosNoAplicados As Decimal
            get
                return me.GetValue_Decimal("pr_400401056749")
            End Get   
        End Property
        Public ReadOnly property ImporteReduccionDePagoPorReembolsoSaldoPromocional As Decimal
            get
                return me.GetValue_Decimal("pr_20040113861")
            End Get   
        End Property
          Public property UsoDeSaldoPersonalizado As Boolean
            get
                return me.GetValue_Boolean("pr_40040115771")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040115771", value)
            End Set
          End Property
        Public ReadOnly property SumaConceptosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_500401150417")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056754")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056757")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuestoExentos As Decimal
            get
                return me.GetValue_Decimal("pr_400401056759")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056758")
            End Get   
        End Property
        Public ReadOnly property DescuentoAdicionalBAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056756")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalAPagar As Decimal
            get
                return me.GetValue_Decimal("pr_400401056743")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductosFacturados As Decimal
            get
                return me.GetValue_Decimal("pr_400401056744")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalA As String
            get
                return me.GetValue_String("pr_4004010567100")
            End Get
            Set(value As String)
                me.SetValue_String("pr_4004010567100", value)
            End Set
          End Property
        Public ReadOnly property ImporteIngresoDeSaldoUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_50040114922")
            End Get   
        End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555197")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555197", value)
            End Set
          End Property
          Public property ReferenciaEstado As Guid
            get
                return me.GetValue_Guid("pr_400401056787")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056787", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056745")
            End Get   
        End Property
        Public ReadOnly property ImporteSaldoQueRecuperaElClienteInmediato As Decimal
            get
                return me.GetValue_Decimal("pr_30040115331")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056748")
            End Get   
        End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555200")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555200", value)
            End Set
          End Property
        Public ReadOnly property ImporteSaldoObtenidoEntidad As Decimal
            get
                return me.GetValue_Decimal("pr_400401056733")
            End Get   
        End Property
        Public ReadOnly property ImporteImporteRetencion As Decimal
            get
                return me.GetValue_Decimal("pr_400401056731")
            End Get   
        End Property
        Public ReadOnly property ReferenciaResumenImpuesto1 As Guid
            get
                return me.GetValue_Guid("pr_400401056786")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555203")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555203", value)
            End Set
          End Property
        Public ReadOnly property ImporteSaldoRecuperaClienteAlPagar As Decimal
            get
                return me.GetValue_Decimal("pr_60040113861002")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056736")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056735")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoExento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056740")
            End Get   
        End Property
          Public property SaldoPromocionalGeneradoDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056738")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056738", value)
            End Set
          End Property
        Public ReadOnly property ImporteSubtotal As Decimal
            get
                return me.GetValue_Decimal("pr_400401056739")
            End Get   
        End Property
        Public ReadOnly property ImporteVentaQueSeHaRectificadoTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_100401150210")
            End Get   
        End Property
          Public property DescuentoVIPDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056737")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056737", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056742")
            End Get   
        End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555222")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555222", value)
            End Set
          End Property
        Public ReadOnly property SaldoPromocionalGeneradoAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056741")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056725")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalDescontadoSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_400401056723")
            End Get   
        End Property
          Public property ReferenciaVentaQueSeEstaRectificando As Guid
            get
                return me.GetValue_Guid("pr_20040105791")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040105791", value)
            End Set
          End Property
        Public ReadOnly property NumeroDeFacturaCompleto As String
            get
                return me.GetValue_String("pr_400401056799")
            End Get   
        End Property
        Public ReadOnly property DescuentoEntidadAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056726")
            End Get   
        End Property
          Public property DescuentoTipoDeEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056730")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056730", value)
            End Set
          End Property
        Public ReadOnly property DescuentoVIPAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056729")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_400401056728")
            End Get   
        End Property
        Public ReadOnly property ImporteSaldoQueTeniaElClienteAntesDeLaVenta As Decimal
            get
                return me.GetValue_Decimal("pr_400401056713")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_10040115005")
            End Get   
        End Property
        Public ReadOnly property DescuentoTipoEntidadPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056711")
            End Get   
        End Property
          Public property ReferenciaCliente As Guid
            get
                return me.GetValue_Guid("pr_400401056781")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056781", value)
            End Set
          End Property
        Public ReadOnly property TotalProductosEntrados As Decimal
            get
                return me.GetValue_Decimal("pr_400401056717")
            End Get   
        End Property
          Public property AplicarRecargoDeEquivalencia As Boolean
            get
                return me.GetValue_Boolean("pr_4004010567108")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_4004010567108", value)
            End Set
          End Property
          Public property ReferenciaRetencion As Guid
            get
                return me.GetValue_Guid("pr_400401056782")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056782", value)
            End Set
          End Property
          Public property ReembolsarConSaldoPromocional As Boolean
            get
                return me.GetValue_Boolean("pr_60040113861001")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040113861001", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_3004010555199")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555199", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMovimientoInternoDeSaldoAcumulado As Guid
            get
                return me.GetValue_Guid("pr_10040107062")
            End Get   
        End Property
        Public ReadOnly property TotalPorcentajeDescuentosGeneralesPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056715")
            End Get   
        End Property
        Public ReadOnly property DescuentoGeneralAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056716")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductosQueDebenEntrar As Decimal
            get
                return me.GetValue_Decimal("pr_400401056718")
            End Get   
        End Property
        Public ReadOnly property VentaQueSeHaRectificadoRatioDeProrrateo As Decimal
            get
                return me.GetValue_Decimal("pr_10040115061")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaImporteProductosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_400401056722")
            End Get   
        End Property
          Public property ReferenciaConfiguracionDeVenta As Guid
            get
                return me.GetValue_Guid("pr_400401056783")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401056783", value)
            End Set
          End Property
        Public ReadOnly property CantidadDeProductos As Decimal
            get
                return me.GetValue_Decimal("pr_400401056720")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleExenta As Decimal
            get
                return me.GetValue_Decimal("pr_40040105673")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_40040105674")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaConceptosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_40040105672")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_40040105671")
            End Get   
        End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_400401056797")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401056797", value)
            End Set
          End Property
          Public property NumeroDeFactura As Integer
            get
                return me.GetValue_Int("pr_4004010567104")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_4004010567104", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaREImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_40040105678")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_40040105679")
            End Get   
        End Property
        Public ReadOnly property ImporteVentaQueSeHaRectificadoImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_10040115029")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaImporteDeProductosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_40040105677")
            End Get   
        End Property
        Public ReadOnly property ReferenciaResumenImpuesto2 As Guid
            get
                return me.GetValue_Guid("pr_400401056780")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoGeneralImpuestoExento As Decimal
            get
                return me.GetValue_Decimal("pr_40040105675")
            End Get   
        End Property
          Public property ImporteSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_40040105676")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_40040105676", value)
            End Set
          End Property
          Public property DescuentoAdicionalBDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_400401056710")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_400401056710", value)
            End Set
          End Property
          Public property DescripcionDescuentoAdicionalB As String
            get
                return me.GetValue_String("pr_400401056798")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401056798", value)
            End Set
          End Property
          Public property FechaContable As Date
            get
                return me.GetValue_Date("pr_40040135704")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_40040135704", value)
            End Set
          End Property
          Public property ReferenciaAsientoContable As Guid
            get
                return me.GetValue_Guid("pr_30040135292")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040135292", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesEmpresa As Guid
            get
                return me.GetValue_Guid("pr_600401388213")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_600401388213", value)
            End Set
          End Property
          Public property DenominacionRazonSocialEmpresa As String
            get
                return me.GetValue_String("pr_600401388227")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388227", value)
            End Set
          End Property
          Public property DireccionEmpresa As String
            get
                return me.GetValue_String("pr_600401388223")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388223", value)
            End Set
          End Property
          Public property CodigoPostalEmpresa As String
            get
                return me.GetValue_String("pr_600401388224")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388224", value)
            End Set
          End Property
          Public property TelefonoEmpresa As String
            get
                return me.GetValue_String("pr_10040138835")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138835", value)
            End Set
          End Property
          Public property ProvinciaEmpresa As String
            get
                return me.GetValue_String("pr_10040138836")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138836", value)
            End Set
          End Property
          Public property MunicipioEmpresa As String
            get
                return me.GetValue_String("pr_600401388226")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388226", value)
            End Set
          End Property
          Public property CIFNIFEmpresa As String
            get
                return me.GetValue_String("pr_600401388228")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388228", value)
            End Set
          End Property
          Public property PaisEmpresa As String
            get
                return me.GetValue_String("pr_600401388225")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401388225", value)
            End Set
          End Property
          Public property CodigoPostalCliente As String
            get
                return me.GetValue_String("pr_400401388314")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401388314", value)
            End Set
          End Property
          Public property TelefonoCliente As String
            get
                return me.GetValue_String("pr_400401388312")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401388312", value)
            End Set
          End Property
          Public property DenominacionRazonSocialCliente As String
            get
                return me.GetValue_String("pr_400401388313")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401388313", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesCliente As Guid
            get
                return me.GetValue_Guid("pr_400401388316")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401388316", value)
            End Set
          End Property
          Public property MunicipioCliente As String
            get
                return me.GetValue_String("pr_50040138832")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040138832", value)
            End Set
          End Property
          Public property PaisCliente As String
            get
                return me.GetValue_String("pr_50040138831")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040138831", value)
            End Set
          End Property
          Public property CIFNIFCliente As String
            get
                return me.GetValue_String("pr_50040138835")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040138835", value)
            End Set
          End Property
          Public property DireccionCliente As String
            get
                return me.GetValue_String("pr_400401388315")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401388315", value)
            End Set
          End Property
          Public property ProvinciaCliente As String
            get
                return me.GetValue_String("pr_50040138833")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040138833", value)
            End Set
          End Property
          Public property ReferenciaImpuestoGeneral As Guid
            get
                return me.GetValue_Guid("pr_20040148962")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040148962", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteImpuestoGeneral As Decimal
            get
                return me.GetValue_Decimal("pr_20040148963")
            End Get   
        End Property
          Public property Terminos As String
            get
                return me.GetValue_String("pr_600401721410")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401721410", value)
            End Set
          End Property
          Public property FechaDeVencimiento As Date
            get
                return me.GetValue_Date("pr_60040172145")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_60040172145", value)
            End Set
          End Property
          Public property NotasAIncluirEnLaFactura As String
            get
                return me.GetValue_String("pr_600401721413")
            End Get
            Set(value As String)
                me.SetValue_String("pr_600401721413", value)
            End Set
          End Property
          Public property CondicionesDePago As String
            get
                return me.GetValue_String("pr_60040172146")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040172146", value)
            End Set
          End Property
          Public property MarcarComoConcluidaAunqueHayanProcesosPendientes As Boolean
            get
                return me.GetValue_Boolean("pr_10040173915")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_10040173915", value)
            End Set
          End Property
          Public property CondicionDePagoDias As Integer
            get
                return me.GetValue_Int("pr_20040176522")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_20040176522", value)
            End Set
          End Property
          Public property ImporteCoste As Decimal
            get
                return me.GetValue_Decimal("pr_200401921757")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_200401921757", value)
            End Set
          End Property
          Public property ImporteMargen As Decimal
            get
                return me.GetValue_Decimal("pr_200401921758")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_200401921758", value)
            End Set
          End Property
          Public property OperacionIntragrupo As Boolean
            get
                return me.GetValue_Boolean("pr_40040238921")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040238921", value)
            End Set
          End Property
          Public property InversionDelSujetoPasivo As Boolean
            get
                return me.GetValue_Boolean("pr_60040238933")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040238933", value)
            End Set
          End Property
          Public property RegimenEspecialDeBienesUsados As Boolean
            get
                return me.GetValue_Boolean("pr_50040238946")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040238946", value)
            End Set
          End Property
          Public property TipoCIFNIFCliente As String
            get
                return me.GetValue_String("pr_20040241605")
            End Get
            Set(value As String)
                me.SetValue_String("pr_20040241605", value)
            End Set
          End Property
          Public property CodigoPaisCliente As String
            get
                return me.GetValue_String("pr_60040241535")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241535", value)
            End Set
          End Property
          Public property CodigoProvinciaCliente As String
            get
                return me.GetValue_String("pr_60040241536")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040241536", value)
            End Set
          End Property
