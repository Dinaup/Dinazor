...
Partial Public Class SeccionesD
  Public Class PresupuestosDeComprasYGastosBaseD
      Public Class PresupuestosDeComprasYGastosBase_ConListaC
      Public Listador as PresupuestosDeComprasYGastosBaseC
      Public Lista As New List(of PresupuestosDeComprasYGastosBaseListaD.PresupuestosDeComprasYGastosBaseListaC)
        sub new(_listador  as PresupuestosDeComprasYGastosBaseC, _lista as List(of PresupuestosDeComprasYGastosBaseListaD.PresupuestosDeComprasYGastosBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "58e29a64-9f4a-4640-bf8f-dddbaa4158df"
      Public Shared _SeccionIDGUID As New Guid("58e29a64-9f4a-4640-bf8f-dddbaa4158df")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PresupuestosDeComprasYGastosBaseC )) 
          Dim R As New List(Of PresupuestosDeComprasYGastosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresupuestosDeComprasYGastosBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PresupuestosDeComprasYGastosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  PresupuestosDeComprasYGastosBase_ConListaC)) 
          Dim R As New List(Of PresupuestosDeComprasYGastosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresupuestosDeComprasYGastosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of PresupuestosDeComprasYGastosBaseListaD.PresupuestosDeComprasYGastosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New PresupuestosDeComprasYGastosBaseListaD.PresupuestosDeComprasYGastosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New PresupuestosDeComprasYGastosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class PresupuestosDeComprasYGastosBaseES
          Public shared _SeccionID as Guid = New Guid("58e29a64-9f4a-4640-bf8f-dddbaa4158df")
      ...
      Public Shared ExportarEnModulos$ = "pr_3004010555239"
      ...
      End Class
      Public Class PresupuestosDeComprasYGastosBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""58e29a64-9f4a-4640-bf8f-dddbaa4158df"",""titulo"": ""Base - Presupuestos de Compras y Gastos"",""iconoid"": ""6c17ff24-7fbc-40de-b2c2-eba0c969191f"",""etiquetasingular"": ""Presupuesto de Compra / Gasto"",""etiquetaplural"": ""Presupuestos de Compras y Gastos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""58e29a64-9f4a-4640-bf8f-dddbaa4158df"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
