...
Partial Public Class SeccionesD
  Public Class CobrosDeRectificacionesComprasListaD
      Public Shared _SeccionID As String = "6e8a3695-d49f-4577-8097-e52e1ffdfe4f"
      Public Shared _SeccionIDGUID As New Guid("6e8a3695-d49f-4577-8097-e52e1ffdfe4f")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CobrosDeRectificacionesComprasListaC )) 
          Dim R As New List(Of CobrosDeRectificacionesComprasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CobrosDeRectificacionesComprasListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CobrosDeRectificacionesComprasListaC 
          ...
          Return R 
      End Function 
      Public Class CobrosDeRectificacionesComprasListaES
          Public shared _SeccionID as Guid = New Guid("6e8a3695-d49f-4577-8097-e52e1ffdfe4f")
      ...
      End Class
      Public Class CobrosDeRectificacionesComprasListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""6e8a3695-d49f-4577-8097-e52e1ffdfe4f"",""titulo"": ""Lista - Cobros de rectificaciones Compras"",""iconoid"": """",""etiquetasingular"": ""Cobro de rectificación Compra"",""etiquetaplural"": ""Cobros de rectificaciones Compras"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""6e8a3695-d49f-4577-8097-e52e1ffdfe4f"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class CobrosDeRectificacionesComprasLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_100401058719")
            End Get   
        End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_100401058717")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401058717", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_100401058716")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401058716", value)
            End Set
          End Property
