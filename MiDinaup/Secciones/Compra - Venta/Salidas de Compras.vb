...
Partial Public Class SeccionesD
  Public Class SalidasDeComprasD
      Public Shared _SeccionID As String = "377ed111-4619-4c2e-b3ae-a959d6a71d89"
      Public Shared _SeccionIDGUID As New Guid("377ed111-4619-4c2e-b3ae-a959d6a71d89")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SalidasDeComprasC )) 
          Dim R As New List(Of SalidasDeComprasC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeComprasES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SalidasDeComprasC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As SalidasDeComprasC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of SalidasDeComprasC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of SalidasDeComprasC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, SalidasDeComprasES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As SalidasDeCompras_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeComprasES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeCompras_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As SalidasDeCompras_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeComprasES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeCompras_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class SalidasDeComprasES
          Public shared _SeccionID as Guid = New Guid("377ed111-4619-4c2e-b3ae-a959d6a71d89")
          Public shared _Tabla$ = "tpr_60040105745"
      Public Shared ReferenciaProducto$ = "pr_10040106053"
      Public Shared ReferenciaMedidaBase$ = "pr_10040106055"
      Public Shared CantidadUnidades$ = "pr_10040106058"
      Public Shared ReferenciaAutorDelAlta$ = "pr_6004010574115"
      Public Shared ReferenciaTicket$ = "pr_6004010574176"
      Public Shared ReferenciaMovimientoInterno$ = "pr_6004010574169"
      Public Shared ReferenciaElementoDeCompraRectificativaO1$ = "pr_10040105765"
      Public Shared ProveedorTieneAccesoWeb$ = "pr_6004010574175"
      Public Shared FechaAlta_UTC$ = "pr_6004010574119"
      Public Shared FechaDato_UTC$ = "pr_6004010574116"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_6004010574139"
      Public Shared ReferenciaMedida$ = "pr_10040106059"
      Public Shared ReferenciaEmpleadoPrincipal$ = "pr_6004010574113"
      Public Shared Cantidad$ = "pr_10040106056"
      Public Shared ReferenciaProveedor$ = "pr_6004010574171"
      Public Shared ReferenciaLote$ = "pr_100401060510"
      Public Shared Observaciones$ = "pr_6004010574178"
      Public Shared ReferenciaCompraO1$ = "pr_10040105766"
      Public Shared TextoTicket$ = "pr_6004010574177"
      Public Shared CantidadMedidaBase$ = "pr_10040106054"
      Public Shared CantidadMedidaBasePorUnd$ = "pr_10040106057"
      Public Shared ReferenciaNumeracionSerie$ = "pr_6004010574174"
      Public Shared AutorDelAltaTieneAccesoWeb$ = "pr_6004010574137"
      Public Shared ReferenciaPuestoDeTrabajo$ = "pr_6004010574173"
      Public Shared ReferenciaUbicacionPrincipal$ = "pr_6004010574114"
      Public Shared ReferenciaTipoDeMovimiento$ = "pr_6004010574172"
      Public Shared ReferenciaDestinador$ = "pr_6004010574122"
      Public Shared HoraLocal$ = "pr_6004010574117"
      Public Shared ReferenciaProductoCompradoOrigen$ = "pr_20040242022"
      Public Shared ReferenciaCompraOrigen$ = "pr_20040242021"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class SalidasDeComprasC
      Inherits Base_DatoC
          ...
          <DisplayName("Elemento de Compra rectificativa (o1)")>
          Public Property ReferenciaElementoDeCompraRectificativaO1 As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaElementoDeCompraRectificativaO1 As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaElementoDeCompraRectificativaO1"",""etiqueta"": ""Elemento de Compra rectificativa (o1)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""05e5e249-9afe-4eb5-9a55-6e47e63e429f"",""titulo"": ""Base Lista - Compras rectificativas"",""iconoid"": """",""etiquetasingular"": ""Elemento de Compra rectificativa"",""etiquetaplural"": ""Elemento de Compras rectificativas"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""05e5e249-9afe-4eb5-9a55-6e47e63e429f"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Elemento de Compra rectificativa (o1)"",""descripcion"": """",""keyword"": ""ReferenciaElementoDeCompraRectificativaO1"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaElementoDeCompraRectificativaO1 As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaElementoDeCompraRectificativaO1
          ...
          <DisplayName("Compra (o1)")>
          Public Property ReferenciaCompraO1 As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaCompraO1 As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaCompraO1"",""etiqueta"": ""Compra (o1)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""fecd2787-c7cf-415d-8f69-32abd415f948"",""titulo"": ""Base - Compras rectificativas"",""iconoid"": ""28ad3bf4-ea68-470a-90d5-949d6f88da18"",""etiquetasingular"": ""Compra rectificativa"",""etiquetaplural"": ""Compras rectificativas"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""fecd2787-c7cf-415d-8f69-32abd415f948"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Compra (o1)"",""descripcion"": """",""keyword"": ""ReferenciaCompraO1"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaCompraO1 As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaCompraO1
          ...
          <DisplayName("Producto Comprado (Origen)")>
          Public Property ReferenciaProductoCompradoOrigen As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaProductoCompradoOrigen As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaProductoCompradoOrigen"",""etiqueta"": ""Producto Comprado (Origen)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""0447cca1-0bca-4c0e-921a-0d848f088a98"",""titulo"": ""Base Lista - Compras y Gastos"",""iconoid"": """",""etiquetasingular"": ""Elemento de Compra / Gasto"",""etiquetaplural"": ""Elementos de Compra / Gasto"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""0447cca1-0bca-4c0e-921a-0d848f088a98"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Producto Comprado (Origen)"",""descripcion"": """",""keyword"": ""ReferenciaProductoCompradoOrigen"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaProductoCompradoOrigen As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaProductoCompradoOrigen
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""377ed111-4619-4c2e-b3ae-a959d6a71d89"",""titulo"": ""Salidas de Compras"",""iconoid"": ""fcc4c1a5-24a3-4221-adcc-0d27247804b9"",""etiquetasingular"": ""Salida de compra"",""etiquetaplural"": ""Salidas de compra"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""377ed111-4619-4c2e-b3ae-a959d6a71d89"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaProducto = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040106053"), _Datos.Leer_String("pr_10040106053.nombre"))
          me.ReferenciaMedidaBase = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040106055"), _Datos.Leer_String("pr_10040106055.nombre"))
          me.CantidadUnidades = _Datos.Leer_Decimal("pr_10040106058")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574115"), _Datos.Leer_String("pr_6004010574115.nombre"))
          me.ReferenciaTicket = _Datos.Leer_Integer("pr_6004010574176")
          me.ReferenciaMovimientoInterno = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574169"), _Datos.Leer_String("pr_6004010574169.nombre"))
          me.ReferenciaElementoDeCompraRectificativaO1 = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040105765"), _Datos.Leer_String("pr_10040105765.nombre"))
          me.ProveedorTieneAccesoWeb = _Datos.Leer_Boolean("pr_6004010574175")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_6004010574119")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_6004010574116")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_6004010574139")
          me.ReferenciaMedida = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040106059"), _Datos.Leer_String("pr_10040106059.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574113"), _Datos.Leer_String("pr_6004010574113.nombre"))
          me.Cantidad = _Datos.Leer_Decimal("pr_10040106056")
          me.ReferenciaProveedor = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574171"), _Datos.Leer_String("pr_6004010574171.nombre"))
          me.ReferenciaLote = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_100401060510"), _Datos.Leer_String("pr_100401060510.nombre"))
          me.Observaciones = _Datos.Leer_String("pr_6004010574178")
          me.ReferenciaCompraO1 = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_10040105766"), _Datos.Leer_String("pr_10040105766.nombre"))
          me.TextoTicket = _Datos.Leer_String("pr_6004010574177")
          me.CantidadMedidaBase = _Datos.Leer_Decimal("pr_10040106054")
          me.CantidadMedidaBasePorUnd = _Datos.Leer_Decimal("pr_10040106057")
          me.ReferenciaNumeracionSerie = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574174"), _Datos.Leer_String("pr_6004010574174.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_6004010574137")
          me.ReferenciaPuestoDeTrabajo = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574173"), _Datos.Leer_String("pr_6004010574173.nombre"))
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574114"), _Datos.Leer_String("pr_6004010574114.nombre"))
          me.ReferenciaTipoDeMovimiento = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574172"), _Datos.Leer_String("pr_6004010574172.nombre"))
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_6004010574122"), _Datos.Leer_String("pr_6004010574122.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_6004010574117")
          me.ReferenciaProductoCompradoOrigen = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_20040242022"), _Datos.Leer_String("pr_20040242022.nombre"))
          me.ReferenciaCompraOrigen = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_20040242021"), _Datos.Leer_String("pr_20040242021.nombre"))
         ...
         If Me.ReferenciaProducto IsNot nothing then
           R.add("pr_10040106053",me.ReferenciaProducto.ID.STR())
         Else
           R.add("pr_10040106053","")
         End if
         If Me.ReferenciaMedidaBase IsNot nothing then
           R.add("pr_10040106055",me.ReferenciaMedidaBase.ID.STR())
         Else
           R.add("pr_10040106055","")
         End if
         R.add("pr_10040106058", me.CantidadUnidades.AdaptarMySQL_Decimal())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_6004010574115",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_6004010574115","")
         End if
         R.add("pr_6004010574176", me.ReferenciaTicket.AdaptarMySQL_Integer())
         If Me.ReferenciaMovimientoInterno IsNot nothing then
           R.add("pr_6004010574169",me.ReferenciaMovimientoInterno.ID.STR())
         Else
           R.add("pr_6004010574169","")
         End if
         If Me.ReferenciaElementoDeCompraRectificativaO1 IsNot nothing then
           R.add("pr_10040105765",me.ReferenciaElementoDeCompraRectificativaO1.ID.STR())
         Else
           R.add("pr_10040105765","")
         End if
         R.add("pr_6004010574175", me.ProveedorTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_6004010574119", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_6004010574116", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_6004010574139", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaMedida IsNot nothing then
           R.add("pr_10040106059",me.ReferenciaMedida.ID.STR())
         Else
           R.add("pr_10040106059","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_6004010574113",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_6004010574113","")
         End if
         R.add("pr_10040106056", me.Cantidad.AdaptarMySQL_Decimal())
         If Me.ReferenciaProveedor IsNot nothing then
           R.add("pr_6004010574171",me.ReferenciaProveedor.ID.STR())
         Else
           R.add("pr_6004010574171","")
         End if
         If Me.ReferenciaLote IsNot nothing then
           R.add("pr_100401060510",me.ReferenciaLote.ID.STR())
         Else
           R.add("pr_100401060510","")
         End if
         R.add("pr_6004010574178", me.Observaciones.AdaptarMySQL_String())
         If Me.ReferenciaCompraO1 IsNot nothing then
           R.add("pr_10040105766",me.ReferenciaCompraO1.ID.STR())
         Else
           R.add("pr_10040105766","")
         End if
         R.add("pr_6004010574177", me.TextoTicket.AdaptarMySQL_String())
         R.add("pr_10040106054", me.CantidadMedidaBase.AdaptarMySQL_Decimal())
         R.add("pr_10040106057", me.CantidadMedidaBasePorUnd.AdaptarMySQL_Decimal())
         If Me.ReferenciaNumeracionSerie IsNot nothing then
           R.add("pr_6004010574174",me.ReferenciaNumeracionSerie.ID.STR())
         Else
           R.add("pr_6004010574174","")
         End if
         R.add("pr_6004010574137", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaPuestoDeTrabajo IsNot nothing then
           R.add("pr_6004010574173",me.ReferenciaPuestoDeTrabajo.ID.STR())
         Else
           R.add("pr_6004010574173","")
         End if
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_6004010574114",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_6004010574114","")
         End if
         If Me.ReferenciaTipoDeMovimiento IsNot nothing then
           R.add("pr_6004010574172",me.ReferenciaTipoDeMovimiento.ID.STR())
         Else
           R.add("pr_6004010574172","")
         End if
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_6004010574122",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_6004010574122","")
         End if
         R.add("pr_6004010574117", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaProductoCompradoOrigen IsNot nothing then
           R.add("pr_20040242022",me.ReferenciaProductoCompradoOrigen.ID.STR())
         Else
           R.add("pr_20040242022","")
         End if
         If Me.ReferenciaCompraOrigen IsNot nothing then
           R.add("pr_20040242021",me.ReferenciaCompraOrigen.ID.STR())
         Else
           R.add("pr_20040242021","")
         End if
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class SalidasDeCompras_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaProducto As Guid
            get
                return me.GetValue_Guid("pr_10040106053")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040106053", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMedidaBase As Guid
            get
                return me.GetValue_Guid("pr_10040106055")
            End Get   
        End Property
        Public ReadOnly property CantidadUnidades As Decimal
            get
                return me.GetValue_Decimal("pr_10040106058")
            End Get   
        End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_6004010574115")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574115", value)
            End Set
          End Property
          Public property ReferenciaTicket As Integer
            get
                return me.GetValue_Int("pr_6004010574176")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_6004010574176", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMovimientoInterno As Guid
            get
                return me.GetValue_Guid("pr_6004010574169")
            End Get   
        End Property
        Public ReadOnly property ReferenciaElementoDeCompraRectificativaO1 As Guid
            get
                return me.GetValue_Guid("pr_10040105765")
            End Get   
        End Property
          Public property ProveedorTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_6004010574175")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_6004010574175", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_6004010574119")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_6004010574119", value)
            End Set
          End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_6004010574116")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_6004010574116", value)
            End Set
          End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_6004010574139")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_6004010574139", value)
            End Set
          End Property
          Public property ReferenciaMedida As Guid
            get
                return me.GetValue_Guid("pr_10040106059")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040106059", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_6004010574113")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574113", value)
            End Set
          End Property
          Public property Cantidad As Decimal
            get
                return me.GetValue_Decimal("pr_10040106056")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_10040106056", value)
            End Set
          End Property
          Public property ReferenciaProveedor As Guid
            get
                return me.GetValue_Guid("pr_6004010574171")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574171", value)
            End Set
          End Property
          Public property ReferenciaLote As Guid
            get
                return me.GetValue_Guid("pr_100401060510")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401060510", value)
            End Set
          End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_6004010574178")
            End Get
            Set(value As String)
                me.SetValue_String("pr_6004010574178", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaCompraO1 As Guid
            get
                return me.GetValue_Guid("pr_10040105766")
            End Get   
        End Property
          Public property TextoTicket As String
            get
                return me.GetValue_String("pr_6004010574177")
            End Get
            Set(value As String)
                me.SetValue_String("pr_6004010574177", value)
            End Set
          End Property
        Public ReadOnly property CantidadMedidaBase As Decimal
            get
                return me.GetValue_Decimal("pr_10040106054")
            End Get   
        End Property
        Public ReadOnly property CantidadMedidaBasePorUnd As Decimal
            get
                return me.GetValue_Decimal("pr_10040106057")
            End Get   
        End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_6004010574174")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574174", value)
            End Set
          End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_6004010574137")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_6004010574137", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_6004010574173")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574173", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_6004010574114")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_6004010574114", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaTipoDeMovimiento As Guid
            get
                return me.GetValue_Guid("pr_6004010574172")
            End Get   
        End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_6004010574122")
            End Get   
        End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_6004010574117")
            End Get   
        End Property
        Public ReadOnly property ReferenciaProductoCompradoOrigen As Guid
            get
                return me.GetValue_Guid("pr_20040242022")
            End Get   
        End Property
        Public ReadOnly property ReferenciaCompraOrigen As Guid
            get
                return me.GetValue_Guid("pr_20040242021")
            End Get   
        End Property
