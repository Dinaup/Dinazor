...
Partial Public Class SeccionesD
  Public Class TiposDeComprasGastosD
      Public Shared _SeccionID As String = "8d2336ac-dc23-4843-b08f-02bd9caf5b5b"
      Public Shared _SeccionIDGUID As New Guid("8d2336ac-dc23-4843-b08f-02bd9caf5b5b")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TiposDeComprasGastosC )) 
          Dim R As New List(Of TiposDeComprasGastosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TiposDeComprasGastosES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TiposDeComprasGastosC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As TiposDeComprasGastosC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of TiposDeComprasGastosC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of TiposDeComprasGastosC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, TiposDeComprasGastosES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As TiposDeComprasGastos_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, TiposDeComprasGastosES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New TiposDeComprasGastos_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As TiposDeComprasGastos_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, TiposDeComprasGastosES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New TiposDeComprasGastos_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class TiposDeComprasGastosES
          Public shared _SeccionID as Guid = New Guid("8d2336ac-dc23-4843-b08f-02bd9caf5b5b")
      ...
      End Class
      Public Class TiposDeComprasGastosC
      Inherits Base_DatoC
          ...
          <DisplayName("Es un gasto sin factura")>
          Public Property EsUnMovimientoSinFactura As Boolean
          Public Shared ___EsUnMovimientoSinFactura As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""EsUnMovimientoSinFactura"",""etiqueta"": ""Es un gasto sin factura"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Es un gasto sin factura"",""descripcion"": """",""keyword"": ""EsUnMovimientoSinFactura"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""8d2336ac-dc23-4843-b08f-02bd9caf5b5b"",""titulo"": ""Tipos de Compras/Gastos"",""iconoid"": ""d720d25f-f5b8-4c83-a9f3-a8bf6cb31468"",""etiquetasingular"": ""Tipo de Compras/Gastos"",""etiquetaplural"": ""Tipos de Compras/Gastos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""8d2336ac-dc23-4843-b08f-02bd9caf5b5b"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class TiposDeComprasGastos_FormularioC
    ...
    End Sub
        ...
        End Property
          ...
          Public property RellenadoObligatorioDeCodigoDePaisEmisor As Boolean
            get
                return me.GetValue_Boolean("pr_50040241547")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040241547", value)
            End Set
          End Property
          Public property RellenadoObligatorioDeCodigoDeProvinciaEmisor As Boolean
            get
                return me.GetValue_Boolean("pr_50040241548")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040241548", value)
            End Set
          End Property
          Public property RellenadoObligatorioDeTipoDeNIFEmisor As Boolean
            get
                return me.GetValue_Boolean("pr_20040241606")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040241606", value)
            End Set
          End Property
          Public property RellenadoObligatorioDeClaveDeOperacionIntracomunitaria As Boolean
            get
