...
Partial Public Class SeccionesD
  Public Class ComprasRectificativasBaseD
      Public Class ComprasRectificativasBase_ConListaC
      Public Listador as ComprasRectificativasBaseC
      Public Lista As New List(of ComprasRectificativasBaseListaD.ComprasRectificativasBaseListaC)
        sub new(_listador  as ComprasRectificativasBaseC, _lista as List(of ComprasRectificativasBaseListaD.ComprasRectificativasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "fecd2787-c7cf-415d-8f69-32abd415f948"
      Public Shared _SeccionIDGUID As New Guid("fecd2787-c7cf-415d-8f69-32abd415f948")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ComprasRectificativasBaseC )) 
          Dim R As New List(Of ComprasRectificativasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ComprasRectificativasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New ComprasRectificativasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  ComprasRectificativasBase_ConListaC)) 
          Dim R As New List(Of ComprasRectificativasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ComprasRectificativasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of ComprasRectificativasBaseListaD.ComprasRectificativasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New ComprasRectificativasBaseListaD.ComprasRectificativasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New ComprasRectificativasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class ComprasRectificativasBaseES
          Public shared _SeccionID as Guid = New Guid("fecd2787-c7cf-415d-8f69-32abd415f948")
      ...
      Public Shared ExportarEnModulos$ = "pr_3004010555271"
      ...
      End Class
      Public Class ComprasRectificativasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""fecd2787-c7cf-415d-8f69-32abd415f948"",""titulo"": ""Base - Compras rectificativas"",""iconoid"": ""28ad3bf4-ea68-470a-90d5-949d6f88da18"",""etiquetasingular"": ""Compra rectificativa"",""etiquetaplural"": ""Compras rectificativas"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""fecd2787-c7cf-415d-8f69-32abd415f948"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
