...
Partial Public Class SeccionesD
  Public Class SalidasDeComprasBaseD
      Public Class SalidasDeComprasBase_ConListaC
      Public Listador as SalidasDeComprasBaseC
      Public Lista As New List(of SalidasDeComprasBaseListaD.SalidasDeComprasBaseListaC)
        sub new(_listador  as SalidasDeComprasBaseC, _lista as List(of SalidasDeComprasBaseListaD.SalidasDeComprasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "74b5c154-eccf-4806-9347-7935fa6ecbcf"
      Public Shared _SeccionIDGUID As New Guid("74b5c154-eccf-4806-9347-7935fa6ecbcf")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SalidasDeComprasBaseC )) 
          Dim R As New List(Of SalidasDeComprasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeComprasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SalidasDeComprasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  SalidasDeComprasBase_ConListaC)) 
          Dim R As New List(Of SalidasDeComprasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeComprasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of SalidasDeComprasBaseListaD.SalidasDeComprasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New SalidasDeComprasBaseListaD.SalidasDeComprasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New SalidasDeComprasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class SalidasDeComprasBaseES
          Public shared _SeccionID as Guid = New Guid("74b5c154-eccf-4806-9347-7935fa6ecbcf")
      ...
      Public Shared ExportarEnModulos$ = "pr_6004010574118"
      ...
      End Class
      Public Class SalidasDeComprasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""74b5c154-eccf-4806-9347-7935fa6ecbcf"",""titulo"": ""Base - Salidas de Compras"",""iconoid"": ""fcc4c1a5-24a3-4221-adcc-0d27247804b9"",""etiquetasingular"": ""Movimiento de producto"",""etiquetaplural"": ""Movimientos de producto"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""74b5c154-eccf-4806-9347-7935fa6ecbcf"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
