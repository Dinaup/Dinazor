...
Partial Public Class SeccionesD
  Public Class CobrosDeRectificacionesComprasBaseD
      Public Class CobrosDeRectificacionesComprasBase_ConListaC
      Public Listador as CobrosDeRectificacionesComprasBaseC
      Public Lista As New List(of CobrosDeRectificacionesComprasBaseListaD.CobrosDeRectificacionesComprasBaseListaC)
        sub new(_listador  as CobrosDeRectificacionesComprasBaseC, _lista as List(of CobrosDeRectificacionesComprasBaseListaD.CobrosDeRectificacionesComprasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "50c148c6-9a6f-4af9-ba61-790278d1d7c8"
      Public Shared _SeccionIDGUID As New Guid("50c148c6-9a6f-4af9-ba61-790278d1d7c8")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CobrosDeRectificacionesComprasBaseC )) 
          Dim R As New List(Of CobrosDeRectificacionesComprasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CobrosDeRectificacionesComprasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CobrosDeRectificacionesComprasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  CobrosDeRectificacionesComprasBase_ConListaC)) 
          Dim R As New List(Of CobrosDeRectificacionesComprasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CobrosDeRectificacionesComprasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of CobrosDeRectificacionesComprasBaseListaD.CobrosDeRectificacionesComprasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New CobrosDeRectificacionesComprasBaseListaD.CobrosDeRectificacionesComprasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New CobrosDeRectificacionesComprasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class CobrosDeRectificacionesComprasBaseES
          Public shared _SeccionID as Guid = New Guid("50c148c6-9a6f-4af9-ba61-790278d1d7c8")
      ...
      Public Shared ExportarEnModulos$ = "pr_100401058710"
      ...
      End Class
      Public Class CobrosDeRectificacionesComprasBaseC
      Inherits Base_DatoC
          ...
          <DisplayName("Todo tramitado y validado")>
          Public Property TodoTramitadoYValidado As Boolean
          Public Shared ___TodoTramitadoYValidado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""TodoTramitadoYValidado"",""etiqueta"": ""Todo tramitado y validado"",""oculta"": false,""formato"": 1,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Todo tramitado y validado"",""descripcion"": """",""keyword"": ""TodoTramitadoYValidado"",""formato"": 1,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""50c148c6-9a6f-4af9-ba61-790278d1d7c8"",""titulo"": ""Base - Cobros de rectificaciones Compras"",""iconoid"": ""846a49dd-bfd1-4f27-a4c0-667d5b041985"",""etiquetasingular"": ""Cobro de rectificación Compra"",""etiquetaplural"": ""Cobros de compras rectificativas"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""50c148c6-9a6f-4af9-ba61-790278d1d7c8"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
