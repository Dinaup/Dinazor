...
Partial Public Class SeccionesD
  Public Class FacturasRectificativasBaseD
      Public Class FacturasRectificativasBase_ConListaC
      Public Listador as FacturasRectificativasBaseC
      Public Lista As New List(of FacturasRectificativasBaseListaD.FacturasRectificativasBaseListaC)
        sub new(_listador  as FacturasRectificativasBaseC, _lista as List(of FacturasRectificativasBaseListaD.FacturasRectificativasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "7ff21a3d-4488-4eef-a287-700511665416"
      Public Shared _SeccionIDGUID As New Guid("7ff21a3d-4488-4eef-a287-700511665416")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of FacturasRectificativasBaseC )) 
          Dim R As New List(Of FacturasRectificativasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FacturasRectificativasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New FacturasRectificativasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  FacturasRectificativasBase_ConListaC)) 
          Dim R As New List(Of FacturasRectificativasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FacturasRectificativasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of FacturasRectificativasBaseListaD.FacturasRectificativasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New FacturasRectificativasBaseListaD.FacturasRectificativasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New FacturasRectificativasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class FacturasRectificativasBaseES
          Public shared _SeccionID as Guid = New Guid("7ff21a3d-4488-4eef-a287-700511665416")
      ...
      Public Shared ExportarEnModulos$ = "pr_3004010555288"
      ...
      End Class
      Public Class FacturasRectificativasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""7ff21a3d-4488-4eef-a287-700511665416"",""titulo"": ""Base - Facturas rectificativas"",""iconoid"": ""6ba30049-bf25-4a50-8d19-f004456611e5"",""etiquetasingular"": ""Factura rectificativa"",""etiquetaplural"": ""Facturas rectificativas"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""7ff21a3d-4488-4eef-a287-700511665416"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
