...
Partial Public Class SeccionesD
  Public Class MovimientoInternoDeSaldoAcumuladoDeVentaD
      Public Shared _SeccionID As String = "97da60ce-25cd-4fee-8ee4-f555ba039502"
      Public Shared _SeccionIDGUID As New Guid("97da60ce-25cd-4fee-8ee4-f555ba039502")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MovimientoInternoDeSaldoAcumuladoDeVentaC )) 
          Dim R As New List(Of MovimientoInternoDeSaldoAcumuladoDeVentaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MovimientoInternoDeSaldoAcumuladoDeVentaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New MovimientoInternoDeSaldoAcumuladoDeVentaC 
          ...
          Return R 
      End Function 
      Public Class MovimientoInternoDeSaldoAcumuladoDeVentaES
          Public shared _SeccionID as Guid = New Guid("97da60ce-25cd-4fee-8ee4-f555ba039502")
      ...
      End Class
      Public Class MovimientoInternoDeSaldoAcumuladoDeVentaC
      Inherits Base_DatoC
          ...
          <DisplayName("Cantidad de saldo acumulado")>
          Public Property ImporteCantidadDeSaldoAcumulado As Decimal
          Public Shared ___ImporteCantidadDeSaldoAcumulado As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ImporteCantidadDeSaldoAcumulado"",""etiqueta"": ""Cantidad de saldo acumulado"",""oculta"": false,""formato"": 3,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 5,""decimales"": ""2"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Cantidad de saldo acumulado"",""descripcion"": """",""keyword"": ""ImporteCantidadDeSaldoAcumulado"",""formato"": 3,""rol"": 5,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ImporteCantidadDeSaldoAcumulado As DinaNETCore.APID.DinaupAPI_CampoC = ___ImporteCantidadDeSaldoAcumulado
          ...
          <DisplayName("Sección registro de origen")>
          Public Property ReferenciaSeccionRegistroDeOrigen As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaSeccionRegistroDeOrigen As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaSeccionRegistroDeOrigen"",""etiqueta"": ""Sección registro de origen"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": ""plantillasp"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Sección registro de origen"",""descripcion"": """",""keyword"": ""ReferenciaSeccionRegistroDeOrigen"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaSeccionRegistroDeOrigen As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaSeccionRegistroDeOrigen
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""97da60ce-25cd-4fee-8ee4-f555ba039502"",""titulo"": ""Movimiento interno de saldo acumulado de venta"",""iconoid"": ""fc4e6fd7-d82c-42e3-b0d9-35cfefd324aa"",""etiquetasingular"": ""Movimiento interno de saldo acumulado de venta"",""etiquetaplural"": ""Movimientos internos de saldo acumulado de venta"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""97da60ce-25cd-4fee-8ee4-f555ba039502"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1723d33b13x2bcwd"), _Datos.Leer_String("pr_1723d33b13x2bcwd.nombre"))
          me.ImporteCantidadDeSaldoAcumulado = _Datos.Leer_Decimal("pr_1724228b3dx1c2wd")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_191d9b55d4x6awd")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_172431ef36x34fwd")
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_1723d33b53x106wd")
          me.EntidadTieneAccesoWeb = _Datos.Leer_Boolean("pr_17245df809x2afwd")
          me.ReferenciaEntidad = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_17245d506fx2a0wd"), _Datos.Leer_String("pr_17245d506fx2a0wd.nombre"))
          me.ReferenciaRegistroDeOrigen = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_60040107041"), _Datos.Leer_String("pr_60040107041.nombre"))
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_191d8f4a2cx363wd"), _Datos.Leer_String("pr_191d8f4a2cx363wd.nombre"))
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_776ae2ewd")
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_1723d33bd8x6bwd"), _Datos.Leer_String("pr_1723d33bd8x6bwd.nombre"))
          me.ReferenciaUbicacionPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_191d8f4a7ex20cwd"), _Datos.Leer_String("pr_191d8f4a7ex20cwd.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_1723d43839x109wd")
          me.ReferenciaSeccionRegistroDeOrigen = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_60040107042"), _Datos.Leer_String("pr_60040107042.nombre"))
         ...
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_1723d33b13x2bcwd",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_1723d33b13x2bcwd","")
         End if
         R.add("pr_1724228b3dx1c2wd", me.ImporteCantidadDeSaldoAcumulado.AdaptarMySQL_Decimal())
         R.add("pr_191d9b55d4x6awd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_172431ef36x34fwd", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_1723d33b53x106wd", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_17245df809x2afwd", me.EntidadTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaEntidad IsNot nothing then
           R.add("pr_17245d506fx2a0wd",me.ReferenciaEntidad.ID.STR())
         Else
           R.add("pr_17245d506fx2a0wd","")
         End if
         If Me.ReferenciaRegistroDeOrigen IsNot nothing then
           R.add("pr_60040107041",me.ReferenciaRegistroDeOrigen.ID.STR())
         Else
           R.add("pr_60040107041","")
         End if
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_191d8f4a2cx363wd",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_191d8f4a2cx363wd","")
         End if
         R.add("pr_776ae2ewd", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_1723d33bd8x6bwd",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_1723d33bd8x6bwd","")
         End if
         If Me.ReferenciaUbicacionPrincipal IsNot nothing then
           R.add("pr_191d8f4a7ex20cwd",me.ReferenciaUbicacionPrincipal.ID.STR())
         Else
           R.add("pr_191d8f4a7ex20cwd","")
         End if
         R.add("pr_1723d43839x109wd", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         If Me.ReferenciaSeccionRegistroDeOrigen IsNot nothing then
           R.add("pr_60040107042",me.ReferenciaSeccionRegistroDeOrigen.ID.STR())
         Else
           R.add("pr_60040107042","")
         End if
