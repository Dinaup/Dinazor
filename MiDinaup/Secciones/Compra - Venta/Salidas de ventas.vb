...
Partial Public Class SeccionesD
  Public Class SalidasDeVentasD
      Public Shared _SeccionID As String = "2c7d5f11-1b45-4f3a-85fa-7aefa0699cfa"
      Public Shared _SeccionIDGUID As New Guid("2c7d5f11-1b45-4f3a-85fa-7aefa0699cfa")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SalidasDeVentasC )) 
          Dim R As New List(Of SalidasDeVentasC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SalidasDeVentasES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SalidasDeVentasC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As SalidasDeVentasC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of SalidasDeVentasC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of SalidasDeVentasC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, SalidasDeVentasES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As SalidasDeVentas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeVentasES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeVentas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As SalidasDeVentas_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, SalidasDeVentasES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New SalidasDeVentas_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class SalidasDeVentasES
          Public shared _SeccionID as Guid = New Guid("2c7d5f11-1b45-4f3a-85fa-7aefa0699cfa")
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""2c7d5f11-1b45-4f3a-85fa-7aefa0699cfa"",""titulo"": ""Salidas de ventas"",""iconoid"": ""fcc4c1a5-24a3-4221-adcc-0d27247804b9"",""etiquetasingular"": ""Salida de venta"",""etiquetaplural"": ""Salidas de venta"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""2c7d5f11-1b45-4f3a-85fa-7aefa0699cfa"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class SalidasDeVentas_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property ReferenciaLote As Guid
            get
                return me.GetValue_Guid("pr_100401060517")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401060517", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_400401057413")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057413", value)
            End Set
          End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_400401057430")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057430", value)
            End Set
          End Property
          Public property ReferenciaMedida As Guid
            get
                return me.GetValue_Guid("pr_100401060513")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401060513", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMedidaBase As Guid
            get
                return me.GetValue_Guid("pr_100401060512")
            End Get   
        End Property
          Public property ClienteTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_400401057436")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_400401057436", value)
            End Set
          End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_400401057414")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_400401057414", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_400401057417")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_400401057417", value)
            End Set
          End Property
          Public property ReferenciaProducto As Guid
            get
                return me.GetValue_Guid("pr_100401060511")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401060511", value)
            End Set
          End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_400401057429")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_400401057429", value)
            End Set
          End Property
          Public property Cantidad As Decimal
            get
                return me.GetValue_Decimal("pr_100401060514")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401060514", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_400401057434")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057434", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_400401057411")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057411", value)
            End Set
          End Property
        Public ReadOnly property CantidadMedidaBase As Decimal
            get
                return me.GetValue_Decimal("pr_100401060516")
            End Get   
        End Property
        Public ReadOnly property ReferenciaTipoDeMovimiento As Guid
            get
                return me.GetValue_Guid("pr_400401057433")
            End Get   
        End Property
          Public property CantidadUnidades As Decimal
            get
                return me.GetValue_Decimal("pr_100401057612")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401057612", value)
            End Set
          End Property
          Public property ReferenciaCliente As Guid
            get
                return me.GetValue_Guid("pr_400401057432")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057432", value)
            End Set
          End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_400401057438")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401057438", value)
            End Set
          End Property
          Public property TextoTicket As String
            get
                return me.GetValue_String("pr_400401057439")
            End Get
            Set(value As String)
                me.SetValue_String("pr_400401057439", value)
            End Set
          End Property
          Public property ReferenciaTicket As Integer
            get
                return me.GetValue_Int("pr_400401057437")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_400401057437", value)
            End Set
          End Property
        Public ReadOnly property CantidadMedidaBasePorUnd As Decimal
            get
                return me.GetValue_Decimal("pr_100401060515")
            End Get   
        End Property
        Public ReadOnly property ReferenciaElementoDeVenta As Guid
            get
                return me.GetValue_Guid("pr_100401057610")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_400401057426")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_400401057426", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_400401057412")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_400401057412", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_400401057415")
            End Get   
        End Property
        Public ReadOnly property ReferenciaMovimientoInterno As Guid
            get
                return me.GetValue_Guid("pr_400401057435")
            End Get   
        End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_400401057420")
            End Get   
        End Property
        Public ReadOnly property ReferenciaVenta As Guid
            get
                return me.GetValue_Guid("pr_10040105769")
            End Get   
        End Property
