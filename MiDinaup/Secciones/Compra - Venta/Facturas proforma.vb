...
Partial Public Class SeccionesD
  Public Class FacturasProformaD
      Public Class FacturasProforma_ConListaC
      Public Listador as FacturasProformaC
      Public Lista As New List(of FacturasProformaListaD.FacturasProformaListaC)
        sub new(_listador  as FacturasProformaC, _lista as List(of FacturasProformaListaD.FacturasProformaListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "ea144ec7-af10-466d-8370-76c5b9126f90"
      Public Shared _SeccionIDGUID As New Guid("ea144ec7-af10-466d-8370-76c5b9126f90")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of FacturasProformaC )) 
          Dim R As New List(Of FacturasProformaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FacturasProformaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New FacturasProformaC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  FacturasProforma_ConListaC)) 
          Dim R As New List(Of FacturasProforma_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(FacturasProformaES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of FacturasProformaListaD.FacturasProformaListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New FacturasProformaListaD.FacturasProformaListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New FacturasProforma_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As FacturasProformaC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of FacturasProformaC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of FacturasProformaC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, FacturasProformaES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As FacturasProforma_ConListaC, Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of FacturasProforma_ConListaC)({DAtos}), CampoWhere, CampoWhereLista)
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of FacturasProforma_ConListaC), Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Dim Importar As New List(Of DinaupAPI_ImportacionProcesableC)
          For Each Actual In DAtos 
              Dim RegistroActual = New DinaupAPI_ImportacionProcesableC() 
               ...
               Importar.Add(RegistroActual)  
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, FacturasProformaES._SeccionID, Importar, CampoWhere, CampoWhereLista) 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As FacturasProforma_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, FacturasProformaES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New FacturasProforma_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As FacturasProforma_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, FacturasProformaES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New FacturasProforma_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class FacturasProformaES
          Public shared _SeccionID as Guid = New Guid("ea144ec7-af10-466d-8370-76c5b9126f90")
      ...
      End Class
      Public Class FacturasProformaC
      Inherits Base_DatoC
          ...
          Public Shared ___ValidoHasta As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ValidoHasta"",""etiqueta"": ""Fecha de vencimiento"",""oculta"": false,""formato"": 7,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Fecha de vencimiento"",""descripcion"": """",""keyword"": ""ValidoHasta"",""formato"": 7,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": true},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""ea144ec7-af10-466d-8370-76c5b9126f90"",""titulo"": ""Facturas proforma"",""iconoid"": ""39d08324-2d04-4df7-bcc2-6945bc006a74"",""etiquetasingular"": ""Factura proforma"",""etiquetaplural"": ""Facturas proforma"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""ea144ec7-af10-466d-8370-76c5b9126f90"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class FacturasProforma_FormularioC
        Inherits DinaNETCore.VentanaVirtualC

    Public _Lista As List(Of FacturasProformaListaD.FacturasProformaLista_FormularioC)
    ...
    Overrides Sub Evento_Actualizar()
        ...
        If Me.EsListador Then
            ...
            Dim CreandoLista As New List(Of FacturasProformaListaD.FacturasProformaLista_FormularioC)
            If FormLista IsNot Nothing Then
                For i = 0 To FormLista.Count - 1
                    Dim ElementoLista As New FacturasProformaListaD.FacturasProformaLista_FormularioC(Me.__VV__, FormLista(i).Token)
    ...
    End Sub
        ...
        Public ReadOnly property ImporteDescuentosGeneralImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058065")
            End Get   
        End Property
          Public property CIFNIFCliente As String
            get
                return me.GetValue_String("pr_10040107983")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040107983", value)
            End Set
          End Property
          Public property DireccionCliente As String
            get
                return me.GetValue_String("pr_100401079920")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401079920", value)
            End Set
          End Property
          Public property ReferenciaNumeracionSerie As Guid
            get
                return me.GetValue_Guid("pr_100401058013")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401058013", value)
            End Set
          End Property
          Public property ProvinciaEmpresa As String
            get
                return me.GetValue_String("pr_60040107982")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107982", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_100401058012")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401058012", value)
            End Set
          End Property
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555319")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555319", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaImporteDeProductosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058064")
            End Get   
        End Property
          Public property CodigoPostalCliente As String
            get
                return me.GetValue_String("pr_10040107984")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040107984", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_3004010555322")
            End Get   
        End Property
        Public ReadOnly property ImportePresupuestoDeVentaTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_50040115729")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058068")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058067")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058069")
            End Get   
        End Property
          Public property ProvinciaCliente As String
            get
                return me.GetValue_String("pr_10040107986")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040107986", value)
            End Set
          End Property
        Public ReadOnly property ImporteSubtotal As Decimal
            get
                return me.GetValue_Decimal("pr_100401058066")
            End Get   
        End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_3004010555327")
            End Get   
        End Property
          Public property MunicipioCliente As String
            get
                return me.GetValue_String("pr_50040108212")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040108212", value)
            End Set
          End Property
          Public property ImporteSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_100401058060")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058060", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosProductoExento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058061")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058059")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555333")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555333", value)
            End Set
          End Property
        Public ReadOnly property SaldoPromocionalGeneradoAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058063")
            End Get   
        End Property
        Public ReadOnly property ReferenciaResumenImpuesto2 As Guid
            get
                return me.GetValue_Guid("pr_100401058011")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleExenta As Decimal
            get
                return me.GetValue_Decimal("pr_100401058062")
            End Get   
        End Property
          Public property ReferenciaEstado As Guid
            get
                return me.GetValue_Guid("pr_100401058010")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401058010", value)
            End Set
          End Property
        Public ReadOnly property ImportePresupuestoDeVentaImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_50040115727")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058053")
            End Get   
        End Property
          Public property UsoDeSaldoPersonalizado As Boolean
            get
                return me.GetValue_Boolean("pr_20040115732")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040115732", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaREImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058052")
            End Get   
        End Property
        Public ReadOnly property SumaConceptosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_60040115044")
            End Get   
        End Property
          Public property ReferenciaTipoDeMovimiento As Guid
            get
                return me.GetValue_Guid("pr_10040105809")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040105809", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaConceptosSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058056")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoExento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058058")
            End Get   
        End Property
        Public ReadOnly property CantidadDeProductos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058057")
            End Get   
        End Property
          Public property Notas As String
            get
                return me.GetValue_String("pr_100401079833")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401079833", value)
            End Set
          End Property
          Public property MunicipioEmpresa As String
            get
                return me.GetValue_String("pr_10040108561")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040108561", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058054")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058055")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuestoExentos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058042")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaREImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058041")
            End Get   
        End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_3004010555318")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555318", value)
            End Set
          End Property
        Public ReadOnly property DescuentoVIPAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058045")
            End Get   
        End Property
        Public ReadOnly property DescuentoAdicionalBAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058046")
            End Get   
        End Property
          Public property DescuentoGeneralDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058043")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058043", value)
            End Set
          End Property
        Public ReadOnly property ImporteDescuentoGeneralImpuestoExento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058044")
            End Get   
        End Property
        Public ReadOnly property DescuentoGeneralAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058050")
            End Get   
        End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058051")
            End Get   
        End Property
          Public property ReferenciaConfiguracionDeVenta As Guid
            get
                return me.GetValue_Guid("pr_10040105808")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040105808", value)
            End Set
          End Property
          Public property ImpuestosIncluidos As Boolean
            get
                return me.GetValue_Boolean("pr_100401058076")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_100401058076", value)
            End Set
          End Property
          Public property ClienteTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_100401058014")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_100401058014", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalDescontadoSinImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058048")
            End Get   
        End Property
        Public ReadOnly property ImporteCuotaImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058049")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalSinPagoConSaldo As Decimal
            get
                return me.GetValue_Decimal("pr_20040115008")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058047")
            End Get   
        End Property
        Public ReadOnly property ReferenciaPresupuestoDeVenta As Guid
            get
                return me.GetValue_Guid("pr_1004010580562")
            End Get   
        End Property
        Public ReadOnly property ImporteSumaDeConceptosImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058037")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555324")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555324", value)
            End Set
          End Property
          Public property ReferenciaCliente As Guid
            get
                return me.GetValue_Guid("pr_10040105805")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040105805", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaResumenImpuesto1 As Guid
            get
                return me.GetValue_Guid("pr_10040105806")
            End Get   
        End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_3004010555321")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_3004010555321", value)
            End Set
          End Property
          Public property ReferenciaRetencion As Guid
            get
                return me.GetValue_Guid("pr_10040105804")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040105804", value)
            End Set
          End Property
          Public property DescuentoTipoDeEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058035")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058035", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058036")
            End Get   
        End Property
          Public property IdentificacionEmpresa As String
            get
                return me.GetValue_String("pr_60040107985")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107985", value)
            End Set
          End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_3004010555335")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_3004010555335", value)
            End Set
          End Property
          Public property CIFNIFEmpresa As String
            get
                return me.GetValue_String("pr_60040107986")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107986", value)
            End Set
          End Property
          Public property DescuentoAdicionalBDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058040")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058040", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaResumenImpuesto3 As Guid
            get
                return me.GetValue_Guid("pr_10040105807")
            End Get   
        End Property
        Public ReadOnly property ImportePresupuestoDeVentaSaldoPromocionalUtilizado As Decimal
            get
                return me.GetValue_Decimal("pr_50040115728")
            End Get   
        End Property
        Public ReadOnly property DescuentoEntidadAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058039")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosProductoImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058038")
            End Get   
        End Property
        Public ReadOnly property ImportePresupuestoDeVentaRatioDeProrrateo As Decimal
            get
                return me.GetValue_Decimal("pr_500401157210")
            End Get   
        End Property
          Public property PaisEmpresa As String
            get
                return me.GetValue_String("pr_60040107983")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107983", value)
            End Set
          End Property
          Public property FechaFactura As Date
            get
                return me.GetValue_Date("pr_50040107971")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_50040107971", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058028")
            End Get   
        End Property
        Public ReadOnly property TotalPorcentajeDescuentosGeneralesPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058029")
            End Get   
        End Property
          Public property TelefonoEmpresa As String
            get
                return me.GetValue_String("pr_50040108121")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040108121", value)
            End Set
          End Property
          Public property DescuentoVIPDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058030")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058030", value)
            End Set
          End Property
          Public property SaldoPromocionalGeneradoDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058032")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058032", value)
            End Set
          End Property
          Public property NFactura As String
            get
                return me.GetValue_String("pr_100401058073")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401058073", value)
            End Set
          End Property
          Public property CodigoPostalEmpresa As String
            get
                return me.GetValue_String("pr_60040107981")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107981", value)
            End Set
          End Property
        Public ReadOnly property ImporteCuotaImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058034")
            End Get   
        End Property
          Public property DescuentoEntidadDeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058033")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058033", value)
            End Set
          End Property
        Public ReadOnly property ImporteSumaImporteProductosConImpuestos As Decimal
            get
                return me.GetValue_Decimal("pr_100401058031")
            End Get   
        End Property
          Public property DescripcionDescuentoAdicionalA As String
            get
                return me.GetValue_String("pr_100401058072")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401058072", value)
            End Set
          End Property
        Public ReadOnly property DescuentoTipoEntidadPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058022")
            End Get   
        End Property
          Public property DireccionEmpresa As String
            get
                return me.GetValue_String("pr_60040107984")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040107984", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_3004010555320")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_3004010555320", value)
            End Set
          End Property
          Public property NFacturaNumerico As Integer
            get
                return me.GetValue_Int("pr_100401058074")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_100401058074", value)
            End Set
          End Property
        Public ReadOnly property ImporteBaseImponibleImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058027")
            End Get   
        End Property
        Public ReadOnly property DescuentoAdicionalAAplicadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058023")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto2 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058024")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentoSaldoImpuesto3 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058026")
            End Get   
        End Property
          Public property DescuentoAdicionalADeseadoPorciento As Decimal
            get
                return me.GetValue_Decimal("pr_100401058025")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058025", value)
            End Set
          End Property
          Public property Terminos As String
            get
                return me.GetValue_String("pr_100401079832")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401079832", value)
            End Set
          End Property
          Public property DescripcionDescuentoAdicionalB As String
            get
                return me.GetValue_String("pr_100401058070")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401058070", value)
            End Set
          End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_100401058071")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401058071", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotal As Decimal
            get
                return me.GetValue_Decimal("pr_100401058017")
            End Get   
        End Property
        Public ReadOnly property ImporteSaldoObtenidoEntidad As Decimal
            get
                return me.GetValue_Decimal("pr_100401058016")
            End Get   
        End Property
          Public property ReferenciaTipoDeCliente As Guid
            get
                return me.GetValue_Guid("pr_10040105803")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040105803", value)
            End Set
          End Property
          Public property IdentificacionCliente As String
            get
                return me.GetValue_String("pr_10040107981")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040107981", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteRetencion As Decimal
            get
                return me.GetValue_Decimal("pr_100401058015")
            End Get   
        End Property
          Public property PaisCliente As String
            get
                return me.GetValue_String("pr_10040107985")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040107985", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalDescuentosNoAplicados As Decimal
            get
                return me.GetValue_Decimal("pr_100401058019")
            End Get   
        End Property
        Public ReadOnly property ImporteDescuentosGeneralImpuesto1 As Decimal
            get
                return me.GetValue_Decimal("pr_100401058020")
            End Get   
        End Property
          Public property ImporteSaldoQueTeniaElClienteAntesDeLaVenta As Decimal
            get
                return me.GetValue_Decimal("pr_100401058021")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_100401058021", value)
            End Set
          End Property
          Public property AplicarRecargoDeEquivalencia As Boolean
            get
                return me.GetValue_Boolean("pr_100401058075")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_100401058075", value)
            End Set
          End Property
          Public property ValidoHasta As Date
            get
                return me.GetValue_Date("pr_100401079831")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_100401079831", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesCliente As Guid
            get
                return me.GetValue_Guid("pr_10040138803")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040138803", value)
            End Set
          End Property
          Public property ReferenciaDatosFiscalesEmpresa As Guid
            get
                return me.GetValue_Guid("pr_10040138802")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040138802", value)
            End Set
          End Property
          Public property TelefonoCliente As String
            get
                return me.GetValue_String("pr_10040138801")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040138801", value)
            End Set
          End Property
          Public property ReferenciaImpuestoGeneral As Guid
            get
                return me.GetValue_Guid("pr_600401489612")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_600401489612", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteImpuestoGeneral As Decimal
            get
                return me.GetValue_Decimal("pr_500401489611")
            End Get   
        End Property
          Public property CondicionesDePago As String
            get
                return me.GetValue_String("pr_50040172141")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040172141", value)
            End Set
          End Property
          Public property CondicionDePagoDias As Integer
            get
                return me.GetValue_Int("pr_40040176512")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_40040176512", value)
            End Set
          End Property
