...
Partial Public Class SeccionesD
  Public Class PresentacionDeModelosFiscalesD
      Public Shared _SeccionID As String = "c14b249c-051f-4a86-9a08-9fc0c98d483f"
      Public Shared _SeccionIDGUID As New Guid("c14b249c-051f-4a86-9a08-9fc0c98d483f")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PresentacionDeModelosFiscalesC )) 
          Dim R As New List(Of PresentacionDeModelosFiscalesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresentacionDeModelosFiscalesES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PresentacionDeModelosFiscalesC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As PresentacionDeModelosFiscalesC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of PresentacionDeModelosFiscalesC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of PresentacionDeModelosFiscalesC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, PresentacionDeModelosFiscalesES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As PresentacionDeModelosFiscales_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, PresentacionDeModelosFiscalesES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New PresentacionDeModelosFiscales_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As PresentacionDeModelosFiscales_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, PresentacionDeModelosFiscalesES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New PresentacionDeModelosFiscales_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class PresentacionDeModelosFiscalesES
          Public shared _SeccionID as Guid = New Guid("c14b249c-051f-4a86-9a08-9fc0c98d483f")
      ...
      End Class
      Public Class PresentacionDeModelosFiscalesC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""c14b249c-051f-4a86-9a08-9fc0c98d483f"",""titulo"": ""Presentación de modelos fiscales"",""iconoid"": ""448b4ef1-8c14-4cd7-9fa9-6baacf071bb5"",""etiquetasingular"": ""Presentación de modelo fiscal"",""etiquetaplural"": ""Presentaciones de modelos fiscales"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""c14b249c-051f-4a86-9a08-9fc0c98d483f"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class PresentacionDeModelosFiscales_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_50040188951012")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_50040188951011")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_50040188951011", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_50040188951007")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040188951007", value)
            End Set
          End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_50040188951008")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_50040188951008", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_50040188951009")
            End Get   
        End Property
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_50040188951024")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040188951024", value)
            End Set
          End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_50040188951023")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040188951023", value)
            End Set
          End Property
          Public property ReferenciaModelo As Guid
            get
                return me.GetValue_Guid("pr_10040188961")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040188961", value)
            End Set
          End Property
          Public property ReferenciaEstado As Guid
            get
                return me.GetValue_Guid("pr_200401889626")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_200401889626", value)
            End Set
          End Property
          Public property ReferenciaDocumento As Guid
            get
                return me.GetValue_Guid("pr_10040188962")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040188962", value)
            End Set
          End Property
          Public property FechaDePresentacion As Date
            get
                return me.GetValue_Date("pr_10040188972")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_10040188972", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_50040188951005")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040188951005", value)
            End Set
          End Property
          Public property ReferenciaPlazosDePresentacion As Guid
            get
                return me.GetValue_Guid("pr_60040189441")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040189441", value)
            End Set
          End Property
          Public property EstadoDeTramitacion__Int as Integer
            get
                return me.GetValue_Int("pr_300401895331")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_300401895331", value)
            End Set
          End Property
          Public property EstadoDeTramitacion As EnumEstadoDeTramiteE
            get
            ...
            End Set
          End Property
          Public property ReferenciaPlazo As Guid
            get
                return me.GetValue_Guid("pr_100401896832")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401896832", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaEjercicio As Guid
            get
                return me.GetValue_Guid("pr_20040237043")
            End Get   
        End Property
        Public ReadOnly property Periodo As EnumIntervaloContableE
            get
                return me.GetValue_Int("pr_40040237044")
            End Get   
        End Property
        Public ReadOnly property Borrador As Boolean
            get
                return me.GetValue_Boolean("pr_30040237051")
            End Get   
        End Property
          Public property ReferenciaDocumentoPrediseñado As Guid
            get
                return me.GetValue_Guid("pr_40040237712")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040237712", value)
            End Set
          End Property
