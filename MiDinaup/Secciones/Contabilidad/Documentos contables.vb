...
Partial Public Class SeccionesD
  Public Class DocumentosContablesD
      Public Shared _SeccionID As String = "50a0d463-f35e-41f4-b56c-a8d3b78373f4"
      Public Shared _SeccionIDGUID As New Guid("50a0d463-f35e-41f4-b56c-a8d3b78373f4")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of DocumentosContablesC )) 
          Dim R As New List(Of DocumentosContablesC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DocumentosContablesES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New DocumentosContablesC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As DocumentosContablesC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of DocumentosContablesC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of DocumentosContablesC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, DocumentosContablesES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As DocumentosContables_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, DocumentosContablesES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New DocumentosContables_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As DocumentosContables_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, DocumentosContablesES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New DocumentosContables_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class DocumentosContablesES
          Public shared _SeccionID as Guid = New Guid("50a0d463-f35e-41f4-b56c-a8d3b78373f4")
      ...
      End Class
      Public Class DocumentosContablesC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""50a0d463-f35e-41f4-b56c-a8d3b78373f4"",""titulo"": ""Documentos contables"",""iconoid"": ""8f620c73-227a-48dd-98d0-479c2e4438e2"",""etiquetasingular"": ""Documento contable"",""etiquetaplural"": ""Documentos contables"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""50a0d463-f35e-41f4-b56c-a8d3b78373f4"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class DocumentosContables_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_600401403013")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_600401403012")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_600401403012", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_600401403010")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_600401403024")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_600401403024", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_60040140308")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040140308", value)
            End Set
          End Property
        Public ReadOnly property IdentificadorDeConfiguracionSha1Obsoleto As String
            get
                return me.GetValue_String("pr_30040142381")
            End Get   
        End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_30040142384")
            End Get
            Set(value As String)
                me.SetValue_String("pr_30040142384", value)
            End Set
          End Property
          Public property ConfiguracionObsoleto As String
            get
                return me.GetValue_String("pr_30040142386")
            End Get
            Set(value As String)
                me.SetValue_String("pr_30040142386", value)
            End Set
          End Property
          Public property DescripcionCorta As String
            get
                return me.GetValue_String("pr_10040158004")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040158004", value)
            End Set
          End Property
          Public property Descripcion As String
            get
                return me.GetValue_String("pr_10040158005")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040158005", value)
            End Set
          End Property
          Public property Titulo As String
            get
                return me.GetValue_String("pr_10040158003")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040158003", value)
            End Set
          End Property
          Public property ReferenciaIcono As Guid
            get
                return me.GetValue_Guid("pr_10040158006")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040158006", value)
            End Set
          End Property
        Public ReadOnly property TipoObsoleto As EnumTipoDeDocumentoE
            get
                return me.GetValue_Int("pr_20040184232")
            End Get   
        End Property
          Public property ReferenciaExclusivoDePlanContableObsoleto As Guid
            get
                return me.GetValue_Guid("pr_30040184971")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040184971", value)
            End Set
          End Property
          Public property MasInformacion As String
            get
                return me.GetValue_String("pr_50040235263")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040235263", value)
            End Set
          End Property
          Public property ReferenciaResumenDelModelo As Guid
            get
                return me.GetValue_Guid("pr_10040237231")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040237231", value)
            End Set
          End Property
          Public property QuienDebePresentarlo As String
            get
                return me.GetValue_String("pr_40040237263")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040237263", value)
            End Set
          End Property
          Public property ParaQueEs As String
            get
                return me.GetValue_String("pr_40040237262")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040237262", value)
            End Set
          End Property
          Public property CuandoSePresenta As String
            get
                return me.GetValue_String("pr_40040237264")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040237264", value)
            End Set
          End Property
          Public property ComoSePresenta As String
            get
                return me.GetValue_String("pr_40040237265")
            End Get
            Set(value As String)
                me.SetValue_String("pr_40040237265", value)
            End Set
          End Property
          Public property EnlaceOficial As String
            get
                return me.GetValue_String("pr_50040237431")
            End Get
            Set(value As String)
                me.SetValue_String("pr_50040237431", value)
            End Set
          End Property
          Public property ReferenciaDocumentoPrediseñado As Guid
            get
                return me.GetValue_Guid("pr_60040237492")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040237492", value)
            End Set
          End Property
          Public property Vigente As Boolean
            get
                return me.GetValue_Boolean("pr_10040237679")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_10040237679", value)
            End Set
          End Property
          Public property RequiereTenerPlazosPreconfigurados As Boolean
            get
                return me.GetValue_Boolean("pr_40040282803")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_40040282803", value)
            End Set
          End Property
