...
Partial Public Class SeccionesD
  Public Class InmovilizadoD
      Public Class Inmovilizado_ConListaC
      Public Listador as InmovilizadoC
      Public Lista As New List(of InmovilizadoListaD.InmovilizadoListaC)
        sub new(_listador  as InmovilizadoC, _lista as List(of InmovilizadoListaD.InmovilizadoListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "3bce6b71-a934-4cf9-be13-8d215ec8bb06"
      Public Shared _SeccionIDGUID As New Guid("3bce6b71-a934-4cf9-be13-8d215ec8bb06")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of InmovilizadoC )) 
          Dim R As New List(Of InmovilizadoC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(InmovilizadoES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New InmovilizadoC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  Inmovilizado_ConListaC)) 
          Dim R As New List(Of Inmovilizado_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(InmovilizadoES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of InmovilizadoListaD.InmovilizadoListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New InmovilizadoListaD.InmovilizadoListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New Inmovilizado_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As InmovilizadoC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of InmovilizadoC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of InmovilizadoC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, InmovilizadoES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As Inmovilizado_ConListaC, Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of Inmovilizado_ConListaC)({DAtos}), CampoWhere, CampoWhereLista)
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of Inmovilizado_ConListaC), Optional CampoWhere$ = "id", Optional CampoWhereLista$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Dim Importar As New List(Of DinaupAPI_ImportacionProcesableC)
          For Each Actual In DAtos 
              Dim RegistroActual = New DinaupAPI_ImportacionProcesableC() 
               ...
               Importar.Add(RegistroActual)  
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, InmovilizadoES._SeccionID, Importar, CampoWhere, CampoWhereLista) 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As Inmovilizado_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, InmovilizadoES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Inmovilizado_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As Inmovilizado_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, InmovilizadoES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New Inmovilizado_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class InmovilizadoES
          Public shared _SeccionID as Guid = New Guid("3bce6b71-a934-4cf9-be13-8d215ec8bb06")
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___NumeroDeAmortizaciones As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""NumeroDeAmortizaciones"",""etiqueta"": ""Número de Amortizaciones"",""oculta"": false,""formato"": 2,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": false,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Número de Amortizaciones"",""descripcion"": """",""keyword"": ""NumeroDeAmortizaciones"",""formato"": 2,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""3bce6b71-a934-4cf9-be13-8d215ec8bb06"",""titulo"": ""Inmovilizado"",""iconoid"": ""8e293cdc-798a-485a-8aea-5beaff94b10c"",""etiquetasingular"": ""Inmovilizado"",""etiquetaplural"": ""Inmovilizados"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""3bce6b71-a934-4cf9-be13-8d215ec8bb06"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class Inmovilizado_FormularioC
        Inherits DinaNETCore.VentanaVirtualC

    Public _Lista As List(Of InmovilizadoListaD.InmovilizadoLista_FormularioC)
    ...
    Overrides Sub Evento_Actualizar()
        ...
        If Me.EsListador Then
            ...
            Dim CreandoLista As New List(Of InmovilizadoListaD.InmovilizadoLista_FormularioC)
            If FormLista IsNot Nothing Then
                For i = 0 To FormLista.Count - 1
                    Dim ElementoLista As New InmovilizadoListaD.InmovilizadoLista_FormularioC(Me.__VV__, FormLista(i).Token)
    ...
    End Sub
        ...
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_500401373316")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_500401373315")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_500401373315", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_500401373311")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_500401373311", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_500401373313")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_500401373322")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_500401373322", value)
            End Set
          End Property
          Public property ImporteValorRemanente As Decimal
            get
                return me.GetValue_Decimal("pr_20040137403")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_20040137403", value)
            End Set
          End Property
          Public property ReferenciaCuentaAmortizacionAcumulada As Guid
            get
                return me.GetValue_Guid("pr_30040137453")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040137453", value)
            End Set
          End Property
          Public property ReferenciaAsientoDeBaja As Guid
            get
                return me.GetValue_Guid("pr_20040137451")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040137451", value)
            End Set
          End Property
          Public property EnEstadoDeBaja As Boolean
            get
                return me.GetValue_Boolean("pr_20040137461")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_20040137461", value)
            End Set
          End Property
          Public property ReferenciaCuentaDotacionAmortizacion As Guid
            get
                return me.GetValue_Guid("pr_30040137452")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040137452", value)
            End Set
          End Property
          Public property ReferenciaTiposDeInmovilizados As Guid
            get
                return me.GetValue_Guid("pr_40040137434")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_40040137434", value)
            End Set
          End Property
          Public property ImporteAmortizacionDeEjerciciosAnteriores As Decimal
            get
                return me.GetValue_Decimal("pr_30040137854")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_30040137854", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalAmortizado As Decimal
            get
                return me.GetValue_Decimal("pr_40040137851")
            End Get   
        End Property
          Public property ImporteCoste As Decimal
            get
                return me.GetValue_Decimal("pr_60040137843")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_60040137843", value)
            End Set
          End Property
          Public property InicioActividad As Date
            get
                return me.GetValue_Date("pr_50040137852")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_50040137852", value)
            End Set
          End Property
          Public property VidaDelActivoAños As Integer
            get
                return me.GetValue_Int("pr_20040137401")
            End Get
            Set(value As Integer)
                me.SetValue_Int("pr_20040137401", value)
            End Set
          End Property
        Public ReadOnly property FechaFinDeAmortizacion As Date
            get
                return me.GetValue_Date("pr_40040137852")
            End Get   
        End Property
        Public ReadOnly property NumeroDeAmortizaciones As Integer
            get
                return me.GetValue_Int("pr_50040137851")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalAAmortizar As Decimal
            get
                return me.GetValue_Decimal("pr_10040137861")
            End Get   
        End Property
          Public property EmpresaObsoletoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_50040180115")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_50040180115", value)
            End Set
          End Property
          Public property ReferenciaEmpresaObsoleto As Guid
            get
                return me.GetValue_Guid("pr_50040180114")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_50040180114", value)
            End Set
          End Property
          Public property ReferenciaActividad As Guid
            get
                return me.GetValue_Guid("pr_20040258061")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_20040258061", value)
            End Set
          End Property
          Public property ProveedorTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_30040258065")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_30040258065", value)
            End Set
          End Property
          Public property ReferenciaFacturaDeCompra As Guid
            get
                return me.GetValue_Guid("pr_30040258063")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040258063", value)
            End Set
          End Property
          Public property InformacionAdicional As String
            get
                return me.GetValue_String("pr_30040258066")
            End Get
            Set(value As String)
                me.SetValue_String("pr_30040258066", value)
            End Set
          End Property
          Public property EstadoDeAdquisicion__Int as Integer
            get
                return me.GetValue_Int("pr_30040258061")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_30040258061", value)
            End Set
          End Property
          Public property EstadoDeAdquisicion As EnumInmovilizadoEstadoAdquisicionEE
            get
                return me.GetValue_Int("pr_30040258061")
            End Get
            Set(value As EnumInmovilizadoEstadoAdquisicionEE)
                me.SetValue_Int("pr_30040258061", value)
            End Set
          End Property
          Public property Naturaleza__Int as Integer
            get
                return me.GetValue_Int("pr_30040258062")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_30040258062", value)
            End Set
          End Property
          Public property Naturaleza As EnumInmovilizadoNaturalezaEE
            get
                return me.GetValue_Int("pr_30040258062")
            End Get
            Set(value As EnumInmovilizadoNaturalezaEE)
                me.SetValue_Int("pr_30040258062", value)
            End Set
          End Property
          Public property ReferenciaProveedor As Guid
            get
                return me.GetValue_Guid("pr_30040258064")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040258064", value)
            End Set
          End Property
          Public property ReferenciaElementoDeCompra As Guid
            get
                return me.GetValue_Guid("pr_10040277771")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_10040277771", value)
            End Set
          End Property
