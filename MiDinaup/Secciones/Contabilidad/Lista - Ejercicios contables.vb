...
Partial Public Class SeccionesD
  Public Class EjerciciosContablesListaD
      Public Shared _SeccionID As String = "01f35211-db22-4d0c-ac0d-453c0f37d0c9"
      Public Shared _SeccionIDGUID As New Guid("01f35211-db22-4d0c-ac0d-453c0f37d0c9")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of EjerciciosContablesListaC )) 
          Dim R As New List(Of EjerciciosContablesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(EjerciciosContablesListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New EjerciciosContablesListaC 
          ...
          Return R 
      End Function 
      Public Class EjerciciosContablesListaES
          Public shared _SeccionID as Guid = New Guid("01f35211-db22-4d0c-ac0d-453c0f37d0c9")
      ...
      End Class
      Public Class EjerciciosContablesListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""01f35211-db22-4d0c-ac0d-453c0f37d0c9"",""titulo"": ""Lista - Ejercicios contables"",""iconoid"": """",""etiquetasingular"": ""Ejercicio contable"",""etiquetaplural"": ""Ejercicios contables"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""01f35211-db22-4d0c-ac0d-453c0f37d0c9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class EjerciciosContablesLista_FormularioC
