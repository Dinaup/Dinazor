...
Partial Public Class SeccionesD
  Public Class AutomatizacionDeContabilidadD
      Public Shared _SeccionID As String = "edca8850-faa9-4de9-a66a-f7a7c5d1dd36"
      Public Shared _SeccionIDGUID As New Guid("edca8850-faa9-4de9-a66a-f7a7c5d1dd36")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AutomatizacionDeContabilidadC )) 
          Dim R As New List(Of AutomatizacionDeContabilidadC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AutomatizacionDeContabilidadES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AutomatizacionDeContabilidadC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As AutomatizacionDeContabilidadC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of AutomatizacionDeContabilidadC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of AutomatizacionDeContabilidadC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, AutomatizacionDeContabilidadES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As AutomatizacionDeContabilidad_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, AutomatizacionDeContabilidadES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New AutomatizacionDeContabilidad_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As AutomatizacionDeContabilidad_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, AutomatizacionDeContabilidadES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New AutomatizacionDeContabilidad_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class AutomatizacionDeContabilidadES
          Public shared _SeccionID as Guid = New Guid("edca8850-faa9-4de9-a66a-f7a7c5d1dd36")
      ...
      End Class
      Public Class AutomatizacionDeContabilidadC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""edca8850-faa9-4de9-a66a-f7a7c5d1dd36"",""titulo"": ""Automatización de contabilidad"",""iconoid"": ""d947fd09-0b03-4fdc-a80b-8a8afbf31875"",""etiquetasingular"": ""Automatización de contabilidad"",""etiquetaplural"": ""Automatizaciones de contabilidad"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""edca8850-faa9-4de9-a66a-f7a7c5d1dd36"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class AutomatizacionDeContabilidad_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
          Public property Desactivar As Boolean
            get
                return me.GetValue_Boolean("pr_60040136163")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040136163", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_100401328816")
            End Get   
        End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_100401328815")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_100401328815", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_100401328811")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_100401328811", value)
            End Set
          End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_100401328813")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_100401328822")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_100401328822", value)
            End Set
          End Property
          Public property Configuracion As String
            get
                return me.GetValue_String("pr_100401328826")
            End Get
            Set(value As String)
                me.SetValue_String("pr_100401328826", value)
            End Set
          End Property
        Public ReadOnly property ConfiguracionCRC As String
            get
                return me.GetValue_String("pr_20040132883")
            End Get   
        End Property
          Public property ConfiguracionDeCuentasPorDefecto As String
            get
                return me.GetValue_String("pr_10040136424")
            End Get
            Set(value As String)
                me.SetValue_String("pr_10040136424", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaSeccionAContabilizar As Guid
            get
                return me.GetValue_Guid("pr_60040135241008")
            End Get   
        End Property
          Public property FechaDeInicio_UTC As Date
            get
                return me.GetValue_DateTime("pr_40040192894")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_40040192894", value)
            End Set
          End Property
