...
Partial Public Class SeccionesD
  Public Class PlazosPresentacionDeModelosFiscalesBaseListaD
      Public Shared _SeccionID As String = "ac3276c7-eb96-4658-a719-433e24d11eb1"
      Public Shared _SeccionIDGUID As New Guid("ac3276c7-eb96-4658-a719-433e24d11eb1")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PlazosPresentacionDeModelosFiscalesBaseListaC )) 
          Dim R As New List(Of PlazosPresentacionDeModelosFiscalesBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PlazosPresentacionDeModelosFiscalesBaseListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PlazosPresentacionDeModelosFiscalesBaseListaC 
          ...
          Return R 
      End Function 
      Public Class PlazosPresentacionDeModelosFiscalesBaseListaES
          Public shared _SeccionID as Guid = New Guid("ac3276c7-eb96-4658-a719-433e24d11eb1")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_400401853622"
      ...
      End Class
      Public Class PlazosPresentacionDeModelosFiscalesBaseListaC
      Inherits Base_DatoC
          ...
          Public Shared ___DiaFinDePlazo As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""DiaFinDePlazo"",""etiqueta"": ""Día fin de plazo"",""oculta"": false,""formato"": 2,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Día fin de plazo"",""descripcion"": """",""keyword"": ""DiaFinDePlazo"",""formato"": 2,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_400401853622")
         ...
         R.add("pr_400401853622", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
