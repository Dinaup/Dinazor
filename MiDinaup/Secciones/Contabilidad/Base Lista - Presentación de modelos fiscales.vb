...
Partial Public Class SeccionesD
  Public Class PresentacionDeModelosFiscalesBaseListaD
      Public Shared _SeccionID As String = "1b384297-fe64-4075-83bc-5f2f84657248"
      Public Shared _SeccionIDGUID As New Guid("1b384297-fe64-4075-83bc-5f2f84657248")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PresentacionDeModelosFiscalesBaseListaC )) 
          Dim R As New List(Of PresentacionDeModelosFiscalesBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PresentacionDeModelosFiscalesBaseListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PresentacionDeModelosFiscalesBaseListaC 
          ...
          Return R 
      End Function 
      Public Class PresentacionDeModelosFiscalesBaseListaES
          Public shared _SeccionID as Guid = New Guid("1b384297-fe64-4075-83bc-5f2f84657248")
          Public shared _Tabla$ = "tpr_50040188953_e"
      Public Shared ReferenciaDestinador$ = "pr_50040188951020"
      Public Shared FechaAlta_UTC$ = "pr_50040188951019"
      Public Shared ReferenciaAutorDelAlta$ = "pr_50040188951016"
      Public Shared FechaDato_UTC$ = "pr_50040188951017"
      Public Shared HoraLocal$ = "pr_50040188951018"
      Public Shared ReferenciaEmpleadoPrincipal$ = "pr_50040188951014"
      Public Shared AutorDelAltaTieneAccesoWeb$ = "pr_50040188951021"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_50040188951022"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class PresentacionDeModelosFiscalesBaseListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""1b384297-fe64-4075-83bc-5f2f84657248"",""titulo"": ""Base Lista - Presentación de modelos fiscales"",""iconoid"": """",""etiquetasingular"": ""Presentación de modelo fiscal"",""etiquetaplural"": ""Presentaciones de modelos fiscales"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""1b384297-fe64-4075-83bc-5f2f84657248"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040188951020"), _Datos.Leer_String("pr_50040188951020.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_50040188951019")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040188951016"), _Datos.Leer_String("pr_50040188951016.nombre"))
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_50040188951017")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_50040188951018")
          me.ReferenciaEmpleadoPrincipal = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_50040188951014"), _Datos.Leer_String("pr_50040188951014.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_50040188951021")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_50040188951022")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_50040188951020",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_50040188951020","")
         End if
         R.add("pr_50040188951019", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_50040188951016",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_50040188951016","")
         End if
         R.add("pr_50040188951017", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_50040188951018", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         If Me.ReferenciaEmpleadoPrincipal IsNot nothing then
           R.add("pr_50040188951014",me.ReferenciaEmpleadoPrincipal.ID.STR())
         Else
           R.add("pr_50040188951014","")
         End if
         R.add("pr_50040188951021", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_50040188951022", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
