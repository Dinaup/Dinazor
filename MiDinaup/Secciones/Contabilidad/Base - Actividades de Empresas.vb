...
Partial Public Class SeccionesD
  Public Class ActividadesDeEmpresasBaseD
      Public Class ActividadesDeEmpresasBase_ConListaC
      Public Listador as ActividadesDeEmpresasBaseC
      Public Lista As New List(of ActividadesDeEmpresasBaseListaD.ActividadesDeEmpresasBaseListaC)
        sub new(_listador  as ActividadesDeEmpresasBaseC, _lista as List(of ActividadesDeEmpresasBaseListaD.ActividadesDeEmpresasBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "f6221df1-2f56-4f49-8e45-dd4914873fa8"
      Public Shared _SeccionIDGUID As New Guid("f6221df1-2f56-4f49-8e45-dd4914873fa8")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of ActividadesDeEmpresasBaseC )) 
          Dim R As New List(Of ActividadesDeEmpresasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ActividadesDeEmpresasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New ActividadesDeEmpresasBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  ActividadesDeEmpresasBase_ConListaC)) 
          Dim R As New List(Of ActividadesDeEmpresasBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(ActividadesDeEmpresasBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of ActividadesDeEmpresasBaseListaD.ActividadesDeEmpresasBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New ActividadesDeEmpresasBaseListaD.ActividadesDeEmpresasBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New ActividadesDeEmpresasBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class ActividadesDeEmpresasBaseES
          Public shared _SeccionID as Guid = New Guid("f6221df1-2f56-4f49-8e45-dd4914873fa8")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_600402561325"
      ...
      End Class
      Public Class ActividadesDeEmpresasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f6221df1-2f56-4f49-8e45-dd4914873fa8"",""titulo"": ""Base - Actividades de Empresas"",""iconoid"": ""c33cb208-e4a6-4189-af8f-00aa92e9599a"",""etiquetasingular"": ""Actividad de Empresa"",""etiquetaplural"": ""Actividades de Empresa"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""f6221df1-2f56-4f49-8e45-dd4914873fa8"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_600402561325")
         ...
         R.add("pr_600402561325", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
