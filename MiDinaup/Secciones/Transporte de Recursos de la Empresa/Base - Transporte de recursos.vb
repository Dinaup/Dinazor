...
Partial Public Class SeccionesD
  Public Class TransporteDeRecursosBaseD
      Public Class TransporteDeRecursosBase_ConListaC
      Public Listador as TransporteDeRecursosBaseC
      Public Lista As New List(of TransporteDeRecursosBaseListaD.TransporteDeRecursosBaseListaC)
        sub new(_listador  as TransporteDeRecursosBaseC, _lista as List(of TransporteDeRecursosBaseListaD.TransporteDeRecursosBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "4fad3e82-ae41-462b-b7bb-e5c8fb212e41"
      Public Shared _SeccionIDGUID As New Guid("4fad3e82-ae41-462b-b7bb-e5c8fb212e41")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TransporteDeRecursosBaseC )) 
          Dim R As New List(Of TransporteDeRecursosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TransporteDeRecursosBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TransporteDeRecursosBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  TransporteDeRecursosBase_ConListaC)) 
          Dim R As New List(Of TransporteDeRecursosBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TransporteDeRecursosBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Obj_Listador.CargaInterna(Actual.Value)
                  Dim Objs_Listas As New List(Of TransporteDeRecursosBaseListaD.TransporteDeRecursosBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New TransporteDeRecursosBaseListaD.TransporteDeRecursosBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New TransporteDeRecursosBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class TransporteDeRecursosBaseES
          Public shared _SeccionID as Guid = New Guid("4fad3e82-ae41-462b-b7bb-e5c8fb212e41")
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_100104215324"
      ...
      End Class
      Public Class TransporteDeRecursosBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""4fad3e82-ae41-462b-b7bb-e5c8fb212e41"",""titulo"": ""Base - Transporte de recursos"",""iconoid"": ""dcf69669-f8ea-4f8d-ab81-76e23ecf813e"",""etiquetasingular"": ""Transporte de recurso"",""etiquetaplural"": ""Transportes de recursos"",""etiquetaesfemenino"": false,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""4fad3e82-ae41-462b-b7bb-e5c8fb212e41"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_100104215324")
         ...
         End if
         R.add("pr_100104215324", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
