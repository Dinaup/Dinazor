...
Partial Public Class SeccionesD
  Public Class PaisesListaD
      Public Shared _SeccionID As String = "3c1c3246-2dea-466d-9045-48d593535945"
      Public Shared _SeccionIDGUID As New Guid("3c1c3246-2dea-466d-9045-48d593535945")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of PaisesListaC )) 
          Dim R As New List(Of PaisesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(PaisesListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New PaisesListaC 
          ...
          Return R 
      End Function 
      Public Class PaisesListaES
          Public shared _SeccionID as Guid = New Guid("3c1c3246-2dea-466d-9045-48d593535945")
      ...
      End Class
      Public Class PaisesListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""3c1c3246-2dea-466d-9045-48d593535945"",""titulo"": ""Lista - Países"",""iconoid"": """",""etiquetasingular"": ""País"",""etiquetaplural"": ""Países"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""3c1c3246-2dea-466d-9045-48d593535945"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class PaisesLista_FormularioC
