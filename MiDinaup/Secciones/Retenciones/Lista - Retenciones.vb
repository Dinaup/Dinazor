...
Partial Public Class SeccionesD
  Public Class RetencionesListaD
      Public Shared _SeccionID As String = "7537e110-4063-4c1e-a619-e29a15118ff5"
      Public Shared _SeccionIDGUID As New Guid("7537e110-4063-4c1e-a619-e29a15118ff5")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RetencionesListaC )) 
          Dim R As New List(Of RetencionesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RetencionesListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RetencionesListaC 
          ...
          Return R 
      End Function 
      Public Class RetencionesListaES
          Public shared _SeccionID as Guid = New Guid("7537e110-4063-4c1e-a619-e29a15118ff5")
          Public shared _Tabla$ = "tpr_5cccabaxd_e"
      Public Shared ID$ = "id"
      ...
      End Class
      Public Class RetencionesListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""7537e110-4063-4c1e-a619-e29a15118ff5"",""titulo"": ""Lista - Retenciones"",""iconoid"": """",""etiquetasingular"": ""Retención"",""etiquetaplural"": ""Retenciones"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""7537e110-4063-4c1e-a619-e29a15118ff5"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class RetencionesLista_FormularioC
