...
Partial Public Class SeccionesD
  Public Class RetencionesBaseD
      Public Shared _SeccionID As String = "1a89014d-3991-4d9d-8d0f-77fcf2ddff5e"
      Public Shared _SeccionIDGUID As New Guid("1a89014d-3991-4d9d-8d0f-77fcf2ddff5e")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of RetencionesBaseC )) 
          Dim R As New List(Of RetencionesBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(RetencionesBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New RetencionesBaseC 
          ...
          Return R 
      End Function 
      Public Class RetencionesBaseES
          Public shared _SeccionID as Guid = New Guid("1a89014d-3991-4d9d-8d0f-77fcf2ddff5e")
          Public shared _Tabla$ = "tpr_5cccabaxd"
      Public Shared EtiquetaRetencionParaImpresion$ = "pr_173a89baa3x267wd"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_191d9a63dax275wd"
      ...
      End Class
      Public Class RetencionesBaseC
      Inherits Base_DatoC
          <DisplayName("Etiqueta retención (Para impresión)")>
          Public Property EtiquetaRetencionParaImpresion As String
          Public Shared ___EtiquetaRetencionParaImpresion As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""EtiquetaRetencionParaImpresion"",""etiqueta"": ""Etiqueta retención (Para impresión)"",""oculta"": false,""formato"": 5,""porubicacion"": false,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Etiqueta retención (Para impresión)"",""descripcion"": """",""keyword"": ""EtiquetaRetencionParaImpresion"",""formato"": 5,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_191d9a63dax275wd")
         ...
         R.add("pr_191d9a63dax275wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
