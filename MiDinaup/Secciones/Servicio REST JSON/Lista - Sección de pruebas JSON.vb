...
Partial Public Class SeccionesD
  Public Class SeccionDePruebasJSONListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SeccionDePruebasJSONListaC )) 
          Dim R As New List(Of SeccionDePruebasJSONListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SeccionDePruebasJSONListaES._SeccionID, False, Parametros) 
