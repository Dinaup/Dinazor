...
Partial Public Class SeccionesD
  Public Class SesionesWebBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SesionesWebBaseListaC )) 
          Dim R As New List(Of SesionesWebBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SesionesWebBaseListaES._SeccionID, False, Parametros) 
