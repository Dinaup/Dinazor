...
Partial Public Class SeccionesD
  Public Class SesionesWebBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of SesionesWebBaseListaC )) 
          Dim R As New List(Of SesionesWebBaseListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, SesionesWebBaseListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SesionesWebBaseListaC 
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""a8b09778-9f84-4172-b193-2ddc87cf3d5d"",""titulo"": ""Base Lista - Sesiones Web"",""iconoid"": """",""etiquetasingular"": ""Sesión web"",""etiquetaplural"": ""Sesiones Web"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": true,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""a8b09778-9f84-4172-b193-2ddc87cf3d5d"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaDestinador = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_500401777620"), _Datos.Leer_String("pr_500401777620.nombre"))
          me.FechaAlta_UTC = _Datos.Leer_DateTime_Nulable("pr_500401777619")
          me.HoraLocal = _Datos.Leer_Time_Nulable("pr_500401777618")
          me.FechaDato_UTC = _Datos.Leer_DateTime_Nulable("pr_500401777617")
          me.ReferenciaAutorDelAlta = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_500401777616"), _Datos.Leer_String("pr_500401777616.nombre"))
          me.AutorDelAltaTieneAccesoWeb = _Datos.Leer_Boolean("pr_500401777621")
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_500401777622")
         ...
         If Me.ReferenciaDestinador IsNot nothing then
           R.add("pr_500401777620",me.ReferenciaDestinador.ID.STR())
         Else
           R.add("pr_500401777620","")
         End if
         R.add("pr_500401777619", me.FechaAlta_UTC.AdaptarMySQL_DateTime_Nulable())
         R.add("pr_500401777618", me.HoraLocal.AdaptarMySQL_Time_Nulable())
         R.add("pr_500401777617", me.FechaDato_UTC.AdaptarMySQL_DateTime_Nulable())
         If Me.ReferenciaAutorDelAlta IsNot nothing then
           R.add("pr_500401777616",me.ReferenciaAutorDelAlta.ID.STR())
         Else
           R.add("pr_500401777616","")
         End if
         R.add("pr_500401777621", me.AutorDelAltaTieneAccesoWeb.AdaptarMySQL_Boolean())
         R.add("pr_500401777622", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
