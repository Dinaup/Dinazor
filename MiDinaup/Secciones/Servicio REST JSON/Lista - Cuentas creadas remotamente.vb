...
Partial Public Class SeccionesD
  Public Class CuentasCreadasRemotamenteListaD
      Public Shared _SeccionID As String = "b768f61f-03f8-4a9f-8cba-a025d2a49a23"
      Public Shared _SeccionIDGUID As New Guid("b768f61f-03f8-4a9f-8cba-a025d2a49a23")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of CuentasCreadasRemotamenteListaC )) 
          Dim R As New List(Of CuentasCreadasRemotamenteListaC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, CuentasCreadasRemotamenteListaES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CuentasCreadasRemotamenteListaC 
          ...
          Return R 
      End Function 
      Public Class CuentasCreadasRemotamenteListaES
          Public shared _SeccionID as Guid = New Guid("b768f61f-03f8-4a9f-8cba-a025d2a49a23")
      ...
      End Class
      Public Class CuentasCreadasRemotamenteListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""b768f61f-03f8-4a9f-8cba-a025d2a49a23"",""titulo"": ""Lista - Cuentas creadas remotamente"",""iconoid"": """",""etiquetasingular"": ""Cuenta creada remotamente"",""etiquetaplural"": ""Cuentas creadas remotamente"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""b768f61f-03f8-4a9f-8cba-a025d2a49a23"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class CuentasCreadasRemotamenteLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_500404803421")
            End Get   
        End Property
