...
Partial Public Class SeccionesD
  Public Class SeccionDePruebasJSONBaseListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SeccionDePruebasJSONBaseListaC )) 
          Dim R As New List(Of SeccionDePruebasJSONBaseListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SeccionDePruebasJSONBaseListaES._SeccionID, False, Parametros) 
