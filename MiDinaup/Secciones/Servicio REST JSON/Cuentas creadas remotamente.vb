...
Partial Public Class SeccionesD
  Public Class CuentasCreadasRemotamenteD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CuentasCreadasRemotamenteC )) 
          Dim R As New List(Of CuentasCreadasRemotamenteC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CuentasCreadasRemotamenteES._SeccionID, False, Parametros) 
