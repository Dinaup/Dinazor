...
Partial Public Class SeccionesD
  Public Class CambiosDeContraseñasListaD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CambiosDeContraseñasListaC )) 
          Dim R As New List(Of CambiosDeContraseñasListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CambiosDeContraseñasListaES._SeccionID, False, Parametros) 
