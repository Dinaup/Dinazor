...
Partial Public Class SeccionesD
  Public Class IntentosFallidosDeInicioDeSesionD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of IntentosFallidosDeInicioDeSesionC )) 
          Dim R As New List(Of IntentosFallidosDeInicioDeSesionC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(IntentosFallidosDeInicioDeSesionES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New IntentosFallidosDeInicioDeSesionC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As IntentosFallidosDeInicioDeSesionC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of IntentosFallidosDeInicioDeSesionC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of IntentosFallidosDeInicioDeSesionC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, IntentosFallidosDeInicioDeSesionES._SeccionID, Importar, CampoWhere, "") 
      End Function
      ...
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""bd8e7893-4c8d-41c0-be2e-da9b3053fbe9"",""titulo"": ""Intentos fallidos de inicio de sesión"",""iconoid"": ""d421826f-5b7f-4ba7-9ac1-69a741dfcf7e"",""etiquetasingular"": ""Intento fallido de inicio de sesión"",""etiquetaplural"": ""Intentos fallidos de inicio de sesión"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""bd8e7893-4c8d-41c0-be2e-da9b3053fbe9"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
    ...
    End Sub
        ...
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_100401784010")
            End Get   
        End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
