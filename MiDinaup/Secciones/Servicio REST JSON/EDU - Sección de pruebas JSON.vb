...
Partial Public Class SeccionesD
  Public Class SeccionDePruebasJSONEDUD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SeccionDePruebasJSONEDUC )) 
          Dim R As New List(Of SeccionDePruebasJSONEDUC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SeccionDePruebasJSONEDUES._SeccionID, False, Parametros) 
