...
Partial Public Class SeccionesD
  Public Class CuentasCreadasRemotamenteBaseD
      Public Class CuentasCreadasRemotamenteBase_ConListaC
      Public Listador as CuentasCreadasRemotamenteBaseC
      Public Lista As New List(of CuentasCreadasRemotamenteBaseListaD.CuentasCreadasRemotamenteBaseListaC)
        sub new(_listador  as CuentasCreadasRemotamenteBaseC, _lista as List(of CuentasCreadasRemotamenteBaseListaD.CuentasCreadasRemotamenteBaseListaC))
           me.Listador =_listador 
           me.Lista =_lista 
        End sub
      End Class
      Public Shared _SeccionID As String = "d6085247-39ca-490b-9113-a59e36f67090"
      Public Shared _SeccionIDGUID As New Guid("d6085247-39ca-490b-9113-a59e36f67090")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of CuentasCreadasRemotamenteBaseC )) 
          Dim R As New List(Of CuentasCreadasRemotamenteBaseC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, CuentasCreadasRemotamenteBaseES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New CuentasCreadasRemotamenteBaseC 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of  CuentasCreadasRemotamenteBase_ConListaC)) 
          Dim R As New List(Of CuentasCreadasRemotamenteBase_ConListaC )  
          Dim d =  Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, CuentasCreadasRemotamenteBaseES._SeccionID, True, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  ...
                  Dim Obj_Listador As New CuentasCreadasRemotamenteBaseC 
                  Obj_Listador.CargarDatos(Valores_Listador) 
                  Dim Objs_Listas As New List(Of CuentasCreadasRemotamenteBaseListaD.CuentasCreadasRemotamenteBaseListaC) 
                  If Valores_Lista.TieneDatos Then  
                      For Each ValoresLista In Valores_Lista 
                         Dim nItem As New CuentasCreadasRemotamenteBaseListaD.CuentasCreadasRemotamenteBaseListaC 
                         nItem.CargarDatos(ValoresLista)   
                         Objs_Listas.Add(nItem)         
                      Next   
                  End If   
                  R.Add(New CuentasCreadasRemotamenteBase_ConListaC(Obj_Listador, Objs_Listas))
              Next 
          End If 
          Return R 
      End Function 
      Public Class CuentasCreadasRemotamenteBaseES
          Public shared _SeccionID as Guid = New Guid("d6085247-39ca-490b-9113-a59e36f67090")
      ...
      Public Shared ExportarEnModulos$ = "pr_500404803414"
      ...
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_500404803428"
      ...
      End Class
      Public Class CuentasCreadasRemotamenteBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""d6085247-39ca-490b-9113-a59e36f67090"",""titulo"": ""Base - Cuentas creadas remotamente"",""iconoid"": ""9f99c5b6-6eda-46cf-a6ce-167c20388169"",""etiquetasingular"": ""Cuenta creada remotamente"",""etiquetaplural"": ""Cuentas creadas remotamente"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""d6085247-39ca-490b-9113-a59e36f67090"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_500404803428")
         ...
         R.add("pr_500404803428", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
