...
Partial Public Class SeccionesD
  Public Class CuentasCreadasRemotamenteBaseD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of CuentasCreadasRemotamenteBaseC )) 
          Dim R As New List(Of CuentasCreadasRemotamenteBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CuentasCreadasRemotamenteBaseES._SeccionID, False, Parametros) 
          ...
          Return R 
      End Function 
      Public Shared Async Function ConsultarDatos_ConLista_Async(  Parametros As SeccionConsultaParametrosC ) As Task(Of List(Of  CuentasCreadasRemotamenteBase_ConListaC)) 
          Dim R As New List(Of CuentasCreadasRemotamenteBase_ConListaC )  
          Dim d =  Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(CuentasCreadasRemotamenteBaseES._SeccionID, True, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
