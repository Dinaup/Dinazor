...
Partial Public Class SeccionesD
  Public Class SeccionDePruebasJSONBaseEDUD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SeccionDePruebasJSONBaseEDUC )) 
          Dim R As New List(Of SeccionDePruebasJSONBaseEDUC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SeccionDePruebasJSONBaseEDUES._SeccionID, False, Parametros) 
