...
Partial Public Class SeccionesD
  Public Class SeccionDePruebasJSONBaseEDUD
      Public Shared _SeccionID As String = "1d8c9cea-ad41-4152-9d08-0be28924a6d3"
      Public Shared _SeccionIDGUID As New Guid("1d8c9cea-ad41-4152-9d08-0be28924a6d3")
      Public Shared Async Function ConsultarDatos_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, ParamArray Valor As String()) As Task(Of List(Of SeccionDePruebasJSONBaseEDUC )) 
          Dim R As New List(Of SeccionDePruebasJSONBaseEDUC )  
          Dim d = Await DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DinaupSesion, SeccionDePruebasJSONBaseEDUES._SeccionID, False, Campo, Valor) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New SeccionDePruebasJSONBaseEDUC 
          ...
          Return R 
      End Function 
      Public Class SeccionDePruebasJSONBaseEDUES
          Public shared _SeccionID as Guid = New Guid("1d8c9cea-ad41-4152-9d08-0be28924a6d3")
      ...
      End Class
      Public Class SeccionDePruebasJSONBaseEDUC
      Inherits Base_DatoC
          ...
          <DisplayName("Relación elemento Sección de prueba JSON")>
          Public Property ReferenciaRelacionElemento As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___ReferenciaRelacionElemento As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""ReferenciaRelacionElemento"",""etiqueta"": ""Relación elemento Sección de prueba JSON"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""2a8a863b-540d-4b4c-8898-3cebc52bba65"",""titulo"": ""Base - Sección de pruebas JSON"",""iconoid"": ""1343acf7-ccf5-4eae-bacb-6d028a80803e"",""etiquetasingular"": ""Sección de prueba JSON"",""etiquetaplural"": ""Secciones de pruebas JSON"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""2a8a863b-540d-4b4c-8898-3cebc52bba65"",""rol"": 0,""decimales"": ""0"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Relación elemento Sección de prueba JSON"",""descripcion"": """",""keyword"": ""ReferenciaRelacionElemento"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __ReferenciaRelacionElemento As DinaNETCore.APID.DinaupAPI_CampoC = ___ReferenciaRelacionElemento
          <DisplayName("Prueba de Texto por ubicación")>
          Public Property PruebaDeTextoPorUbicacionEDU As String
          Public Shared ___PruebaDeTextoPorUbicacionEDU As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""PruebaDeTextoPorUbicacionEDU"",""etiqueta"": ""Prueba de Texto por ubicación"",""oculta"": false,""formato"": 5,""porubicacion"": true,""seccionrelacionada"": null,""seccionrelacionadaid"": """",""rol"": 9,""decimales"": ""0"",""multilinea"": true,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Prueba de Texto por ubicación"",""descripcion"": """",""keyword"": ""PruebaDeTextoPorUbicacionEDU"",""formato"": 5,""rol"": 9,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __PruebaDeTextoPorUbicacionEDU As DinaNETCore.APID.DinaupAPI_CampoC = ___PruebaDeTextoPorUbicacionEDU
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": true,""seccionrelacionada"": {""id"": ""1d8c9cea-ad41-4152-9d08-0be28924a6d3"",""titulo"": ""Base EDU - Sección de pruebas JSON"",""iconoid"": """",""etiquetasingular"": ""Sección de prueba JSON"",""etiquetaplural"": ""Secciones de pruebas JSON"",""etiquetaesfemenino"": true,""contienelista"": true,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""1d8c9cea-ad41-4152-9d08-0be28924a6d3"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.ReferenciaUbicacionDeLosDatos = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_20040140793"), _Datos.Leer_String("pr_20040140793.nombre"))
          me.ReferenciaRelacionElemento = new DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC( _Datos.Leer_Guid("pr_20040140792"), _Datos.Leer_String("pr_20040140792.nombre"))
          me.PruebaDeTextoPorUbicacionEDU = _Datos.Leer_String("pr_40040140793")
         ...
         If Me.ReferenciaUbicacionDeLosDatos IsNot nothing then
           R.add("pr_20040140793",me.ReferenciaUbicacionDeLosDatos.ID.STR())
         Else
           R.add("pr_20040140793","")
         End if
         If Me.ReferenciaRelacionElemento IsNot nothing then
           R.add("pr_20040140792",me.ReferenciaRelacionElemento.ID.STR())
         Else
           R.add("pr_20040140792","")
         End if
         R.add("pr_40040140793", me.PruebaDeTextoPorUbicacionEDU.AdaptarMySQL_String())
