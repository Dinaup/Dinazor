...
Partial Public Class SeccionesD
  Public Class SesionesWebD
      ...
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of SesionesWebC )) 
          Dim R As New List(Of SesionesWebC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(SesionesWebES._SeccionID, False, Parametros) 
