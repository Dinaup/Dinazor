...
Partial Public Class SeccionesD
  Public Class DepositosMonetariosBaseD
      Public Shared _SeccionID As String = "cab2cf42-3cf6-4aa6-9930-c7ee704650bc"
      Public Shared _SeccionIDGUID As New Guid("cab2cf42-3cf6-4aa6-9930-c7ee704650bc")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of DepositosMonetariosBaseC )) 
          Dim R As New List(Of DepositosMonetariosBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(DepositosMonetariosBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New DepositosMonetariosBaseC 
          ...
          Return R 
      End Function 
      Public Class DepositosMonetariosBaseES
          Public shared _SeccionID as Guid = New Guid("cab2cf42-3cf6-4aa6-9930-c7ee704650bc")
      ...
      Public Shared ExportarEnModulos$ = "pr_1463102061x100wd"
      Public Shared ImporteSaldoEsperado$ = "pr_2300n"
      Public Shared EmpleadoTieneAccesoWeb$ = "pr_1464b5a57ax43wd"
      ...
      End Class
      Public Class DepositosMonetariosBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""cab2cf42-3cf6-4aa6-9930-c7ee704650bc"",""titulo"": ""Base - Depósitos monetarios"",""iconoid"": ""f037928c-b088-47e4-a79e-3d217109403b"",""etiquetasingular"": ""Depósito monetario"",""etiquetaplural"": ""Depósitos monetarios"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""cab2cf42-3cf6-4aa6-9930-c7ee704650bc"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          me.EmpleadoTieneAccesoWeb = _Datos.Leer_Boolean("pr_1464b5a57ax43wd")
         ...
         R.add("pr_1464b5a57ax43wd", me.EmpleadoTieneAccesoWeb.AdaptarMySQL_Boolean())
