...
Partial Public Class SeccionesD
  Public Class TransaccionesMonetariasInternasBaseD
      Public Shared _SeccionID As String = "b7035ff9-705a-4029-b857-6ff808fe3db7"
      Public Shared _SeccionIDGUID As New Guid("b7035ff9-705a-4029-b857-6ff808fe3db7")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TransaccionesMonetariasInternasBaseC )) 
          Dim R As New List(Of TransaccionesMonetariasInternasBaseC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TransaccionesMonetariasInternasBaseES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TransaccionesMonetariasInternasBaseC 
          ...
          Return R 
      End Function 
      Public Class TransaccionesMonetariasInternasBaseES
          Public shared _SeccionID as Guid = New Guid("b7035ff9-705a-4029-b857-6ff808fe3db7")
      ...
      Public Shared ExportarEnModulos$ = "pr_3004010606131"
      ...
      End Class
      Public Class TransaccionesMonetariasInternasBaseC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""b7035ff9-705a-4029-b857-6ff808fe3db7"",""titulo"": ""Base - Transacciones monetarias internas"",""iconoid"": ""c17a70cf-f1f8-410e-ad7d-c07041338177"",""etiquetasingular"": ""Transacción monetaria interna"",""etiquetaplural"": ""Transacciones monetarias internas"",""etiquetaesfemenino"": true,""contienelista"": false,""eslista"": false,""esbase"": true,""puedeagregar"": false},""seccionrelacionadaid"": ""b7035ff9-705a-4029-b857-6ff808fe3db7"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
