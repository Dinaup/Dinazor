...
Partial Public Class SeccionesD
  Public Class AjustesDeDepositosMonetariosD
      Public Shared _SeccionID As String = "b2b46811-3ecd-4b1b-947e-06626b029f43"
      Public Shared _SeccionIDGUID As New Guid("b2b46811-3ecd-4b1b-947e-06626b029f43")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeDepositosMonetariosC )) 
          Dim R As New List(Of AjustesDeDepositosMonetariosC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeDepositosMonetariosES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AjustesDeDepositosMonetariosC 
          ...
          Return R 
      End Function 
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As AjustesDeDepositosMonetariosC, Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          Return Await DatosGuardar_Async(DinaupSesion, New List(Of AjustesDeDepositosMonetariosC)({DAtos}), CampoWhere )
      End Function
      Public Shared Async Function DatosGuardar_Async(DinaupSesion As DinaNETCore.APID.DinaupSesionC, DAtos As List(Of AjustesDeDepositosMonetariosC), Optional CampoWhere$ = "id") As Task(Of HTTPRespuestaAPIC_Formualario_GuardarC)
          ...
          Next 
          Return Await DinaupSesion.ConexionServidor.Funcion_Importar_Ejecutar_Async(DinaupSesion, AjustesDeDepositosMonetariosES._SeccionID, Importar, CampoWhere, "") 
      End Function
      Public Shared Function AbrirVentana_Agregar(DinaupSesion As DinaNETCore.APID.DinaupSesionC) As AjustesDeDepositosMonetarios_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, AjustesDeDepositosMonetariosES._SeccionID, "id", "")
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New AjustesDeDepositosMonetarios_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Shared Function AbrirVentana_Editar(DinaupSesion As DinaNETCore.APID.DinaupSesionC, Campo$, Valor$) As AjustesDeDepositosMonetarios_FormularioC
          Dim Form_Nuevo = DinaupSesion.ConexionServidor.Funcion_Formulario_Abrir(DinaupSesion, AjustesDeDepositosMonetariosES._SeccionID,Campo, Valor)
          Dim API_VV = New DinaNETCore.API_VVC
          API_VV.Actualizar(Form_Nuevo)
          Return New AjustesDeDepositosMonetarios_FormularioC(API_VV, API_VV.TokenListador)
      End Function
      Public Class AjustesDeDepositosMonetariosES
          Public shared _SeccionID as Guid = New Guid("b2b46811-3ecd-4b1b-947e-06626b029f43")
      ...
      End Class
      Public Class AjustesDeDepositosMonetariosC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""b2b46811-3ecd-4b1b-947e-06626b029f43"",""titulo"": ""Ajustes de depósitos monetarios"",""iconoid"": ""34622279-e1ff-466d-9cde-e08864b50304"",""etiquetasingular"": ""Ajuste de depósito monetario"",""etiquetaplural"": ""Ajustes de depósito monetario"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""b2b46811-3ecd-4b1b-947e-06626b029f43"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("fechasyn", me.Fechadesincronizacion_UTC.AdaptarMySQL_DateTime())
          ...
          End Sub
      End Class
      Public Class AjustesDeDepositosMonetarios_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property TodoTramitadoYValidadoObsoleto As Boolean
            get
                return me.GetValue_Boolean("pr_472c360x3a1wc")
            End Get   
        End Property
          Public property ReferenciaChequeOPagare As Guid
            get
                return me.GetValue_Guid("pr_18f0ffc487xcfwd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_18f0ffc487xcfwd", value)
            End Set
          End Property
        Public ReadOnly property ImporteImporteAfectadoADeposito As Decimal
            get
                return me.GetValue_Decimal("pr_2479n")
            End Get   
        End Property
        Public ReadOnly property ImporteTotalAjustado As Decimal
            get
                return me.GetValue_Decimal("pr_66c1fa79")
            End Get   
        End Property
        Public ReadOnly property FechaDeTramitacionYValidacion_UTC As Date
            get
                return me.GetValue_DateTime("pr_18f107b182x130wd")
            End Get   
        End Property
          Public property FechaDeVencimiento As Date
            get
                return me.GetValue_Date("pr_18f104e2d3x292wd")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_18f104e2d3x292wd", value)
            End Set
          End Property
          Public property ReferenciaAutorDelAlta As Guid
            get
                return me.GetValue_Guid("pr_146310652fx381wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_146310652fx381wd", value)
            End Set
          End Property
          Public property FechaDeVencimientoRetiroObsoleto As Date
            get
                return me.GetValue_Date("pr_18f105796fx20cwd")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_18f105796fx20cwd", value)
            End Set
          End Property
        Public ReadOnly property ImporteTotalPagadoTramitado As Decimal
            get
                return me.GetValue_Decimal("pr_472c014x7bwc")
            End Get   
        End Property
        Public ReadOnly property ImporteImporteAfectadoADepositoTramitado As Decimal
            get
                return me.GetValue_Decimal("pr_2361n")
            End Get   
        End Property
          Public property ReferenciaEntidadAfectada As Guid
            get
                return me.GetValue_Guid("pr_2430")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_2430", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaMovimientoEntreDepositos As Guid
            get
                return me.GetValue_Guid("pr_4e54e6ax84wc")
            End Get   
        End Property
          Public property Estado__Int as Integer
            get
                return me.GetValue_Int("pr_18f101d739x391wd")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_18f101d739x391wd", value)
            End Set
          End Property
          Public property Estado As EnumTramitacionE
            get
          ...
          Public property EmpleadoTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_1464b590a9g2aewd")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_1464b590a9g2aewd", value)
            End Set
          End Property
          Public property Observaciones As String
            get
                return me.GetValue_String("pr_66c2edd5")
            End Get
            Set(value As String)
                me.SetValue_String("pr_66c2edd5", value)
            End Set
          End Property
          Public property ReferenciaPuestoDeTrabajo As Guid
            get
                return me.GetValue_Guid("pr_442d246x126wc")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_442d246x126wc", value)
            End Set
          End Property
          Public property FechaAlta_UTC As Date
            get
                return me.GetValue_DateTime("pr_14c9f3ed43x1d9wd")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_14c9f3ed43x1d9wd", value)
            End Set
          End Property
          Public property ImporteImporteIngreso As Decimal
            get
                return me.GetValue_Decimal("pr_18f0f7f0a1x389wd")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_18f0f7f0a1x389wd", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaTransaccionSecundaria As Guid
            get
                return me.GetValue_Guid("pr_10040114146")
            End Get   
        End Property
          Public property ReferenciaDepositoMonetario As Guid
            get
                return me.GetValue_Guid("pr_2303n")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_2303n", value)
            End Set
          End Property
          Public property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_1463106559xf2wd")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_1463106559xf2wd", value)
            End Set
          End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b42362x268wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1464b42362x268wd", value)
            End Set
          End Property
          Public property ImporteImporteRetiro As Decimal
            get
                return me.GetValue_Decimal("pr_18f0fdf68dx109wd")
            End Get
            Set(value As Decimal)
                me.SetValue_Decimal("pr_18f0fdf68dx109wd", value)
            End Set
          End Property
          Public property EntidadAfectadaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_146310d74ah378wd")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_146310d74ah378wd", value)
            End Set
          End Property
          Public property FechaDeTramitacionYValidacionRetiroObsoleto_UTC As Date
            get
                return me.GetValue_DateTime("pr_18f1071b69x351wd")
            End Get
            Set(value As Date)
                me.SetValue_DateTime("pr_18f1071b69x351wd", value)
            End Set
          End Property
          Public property ReferenciaMetodoDePagoRetiroObsoleto As Guid
            get
                return me.GetValue_Guid("pr_18f0f3013cx28wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_18f0f3013cx28wd", value)
            End Set
          End Property
          Public property ReferenciaMetodoDePago As Guid
            get
                return me.GetValue_Guid("pr_18f0f0d1b9x1c5wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_18f0f0d1b9x1c5wd", value)
            End Set
          End Property
          Public property AutorDelAltaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_14631497aexdfwd")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_14631497aexdfwd", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaTransaccionInterna As Guid
            get
                return me.GetValue_Guid("pr_20040106091")
            End Get   
        End Property
          Public property ReferenciaChequeOPagareRetiro As Guid
            get
                return me.GetValue_Guid("pr_18f100e8a6x20dwd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_18f100e8a6x20dwd", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaDestinador As Guid
            get
                return me.GetValue_Guid("pr_14631065ecx3d0wd")
            End Get   
        End Property
        Public ReadOnly property HoraLocal As DateTime
            get
                return me.GetValue_DateTime("pr_776ae4ewd")
            End Get   
        End Property
          Public property RetiroEstadoObsoleto__Int as Integer
            get
                return me.GetValue_Int("pr_18f103b1dfx3e3wd")
            End Get
            Set(value as Integer)
                me.SetValue_Int("pr_18f103b1dfx3e3wd", value)
            End Set
          End Property
          Public property RetiroEstadoObsoleto As EnumTramitacionE
            get
          ...
          Public property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b42384x298wd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1464b42384x298wd", value)
            End Set
          End Property
          Public property FechaContable As Date
            get
                return me.GetValue_Date("pr_10040135712")
            End Get
            Set(value As Date)
                me.SetValue_Date("pr_10040135712", value)
            End Set
          End Property
          Public property EmpleadoQueTramitaYValidaTieneAccesoWeb As Boolean
            get
                return me.GetValue_Boolean("pr_60040141242")
            End Get
            Set(value As Boolean)
                me.SetValue_Boolean("pr_60040141242", value)
            End Set
          End Property
        Public ReadOnly property ReferenciaEmpleadoQueTramitaYValida As Guid
            get
                return me.GetValue_Guid("pr_60040141241")
            End Get   
        End Property
        Public ReadOnly property FechaLocalDeTramitacionYValidacion As Date
            get
                return me.GetValue_Date("pr_20040141264")
            End Get   
        End Property
          Public property Concepto As String
            get
                return me.GetValue_String("pr_60040263353")
            End Get
            Set(value As String)
                me.SetValue_String("pr_60040263353", value)
            End Set
          End Property
          Public property ReferenciaMovimientoBancario As Guid
            get
                return me.GetValue_Guid("pr_30040264608")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_30040264608", value)
            End Set
          End Property
          Public property ReferenciaAsientoContable As Guid
            get
                return me.GetValue_Guid("pr_60040135502")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_60040135502", value)
            End Set
          End Property
