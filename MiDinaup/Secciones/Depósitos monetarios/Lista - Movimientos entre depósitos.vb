...
Partial Public Class SeccionesD
  Public Class MovimientosEntreDepositosListaD
      Public Shared _SeccionID As String = "f39fcbc6-97ec-4fda-a2e0-a7ffa19ef849"
      Public Shared _SeccionIDGUID As New Guid("f39fcbc6-97ec-4fda-a2e0-a7ffa19ef849")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of MovimientosEntreDepositosListaC )) 
          Dim R As New List(Of MovimientosEntreDepositosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(MovimientosEntreDepositosListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New MovimientosEntreDepositosListaC 
          ...
          Return R 
      End Function 
      Public Class MovimientosEntreDepositosListaES
          Public shared _SeccionID as Guid = New Guid("f39fcbc6-97ec-4fda-a2e0-a7ffa19ef849")
      ...
      End Class
      Public Class MovimientosEntreDepositosListaC
      Inherits Base_DatoC
          ...
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""f39fcbc6-97ec-4fda-a2e0-a7ffa19ef849"",""titulo"": ""Lista - Movimientos entre depósitos"",""iconoid"": """",""etiquetasingular"": ""Movimiento entre depósitos"",""etiquetaplural"": ""Movimientos entre depósitos"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""f39fcbc6-97ec-4fda-a2e0-a7ffa19ef849"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class MovimientosEntreDepositosLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_14631025aeg122wd")
            End Get   
        End Property
          Public property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b410d0g38cwd")
            End Get
            Set(value As Guid)
                me.SetValue_Guid("pr_1464b410d0g38cwd", value)
            End Set
          End Property
