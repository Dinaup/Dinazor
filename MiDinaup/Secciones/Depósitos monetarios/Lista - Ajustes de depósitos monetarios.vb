...
Partial Public Class SeccionesD
  Public Class AjustesDeDepositosMonetariosListaD
      Public Shared _SeccionID As String = "eab03f4c-bd9c-41aa-8b2b-bac5318d1682"
      Public Shared _SeccionIDGUID As New Guid("eab03f4c-bd9c-41aa-8b2b-bac5318d1682")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of AjustesDeDepositosMonetariosListaC )) 
          Dim R As New List(Of AjustesDeDepositosMonetariosListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(AjustesDeDepositosMonetariosListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New AjustesDeDepositosMonetariosListaC 
          ...
          Return R 
      End Function 
      Public Class AjustesDeDepositosMonetariosListaES
          Public shared _SeccionID as Guid = New Guid("eab03f4c-bd9c-41aa-8b2b-bac5318d1682")
      ...
      End Class
      Public Class AjustesDeDepositosMonetariosListaC
      Inherits Base_DatoC
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class AjustesDeDepositosMonetariosLista_FormularioC
        Inherits DinaNETCore.VentanaVirtualC
    Overrides Sub Evento_Actualizar()
    End Sub
        Public ReadOnly property FechaDato_UTC As Date
            get
                return me.GetValue_DateTime("pr_14631092e2g212wd")
            End Get   
        End Property
        Public ReadOnly property ReferenciaUbicacionPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b42fddx51wd")
            End Get   
        End Property
        Public ReadOnly property ReferenciaEmpleadoPrincipal As Guid
            get
                return me.GetValue_Guid("pr_1464b42fb3x2cwd")
            End Get   
        End Property
