...
Partial Public Class SeccionesD
  Public Class TalonariosDeChequesListaD
      Public Shared _SeccionID As String = "b3edb4b8-47e5-4c1d-9fa7-5d721d0e5bf5"
      Public Shared _SeccionIDGUID As New Guid("b3edb4b8-47e5-4c1d-9fa7-5d721d0e5bf5")
      Public Shared Async Function ConsultarDatos_Async(Parametros As SeccionConsultaParametrosC) As Task(Of List(Of TalonariosDeChequesListaC )) 
          Dim R As New List(Of TalonariosDeChequesListaC )  
          Dim d = Await Parametros.DinaupSesion.ConexionServidor.Funcion_Datos_Recibir_Async(TalonariosDeChequesListaES._SeccionID, False, Parametros) 
          If d.Datos.TieneDatos Then 
              For Each Actual In d.Datos 
                  Dim Valores_Listador = Actual.Value.Item1
                  Dim Obj_Listador As New TalonariosDeChequesListaC 
          ...
          Return R 
      End Function 
      Public Class TalonariosDeChequesListaES
          Public shared _SeccionID as Guid = New Guid("b3edb4b8-47e5-4c1d-9fa7-5d721d0e5bf5")
      ...
      End Class
      Public Class TalonariosDeChequesListaC
      Inherits Base_DatoC
          <ReadOnlyAttribute(True)>
          <DisplayName("ID")>
          Public Property ID As Guid
          Public Shared ___ID As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": true,""eseliminado"": false,""keyword"": ""ID"",""etiqueta"": ""ID"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""b3edb4b8-47e5-4c1d-9fa7-5d721d0e5bf5"",""titulo"": ""Lista - Talonarios de cheques"",""iconoid"": """",""etiquetasingular"": ""Talonario de cheques"",""etiquetaplural"": ""Talonarios de cheques"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": true,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""b3edb4b8-47e5-4c1d-9fa7-5d721d0e5bf5"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": false,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""ID"",""descripcion"": """",""keyword"": ""ID"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          ...
          <ReadOnlyAttribute(True)>
          <DisplayName("Talonario de cheques (Listador) (Relación)")>
          Public Property RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_IdentificacionRegistroC
          Public Shared ___RelacionElementoContenedorListador As New DinaNETCore.APID.DinaupAPI_CampoC("{""esid"": false,""eseliminado"": false,""keyword"": ""RelacionElementoContenedorListador"",""etiqueta"": ""Talonario de cheques (Listador) (Relación)"",""oculta"": false,""formato"": 9,""porubicacion"": false,""seccionrelacionada"": {""id"": ""ac1ad6f5-8526-4564-b306-4ba0f17e2e99"",""titulo"": ""Talonarios de cheques"",""iconoid"": ""cbcded4b-3acf-41c0-bd22-48a2e5992a82"",""etiquetasingular"": ""Talonario de cheques"",""etiquetaplural"": ""Talonarios de cheques"",""etiquetaesfemenino"": false,""contienelista"": false,""eslista"": false,""esbase"": false,""puedeagregar"": false},""seccionrelacionadaid"": ""ac1ad6f5-8526-4564-b306-4ba0f17e2e99"",""rol"": 0,""decimales"": ""22"",""multilinea"": false,""obligatorio"": true,""motivobloqueo"": """",""esutc"": false,""aceptasegundos"": false,""aceptacero"": true,""aceptapositivos"": true,""aceptanegativos"": true,""predefinidos_valores"": [],""predefinidos_textos"": [],""predefinidos_iconos"": [],""filtro"": {""titulo"": ""Talonario de cheques (Listador) (Relación)"",""descripcion"": """",""keyword"": ""RelacionElementoContenedorListador"",""formato"": 9,""rol"": 0,""seccionrelacionada"": null,""desplegableinforme"": null,""rango"": false},""solovalorespredefinidos"": false}")
          Public  __RelacionElementoContenedorListador As DinaNETCore.APID.DinaupAPI_CampoC = ___RelacionElementoContenedorListador
          <DisplayName("Talonario de cheques (Listador) Eliminadoo *")>
         ...
         R.add("listadoreliminado", me.Listadoreliminado.AdaptarMySQL_Boolean())
          ...
          End Sub
      End Class
      Public Class TalonariosDeChequesLista_FormularioC
