...
Partial Public Class InformesD
  Partial Public Class FuncionalidadD
      Public Class ContabilizacionPagosDeComprasC
          Inherits DinaNETCore.APID.APID_InformeC
          Public Filas As New List(Of ContabilizacionPagosDeCompras_FilaC)
          Public TokenCambios As Guid
          Sub new()
              Parametros = New APID.Funcion_Informe_Consultar_ParametrosC( ("95355656-3418-4540-b76e-9e3fa70e8b97"))
              me.ID = new GUID("95355656-3418-4540-b76e-9e3fa70e8b97")
              me.Titulo  = "Contabilización Pagos de Compras"
          End sub
          <ProtoContract>
          Public Class ContabilizacionPagosDeCompras_FilaC
          ...
          Public Overrides Sub CargarRespuesta()
                Dim Creando_Filas As New List(Of ContabilizacionPagosDeCompras_FilaC)
                If Respuesta IsNot Nothing AndAlso Respuesta.Listado IsNot Nothing AndAlso Respuesta.Listado.Filas IsNot Nothing Then
                    For Each Actual In Respuesta.Listado.Filas
                        If Actual Is Nothing Then Continue For
                        Dim N = New ContabilizacionPagosDeCompras_FilaC(Actual)
                        Creando_Filas.Add(N)
                    Next
                End If
